...
public class Thumbnail {
  public static InputStream makeThumbnail(MultipartFile originalFile, String fileName,String fileExt)throws Exception{
    ...
    BufferedImage cropImg = Scalr
        .crop(srcImg,(origin_width-n_width)/2,(origin_height-n_height)/2,n_width,n_height);
