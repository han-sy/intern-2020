...
(function () {
  ...
  window.CKEDITOR || (window.CKEDITOR = function () {
    var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
      ...
      basePath: function () {
        ...
        if (!b) {
          for (var c = document.getElementsByTagName("script"), d = 0;
              d < c.length; d++) {
        ...
        -1 == b.indexOf(":/") && "//" != b.slice(0, 2) && (b = 0 === b.indexOf(
      ...
      getUrl: function (a) {
        -1 == a.indexOf(":/") && 0 !== a.indexOf("/") && (a = this.basePath
            + a);
        this.timestamp && "/" != a.charAt(a.length - 1) && !/[&?]t=/.test(a)
        && (a += (0 <= a.indexOf("?") ? "\x26" : "?") + "t\x3d"
            + this.timestamp);
        return a
      },
      domReady: function () {
        function a() {
          try {
            document.addEventListener ? (document.removeEventListener(
                "DOMContentLoaded",
                a, !1), b()) : document.attachEvent && "complete"
          ...
          if (1
            ...
            if (document.addEventListener) {
              document.addEventListener(
                  "DOMContentLoaded", a, !1), window.addEventListener("load", a,
                  !1);
      ...
      once: function () {
        ...
        return function (g, l, u) {
          ...
          if (e) {
            var t = e.listeners;
            if (t.length) {
              for (var t = t.slice(0), z, I = 0; I < t.length;
                  I++) {
                if (e.errorProof) {
                  try {
                    z =
  ...
  CKEDITOR.env || (CKEDITOR.env = function () {
    var a = navigator.userAgent.toLowerCase(),
        d = a.match(/edge[ \/](\d+.?\d*)/), b = -1 < a.indexOf("trident/"),
        b = !(!d && !b), b = {
          ie: b,
          edge: !!d,
          ...
          quirks: "BackCompat" == document.compatMode && (!document.documentMode
    ...
    var c = 0;
    b.ie && (c = d ? parseFloat(d[1]) : b.quirks || !document.documentMode
        ? parseFloat(a.match(/msie (\d+)/)[1])
        : document.documentMode, b.ie9Compat = 9 == c, b.ie8Compat = 8
        == c, b.ie7Compat = 7 == c, b.ie6Compat = 7 > c || b.quirks);
    b.gecko && (d = a.match(/rv:([\d\.]+)/)) && (d = d[1].split("."), c = 1E4
        * d[0] + 100 * (d[1] || 0) + 1 * (d[2] || 0));
    ...
    b.cssClass = "cke_browser_" + (b.ie ? "ie" : b.gecko ? "gecko" : b.webkit
        ? "webkit" : "unknown");
    b.quirks && (b.cssClass += " cke_browser_quirks");
    b.ie && (b.cssClass += " cke_browser_ie" + (b.quirks
  ...
  "unloaded" == CKEDITOR.status && function () {
    ...
    (function () {
      CKEDITOR.domReady(function () {
        ...
        a && (CKEDITOR.status = "basic_ready", a && a._load ? a() : d
            && setTimeout(function () {
  ...
  CKEDITOR.warn = function (a, d) {
    CKEDITOR.verbosity & CKEDITOR.VERBOSITY_WARN && CKEDITOR.fire("log",
        {type: "warn", errorCode: a, additionalData: d})
  };
  ...
  CKEDITOR.on("log", function (a) {
    if (window.console && window.console.log) {
      ...
      if (a = a.data.additionalData) {
        console[d](
            "[CKEDITOR] Error code: " + b + ".", a);
      } else {
        console[d](
            "[CKEDITOR] Error code: " + b + ".");
      }
      console[d](
  ...
  (function () {
    function a(a, b, e) {
      ...
      this.input = function () {
        ...
        if (!c._scheduledTimer || !1 !== c._reschedule()) {
          ...
          x < c._minInterval ? c._scheduledTimer = setTimeout(a,
              c._minInterval - x) : a()
        }
      }
    }
    ...
    var b = [],
        c = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-"
            : CKEDITOR.env.ie ? "-ms-" : "", f = /&/g, h = />/g, k = /</g,
        g = /"/g, l = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, u = {
          lt: "\x3c",
          gt: "\x3e",
          amp: "\x26",
          quot: '"',
    ...
    CKEDITOR.tools = {
      ...
      clone: function (a) {
        ...
        if (a && a instanceof Array) {
          b = [];
          for (var e = 0; e < a.length; e++) {
            b[e] = CKEDITOR.tools.clone(a[e]);
          }
          return b
        }
        if (null === a || "object" != typeof a || a instanceof String || a
            instanceof Number || a instanceof Boolean || a instanceof Date || a
            instanceof RegExp || a.nodeType || a.window === a) {
          return a;
        }
        b = new a.constructor;
        for (e in a) {
      ...
      capitalize: function (a, b) {
        return a.charAt(0).toUpperCase() + (b ? a.slice(1) : a.slice(
            1).toLowerCase())
      },
      extend: function (a) {
        var b = arguments.length, e, c;
        "boolean" == typeof (e = arguments[b - 1]) ? b-- : "boolean"
            == typeof (e = arguments[b - 2]) && (c = arguments[b - 1], b -= 2);
        for (var g = 1; g < b; g++) {
          var m = arguments[g] || {};
          CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(m),
              function (b) {
                if (!0 === e || null == a[b]) {
                  if (!c || b in c) {
                    a[b] = m[b]
      ...
      cssStyleToDomStyle: function () {
        var a = document.createElement("div").style,
            b = "undefined" != typeof a.cssFloat ? "cssFloat" : "undefined"
            != typeof a.styleFloat ? "styleFloat" :
                "float";
        return function (a) {
      ...
      buildStyleHtml: function (a) {
        ...
        for (var b, e = [], c = 0; c < a.length;
            c++) {
          if (b = a[c]) {
            /@import|[{}]/.test(b) ? e.push(
                "\x3cstyle\x3e" + b + "\x3c/style\x3e") : e.push(
                '\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + b
                + '"\x3e');
          }
        }
        return e.join("")
      ...
      htmlEncode: function (a) {
        return void 0 === a || null === a ? "" : String(a).replace(f,
            "\x26amp;").replace(h, "\x26gt;").replace(k, "\x26lt;")
      },
      ...
      transformPlainTextToHtml: function (a, b) {
        ...
        c = c.replace(/\n/g, "\x3cbr\x3e");
        e || (c =
            c.replace(new RegExp("\x3cbr\x3e(?\x3d\x3c/" + g + "\x3e)"),
                function (a) {
      ...
      createClass: function (a) {
        ...
        e && (b.prototype = this.prototypedCopy(
            e.prototype), b.prototype.constructor = b, b.base = e, b.baseProto = e.prototype, b.prototype.base = function y() {
      ...
      convertRgbToHex: function (a) {
        return a.replace(/(?:rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\))/gi,
            function (a, b, e, c) {
              a = [b, e, c];
              for (b = 0; 3 > b; b++) {
                a[b] = ("0" + parseInt(a[b], 10).toString(
                    16)).slice(-2);
              }
              return "#" + a.join("")
            })
      ...
      parseCssText: function (a, b, e) {
        ...
        a && (a = CKEDITOR.tools.normalizeHex(
            CKEDITOR.tools.convertRgbToHex(a)));
        if (!a || ";" == a) {
          return c;
        }
        a.replace(/&quot;/g, '"').replace(
            /\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (a, e, x) {
              b && (e = e.toLowerCase(), "font-family" == e && (x = x.replace(
                  /\s*,\s*/g, ",")), x = CKEDITOR.tools.trim(x));
              c[e] = x
            });
        return c
      },
      ...
      keystrokeToArray: function (a, b) {
        var e = b & 16711680, c = b & 65535, g = CKEDITOR.env.mac, m = [],
            d = [];
        e & CKEDITOR.CTRL && (m.push(g ? "⌘" : a[17]), d.push(
            g ? a[224] : a[17]));
        e & CKEDITOR.ALT && (m.push(g ? "⌥" : a[18]), d.push(a[18]));
        e & CKEDITOR.SHIFT && (m.push(g ?
            "⇧" : a[16]), d.push(a[16]));
        c && (a[c] ? (m.push(a[c]), d.push(a[c])) : (m.push(
            String.fromCharCode(c)), d.push(String.fromCharCode(c))));
      ...
      getCookie: function (a) {
        a = a.toLowerCase();
        for (var b = document.cookie.split(";"), e, c, g = 0; g < b.length;
            g++) {
          if (e = b[g].split("\x3d"), c = decodeURIComponent(
              CKEDITOR.tools.trim(e[0]).toLowerCase()), c
          === a) {
      ...
      getCsrfToken: function () {
        ...
        if (!a || 40 != a.length) {
          ...
          if (window.crypto
            ...
            a = new Uint8Array(
                40), window.crypto.getRandomValues(a);
          } else {
            for (var e = 0;
                40 > e; e++) {
          ...
          for (e = 0; e < a.length;
              e++) {
            var c = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(
                a[e] % 36), b = b + (.5 < Math.random() ? c.toUpperCase() :
                c);
          }
          a = b;
      ...
      escapeCss: function (a) {
        return a ? window.CSS && CSS.escape ? CSS.escape(a) : isNaN(
            parseInt(a.charAt(0), 10)) ? a : "\\3" + a.charAt(0) + " "
            + a.substring(1, a.length) : ""
      },
      getMouseButton: function (a) {
        return (a = a && a.data ? a.data.$ : a)
            ? CKEDITOR.tools.normalizeMouseButton(a.button) : !1
      },
      normalizeMouseButton: function (a, b) {
        ...
        for (var e = [[CKEDITOR.MOUSE_BUTTON_LEFT, 1],
      ...
      convertHexStringToBytes: function (a) {
        ...
        for (c = 0; c < e; c++) {
          b.push(parseInt(a.substr(2 * c, 2), 16));
        }
        return b
      },
      convertBytesToBase64: function (a) {
        var b = "", e = a.length, c;
        for (c = 0; c < e; c += 3) {
          var g = a.slice(c, c + 3), m = g.length, d = [], l;
          if (3 > m) {
            for (l = m; 3 > l; l++) {
              g[l] = 0;
            }
      ...
      object: {
        ...
        entries: function (a) {
          ...
          var b = Object.prototype.hasOwnProperty, e = [],
              c = CKEDITOR.tools.object.DONT_ENUMS;
          if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version && (!a || "object"
              !== typeof a)) {
            b = [];
            if ("string" === typeof a) {
          ...
          e.array.forEach(e.object.keys(g), function (a) {
            c[a] = "object" === typeof g[a] && "object" === typeof c[a]
                ? e.object.merge(c[a], g[a]) : g[a]
          });
          return c
        }
      },
      ...
      $: function (a) {
        ...
        normalizeMap: {
          ...
          for (var a in this._.normalizeMap) {
            var b = this[a];
            b && (this[a] = CKEDITOR.tools.array.reduce(this._.normalizeMap[a],
                function (a, b) {
        ...
        toString: function () {
          return CKEDITOR.tools.array.filter(
              [this.width, this.style, this.color], function (a) {
                return !!a
              }).join(" ")
        }
      }, statics: {
        fromCssRule: function (a) {
          ...
          CKEDITOR.tools.array.forEach(e, function (a) {
            b.style ||
            -1 === CKEDITOR.tools.indexOf(
                CKEDITOR.tools.style.parse._borderStyle, a) ? !b.width
          ...
          b = b || {};
          var e = CKEDITOR.tools.array.reduce(["width", "style", "color"],
              function (e, c) {
                var g = a["border-" + c] || b[c];
                e[c] = g ? CKEDITOR.tools.style.parse.sideShorthand(g) : null;
                return e
              }, {});
          return CKEDITOR.tools.array.reduce(["top", "right", "bottom", "left"],
              function (b, c) {
                var g = {}, d;
                for (d in e) {
                  var l =
  ...
  CKEDITOR.dtd = function () {
    var a = CKEDITOR.tools.extend, d = function (a, b) {
        ...
        k = {}, g = {"#": 1}, l = {center: 1, dir: 1, noframes: 1};
    a(b, {
      a: 1,
      abbr: 1,
      area: 1,
    ...
    getKey: function () {
      ...
      return {
        x: this.$.pageX || this.$.clientX + (a.documentElement.scrollLeft
            || a.body.scrollLeft),
        y: this.$.pageY || this.$.clientY + (a.documentElement.scrollTop
            || a.body.scrollTop)
      }
    }
  };
  ...
  CKEDITOR.dom.domObject.prototype = function () {
    ...
    return {
      getPrivate: function () {
        ...
        b[d] || (b = b[d] = a(this, d), this.$.addEventListener
        ...
        if (!this.hasListeners(a)) {
          ...
          c && (this.$.removeEventListener ? this.$.removeEventListener(a, c,
              !1) : this.$.detachEvent && this.$.detachEvent("on" + a,
              c), delete b[a])
        }
      }, removeAllListeners: function () {
        try {
          ...
          for (b in a) {
            ...
            this.$.detachEvent ? this.$.detachEvent("on" +
                b, c) : this.$.removeEventListener
                && this.$.removeEventListener(b, c, !1);
            delete a[b]
          }
        } catch (f) {
          if (!CKEDITOR.env.edge || -2146828218 !== f.number) {
            throw f;
          }
        }
  ...
  CKEDITOR.dom.node = function (a) {
    return a ? new CKEDITOR.dom[a.nodeType == CKEDITOR.NODE_DOCUMENT
        ? "document" : a.nodeType == CKEDITOR.NODE_ELEMENT ? "element"
            : a.nodeType == CKEDITOR.NODE_TEXT ? "text" : a.nodeType
            == CKEDITOR.NODE_COMMENT ? "comment" : a.nodeType
            == CKEDITOR.NODE_DOCUMENT_FRAGMENT ? "documentFragment"
                : "domObject"](a) : this
  };
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
    appendTo: function (a, d) {
      ...
      function b(c) {
        ...
        if (c.nodeType == CKEDITOR.NODE_ELEMENT || c.nodeType
            == CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
          if (d || c.nodeType
          != CKEDITOR.NODE_ELEMENT || c.removeAttribute("id", !1), a) {
            c = c.childNodes;
      ...
      function c(b) {
        if (b.type == CKEDITOR.NODE_ELEMENT || b.type
            == CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
      ...
      CKEDITOR.env.ie && 9 > CKEDITOR.env.version && (this.type
          == CKEDITOR.NODE_ELEMENT || this.type
      ...
      for (var d = [], b = this.getDocument().$.documentElement, c = this;
          c && c != b;) {
        var f = c.getParent();
      ...
      var b = this, c = -1, f;
      if (!this.getParent() || a && b.type == CKEDITOR.NODE_TEXT && b.isEmpty()
          && !d(b) && !d(b, !0)) {
        return -1;
      }
      do {
        if (!a || b.equals(this) || b.type != CKEDITOR.NODE_TEXT || !f
            && !b.isEmpty()) {
          c++, f = b.type
              == CKEDITOR.NODE_TEXT;
        }
      ...
      var f;
      if (!a) {
        if (this.type == CKEDITOR.NODE_ELEMENT && b && !1 === b(this,
            !0)) {
          return null;
        }
        a = this.getNext()
      ...
      return !a || b && !1 === b(a) ? null : d && d != a.type
          ? a.getNextSourceNode(!1, d, b) : a
      ...
      return !a || b && !1 === b(a) ? null : d && a.type != d
          ? a.getPreviousSourceNode(!1, d, b) :
          a
    }, getPrevious: function (a) {
      var d = this.$, b;
      do {
        b = (d = d.previousSibling) && 10 != d.nodeType
      ...
      return d && (d.nodeType == CKEDITOR.NODE_ELEMENT || a && d.nodeType
          == CKEDITOR.NODE_DOCUMENT_FRAGMENT) ? new CKEDITOR.dom.node(d) : null
      ...
      if (this.type == CKEDITOR.NODE_ELEMENT && a.type
      ...
      for (var b = Math.min(d.length, a.length), c = 0; c < b; c++) {
        if (d[c]
            != a[c]) {
          return d[c] < a[c] ? CKEDITOR.POSITION_PRECEDING
              : CKEDITOR.POSITION_FOLLOWING;
        }
      }
      ...
      for (var a; this.getFirst && (a = this.getFirst());) {
        if (a.type == CKEDITOR.NODE_TEXT) {
          ...
          if (d) {
            d.length <
            b && (a.split(b - d.length), this.$.removeChild(
                this.$.firstChild));
          } else {
            a.remove();
            continue
      ...
      for (var a; this.getLast && (a = this.getLast());) {
        if (a.type == CKEDITOR.NODE_TEXT) {
          ...
          if (d) {
            d.length < b && (a.split(
                d.length), this.$.lastChild.parentNode.removeChild(
                this.$.lastChild));
          } else {
            a.remove();
            continue
      ...
      CKEDITOR.env.needsBrFiller && (a = this.$.lastChild) && 1 == a.type
      && "br" == a.nodeName.toLowerCase() && a.parentNode.removeChild(a)
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
    type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function (a) {
      ...
      d && (d.attributes && b.setAttributes(d.attributes), d.styles
      && b.setStyles(d.styles));
      return b
      ...
      for (var b =
        ...
        if (d) {
          for (var h = -1, k = 0; k < b.childNodes.length; k++) {
            ...
            if (!0 !== d || 3 != g.nodeType || !g.previousSibling || 3
      ...
      return a = a ? new CKEDITOR.dom.element(a)
          : this.getDocumentElement().append(new CKEDITOR.dom.element("head"),
              !0)
    }, getBody: function () {
      ...
      a
      || (a = this.$.createDocumentFragment(), CKEDITOR.tools.enableHtml5Elements(
          a, !0), this.setCustomData("html5ShivFrag", a));
      return a
    }
  });
  ...
  CKEDITOR.dom.nodeList.prototype = {
    count: function () {
      ...
      return 0 > a || a >= this.$.length ? null : (a = this.$[a])
  ...
  CKEDITOR.dom.element.get = function (a) {
    return (a = "string" == typeof a ? document.getElementById(a)
        || document.getElementsByName(a)[0] : a) && (a.$ ? a
  ...
  CKEDITOR.dom.element.setMarker = function (a, d, b, c) {
    var f = d.getCustomData("list_marker_id") || d.setCustomData(
        "list_marker_id", CKEDITOR.tools.getNextNumber()).getCustomData(
        "list_marker_id"),
        h = d.getCustomData("list_marker_names") || d.setCustomData(
            "list_marker_names", {}).getCustomData("list_marker_names");
    a[f] = d;
    h[b] = 1;
  ...
  CKEDITOR.dom.element.clearMarkers = function (a, d, b) {
    var c = d.getCustomData("list_marker_names"),
        f = d.getCustomData("list_marker_id"), h;
    for (h in c) {
  ...
  (function () {
    ...
    function c(a) {
      for (var b = 0, c = 0, e = k[a].length; c < e; c++) {
        b += parseFloat(
            this.getComputedStyle(k[a][c]) || 0, 10) || 0;
      }
      return b
    }
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
      ...
      removeClass: f ? function (a) {
        ...
        c && a(c, b) && ((c = c.replace(new RegExp("(?:^|\\s+)" +
            b + "(?\x3d\\s|$)"), "").replace(/^\s+/, "")) ? this.setAttribute(
            "class", c) : this.removeAttribute("class"));
        return this
      },
      hasClass: function (b) {
      ...
      append: function (a, b) {
        ...
        b ? this.$.insertBefore(a.$, this.$.firstChild) : this.$.appendChild(
            a.$);
        return a
      },
      ...
      appendText: function (a) {
        null !=
        this.$.text && CKEDITOR.env.ie && 9 > CKEDITOR.env.version
            ? this.$.text += a : this.append(new CKEDITOR.dom.text(a))
      },
      appendBogus: function (a) {
        if (a || CKEDITOR.env.needsBrFiller) {
          for (a = this.getLast();
              a && a.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.rtrim(
                  a.getText());) {
            a = a.getPrevious();
          }
          a && a.is && a.is("br") || (a = this.getDocument().createElement(
              "br"), CKEDITOR.env.gecko && a.setAttribute("type",
              "_moz"), this.append(a))
        }
      },
      breakParent: function (a, b) {
        ...
        if (CKEDITOR.env.ie && !CKEDITOR.env.edge) {
          for (c = new CKEDITOR.dom.element("div");
              d = e.getFirst();) {
            d.$.style.backgroundColor
            && (d.$.style.backgroundColor = d.$.style.backgroundColor), c.append(
                d);
          }
          c.insertAfter(this);
          c.remove(!0)
      ...
      getClientRect: function (a) {
        ...
        return a ? CKEDITOR.tools.getAbsoluteRectPosition(this.getWindow(), b)
            : b
      },
      ...
      getAttribute: function () {
        ...
        return CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat
            || CKEDITOR.env.quirks) ? function (a) {
          switch (a) {
            case "class":
              a = "className";
              break;
            ...
            case "checked":
              return a = this.$.attributes.getNamedItem(a), (a.specified
      ...
      getAttributes: function (a) {
        ...
        for (e = 0; e < c.length; e++) {
          -1 === CKEDITOR.tools.indexOf(a,
              c[e].name) && (b[c[e].name] = c[e].value);
        }
        return b
      },
      ...
      && document.defaultView.getComputedStyle ? function (a) {
      ...
      getTabIndex: function () {
        var a = this.$.tabIndex;
        return 0 !== a || CKEDITOR.dtd.$tabIndex[this.getName()] || 0
        === parseInt(this.getAttribute("tabindex"), 10) ? a : -1
      },
      getText: function () {
      ...
      getLast: function (a) {
        ...
        (b = b && new CKEDITOR.dom.node(b)) && a && !a(b) && (b = b.getPrevious(
            a));
        return b
      },
      getStyle: function (a) {
      ...
      isEditable: function (a) {
        var b = this.getName();
        return this.isReadOnly() || "none" == this.getComputedStyle("display")
        || "hidden" == this.getComputedStyle("visibility")
        || CKEDITOR.dtd.$nonEditable[b] || CKEDITOR.dtd.$empty[b] || this.is(
            "a") && (this.data("cke-saved-name") || this.hasAttribute("name"))
        && !this.getChildCount() ? !1 : !1 !== a ? (a = CKEDITOR.dtd[b] ||
      ...
      isIdentical: function (a) {
        ...
        a.removeAttributes(
            ["_moz_dirty", "data-cke-expando", "data-cke-saved-href",
              "data-cke-saved-name"]);
        if (b.$.isEqualNode) {
          return b.$.style.cssText = CKEDITOR.tools.normalizeCssText(
              b.$.style.cssText), a.$.style.cssText = CKEDITOR.tools.normalizeCssText(
        ...
        if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version && this.is("a")) {
          ...
          c.type == CKEDITOR.NODE_ELEMENT && (c = c.clone(), c.setHtml(
              b), b = c.getHtml(), c.setHtml(a), a = c.getHtml())
        }
        return b == a
      },
      isVisible: function () {
        var a = (this.$.offsetHeight || this.$.offsetWidth) && "hidden"
            != this.getComputedStyle("visibility"), b, c;
        a && CKEDITOR.env.webkit && (b = this.getWindow(), !b.equals(
            CKEDITOR.document.getWindow()) && (c = b.$.frameElement)
      ...
      isEmptyInlineRemoveable: function () {
        ...
        for (var a = this.getChildren(), b = 0, c = a.count(); b < c; b++) {
          var e = a.getItem(b);
          if (e.type != CKEDITOR.NODE_ELEMENT || !e.data(
              "cke-bookmark")) {
            if (e.type == CKEDITOR.NODE_ELEMENT
                && !e.isEmptyInlineRemoveable() || e.type == CKEDITOR.NODE_TEXT
      ...
      hasAttributes: CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat
        ...
        var a = this.$.attributes, b = a.length,
            c = {"data-cke-expando": 1, _moz_dirty: 1};
        return 0 < b && (2 < b || !c[a[0].nodeName] || 2 == b
            && !c[a[1].nodeName])
      },
          ...
          if ("input" == this.getName()) {
            switch (b) {
              ...
              case "checked":
                return !!this.$.checked;
              case "value":
                return b = this.getAttribute("type"), "checkbox" == b || "radio"
                == b ? "on" != this.$.value : !!this.$.value
            }
          }
          return c ?
              c.specified : !1
      ...
      moveChildren: function (a, b) {
        ...
        if (c != a) {
          ...
          if (b) {
            for (; e = c.lastChild;) {
              a.insertBefore(c.removeChild(e),
                  a.firstChild);
            }
          } else {
            for (; e = c.firstChild;) {
      ...
      mergeSiblings: function () {
        function a(b, c, e) {
          if (c && c.type == CKEDITOR.NODE_ELEMENT) {
            ...
            || c.isEmptyInlineRemoveable();) {
              if (d.push(c), c = e ? c.getNext()
                  : c.getPrevious(), !c || c.type
              != CKEDITOR.NODE_ELEMENT) {
                return;
              }
            }
            if (b.isIdentical(c)) {
              for (var g = e ? b.getLast() : b.getFirst();
                  d.length;) {
                d.shift().move(b, !e);
              }
              c.moveChildren(b, !e);
        ...
        return function (b) {
          if (!1 === b || CKEDITOR.dtd.$removeEmpty[this.getName()] || this.is(
              "a")) {
      ...
      setAttribute: function () {
        ...
        return CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat
            || CKEDITOR.env.quirks) ? function (b, c) {
          "class" == b ? this.$.className = c : "style" == b
              ? this.$.style.cssText = c : "tabindex" == b ? this.$.tabIndex = c
                  : "checked" == b ? this.$.checked = c : "contenteditable" == b
                      ? a.call(this, "contentEditable", c) : a.apply(this,
                          arguments);
          return this
      ...
      removeAttribute: function () {
        ...
        return CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat
            || CKEDITOR.env.quirks) ? function (a) {
          "class" == a ? a = "className" : "tabindex" == a ? a = "tabIndex"
      ...
      removeStyle: function (a) {
        var b = this.$.style;
        if (b.removeProperty || "border" != a && "margin" != a && "padding"
            != a) {
          b.removeProperty ? b.removeProperty(a) : b.removeAttribute(
              CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText
      ...
      setOpacity: function (a) {
        CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? (a = Math.round(
            100 * a), this.setStyle("filter", 100 <= a ? ""
      ...
      unselectable: function () {
        ...
        if (CKEDITOR.env.ie) {
          ...
          for (var a, b = this.getElementsByTag("*"), c = 0, e = b.count();
              c < e; c++) {
      ...
      getDocumentPosition: function (a) {
        var b = 0, c = 0, e = this.getDocument(), d = e.getBody(),
        ...
        if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
          ...
          var f = this.$.getBoundingClientRect(), h = e.$.documentElement,
              ...
              m = h.clientLeft || d.$.clientLeft || 0, k = !0;
          CKEDITOR.env.ie && (k = e.getDocumentElement().contains(
              this), e = e.getBody().contains(this), k = t && e || !t && k);
          k && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12
          <= CKEDITOR.env.version ? (b = d.$.scrollLeft
              || h.scrollLeft, c = d.$.scrollTop || h.scrollTop) : (c = t ? d.$
              : h, b = c.scrollLeft, c = c.scrollTop), b = f.left + b
              - m, c = f.top + c - r)
        } else {
          ...
          "html" != r.getName();) {
            ...
            r.equals(this) || (b += r.$.clientLeft || 0, c += r.$.clientTop
                || 0);
            for (; m && !m.equals(
                r);) {
        ...
        a && (f = this.getWindow(), r = a.getWindow(), !f.equals(r)
        && f.$.frameElement && (a = (new CKEDITOR.dom.element(
            f.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y));
      ...
      scrollIntoView: function (a) {
        ...
        if (b) {
          do {
            if ((b.$.clientWidth && b.$.clientWidth < b.$.scrollWidth
      ...
      scrollIntoParent: function (a, b, c) {
        ...
        function r(a, b) {
          ...
          e = a.getWindow();
          e.equals(b) || (e = r(CKEDITOR.dom.element.get(e.$.frameElement),
              b), c.x += e.x, c.y += e.y);
          return c
        }
        ...
        a instanceof CKEDITOR.dom.window && (a = k ? t.getBody()
            : t.getDocumentElement());
        CKEDITOR.env.webkit && (t = this.getEditor(!1))
        && (t._.previousScrollTop = null);
        t = a.getWindow();
        d = r(this, t);
        var y = r(a, t), J = this.$.offsetHeight;
        e = this.$.offsetWidth;
        var E = a.$.clientHeight, p = a.$.clientWidth;
      ...
      setState: function (a, b, c) {
        ...
        switch (a) {
          ...
          case CKEDITOR.TRISTATE_DISABLED:
            ...
            break;
          default:
            this.addClass(b + "_off"), this.removeClass(
                b + "_on"), this.removeClass(b + "_disabled"), c
            && this.removeAttribute("aria-pressed"), c && this.removeAttribute(
                "aria-disabled")
        }
      },
      ...
      copyAttributes: function (a, b) {
        ...
        for (var e = 0; e < c.length; e++) {
          ...
          if (!(t in b)) {
            if ("checked" == t && (f = this.getAttribute(
                t))) {
              a.setAttribute(t, f);
            } else if (!CKEDITOR.env.ie
                || this.hasAttribute(t)) {
              f = this.getAttribute(t), null === f
              && (f = d.nodeValue), a.setAttribute(t, f)
            }
          }
        }
        "" !== this.$.style.cssText &&
      ...
      disableContextMenu: function () {
        function a(b) {
          return b.type == CKEDITOR.NODE_ELEMENT && b.hasClass(
      ...
      getEditor: function (a) {
        ...
        a = a || void 0 === a;
        for (c in b) {
          if (e = b[c], e.element.equals(this) && e.elementMode
          != CKEDITOR.ELEMENT_MODE_APPENDTO || !a && (d = e.editable())
      ...
      forEach: function (a, b, c) {
        ...
        if (!1 !== e) {
          ...
          for (var d = 0; d < c.count(); d++) {
            e = c.getItem(d), e.type
            == CKEDITOR.NODE_ELEMENT ? e.forEach(a, b) : b && e.type != b || a(
                e)
          }
        }
      },
      ...
      isDetached: function () {
        ...
        return b.equals(this) || b.contains(this) ? !CKEDITOR.env.ie || 8
            < CKEDITOR.env.version && !CKEDITOR.env.quirks ? !a.$.defaultView : !1
            : !0
      }
    });
    var k = {
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.documentFragment.prototype,
      CKEDITOR.dom.document.prototype, !0, {find: 1, findOne: 1});
  (function () {
    function a(a, b) {
      var c = this.range;
      if (this._.end) {
      ...
      e = c.endContainer;
      var f = c.startOffset, x = c.endOffset, h, g = this.guard, p = this.type,
      ...
      if (!a && !this._.guardLTR) {
        ...
        this._.guardLTR = function (a, b) {
          return (!b || !G.equals(a)) && (!B ||
              !a.equals(B)) && (a.type != CKEDITOR.NODE_ELEMENT || !b
              || !a.equals(c.root))
        }
      }
      if (a && !this._.guardRTL) {
        var k = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
            q = d.type == CKEDITOR.NODE_ELEMENT ? f ? d.getChild(f - 1) : null
                : d.getPrevious();
        this._.guardRTL = function (a, b) {
          return (!b || !k.equals(a)) && (!q || !a.equals(q)) && (a.type
              != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
        }
      }
      ...
      this.current ? e = this.current[D](!1, p, h) : (a ? e.type
          == CKEDITOR.NODE_ELEMENT &&
          (e = 0 < x ? e.getChild(x - 1) : !1 === h(e, !0) ? null
              : e.getPreviousSourceNode(!0, p, h)) : (e = d, e.type
      == CKEDITOR.NODE_ELEMENT && ((e = e.getChild(f)) || (e = !1 === h(d, !0)
          ? null : d.getNextSourceNode(!0, p, h)))), e && !1 === h(e)
      && (e = null));
      for (; e && !this._.end;) {
        this.current = e;
    ...
    CKEDITOR.dom.element.prototype.isBlockBoundary = function (a) {
      return "none" != this.getComputedStyle("float") || this.getComputedStyle(
          "position") in c || !b[this.getComputedStyle("display")] ? !!(this.is(
          CKEDITOR.dtd.$block) || a && this.is(a)) : !0
    };
    ...
    CKEDITOR.dom.walker.whitespaces = function (a) {
      return function (b) {
        var c;
        b && b.type == CKEDITOR.NODE_TEXT && (c = !CKEDITOR.tools.trim(
            b.getText()) || CKEDITOR.env.webkit && b.getText()
    ...
    CKEDITOR.dom.walker.invisible =
        function (a) {
          ...
          return function (e) {
            ...
            && (e = e.getParent()), e = e.$.offsetWidth <= c);
            return !!(a ^ e)
          }
        };
    ...
    CKEDITOR.dom.walker.bogus = function (a) {
      ...
      return function (c) {
        var e = CKEDITOR.env.needsBrFiller ? c.is && c.is("br") : c.getText
            && f.test(c.getText());
    ...
    var f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/,
        ...
        k = CKEDITOR.dom.walker.bookmark(), g = CKEDITOR.dom.walker.temp(),
        l = function (a) {
          return k(a) || h(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(
              CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty)
        };
    ...
    CKEDITOR.dom.walker.editable = function (a) {
      return function (b) {
        b =
            u(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type
            == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is(
                "hr") || "false" == b.getAttribute("contenteditable")
                || !CKEDITOR.env.needsBrFiller && b.is(x) && e(b)) ? !0 : !1;
        return !!(a ^ b)
      }
    };
    CKEDITOR.dom.element.prototype.getBogus = function () {
      ...
      return a && (CKEDITOR.env.needsBrFiller ? a.is && a.is("br") : a.getText
          && f.test(a.getText())) ? a : !1
    }
  })();
  ...
  (function () {
    function a(a) {
      a.collapsed = a.startContainer && a.endContainer
          && a.startContainer.equals(a.endContainer) && a.startOffset
          == a.endOffset
    }
    ...
    function d(a, b, c, d, f) {
      function h(a, b, c, e) {
        ...
        l || e ? b.append(a.clone(!0, f), c) : (a.remove(), u && b.append(a,
            c));
        return A
      }
      ...
      function g() {
        var b = O - 1, c = C && w && !p.equals(D);
        b < H - 1 || b < F - 1 || c ? (c ? a.moveToPosition(D,
            CKEDITOR.POSITION_BEFORE_START) : F == b + 1 && q
            ? a.moveToPosition(n[b], CKEDITOR.POSITION_BEFORE_END)
            : a.moveToPosition(n[b + 1], CKEDITOR.POSITION_BEFORE_START), d
        && (b = S[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT
        && (c = CKEDITOR.dom.element.createFromHtml(
            '\x3cspan data-cke-bookmark\x3d"1" style\x3d"display:none"\x3e\x26nbsp;\x3c/span\x3e',
            a.document), c.insertAfter(b), b.mergeSiblings(
            !1), a.moveToBookmark({startNode: c}))) : a.collapse(!0)
      }

      a.optimizeBookmark();
      var k = 0 === b, u = 1 == b, l = 2 == b;
      b = l || u;
      var p = a.startContainer, D = a.endContainer,
          G = a.startOffset, B = a.endOffset, N, q, C, w, v, Q;
      if (l && D.type == CKEDITOR.NODE_TEXT && (p.equals(D) || p.type
          === CKEDITOR.NODE_ELEMENT && p.getFirst().equals(D))) {
        c.append(
            a.document.createText(D.substring(G, B)));
      } else {
        D.type == CKEDITOR.NODE_TEXT ? l ? Q = !0 : D = D.split(B) : 0
        < D.getChildCount() ? B >= D.getChildCount() ? (D = D.getChild(
            B - 1), q = !0) : D = D.getChild(B) : w = q = !0;
        p.type == CKEDITOR.NODE_TEXT ? l ? v = !0 : p.split(G) : 0
        < p.getChildCount() ? 0 === G ? (p = p.getChild(G), N = !0)
            : p = p.getChild(G - 1) : C = N = !0;
        for (var S = p.getParents(), n = D.getParents(), O = m(),
            H = S.length - 1, F = n.length - 1, K = c, A, ba, L, da = -1, T = O;
            T <= H; T++) {
          ba = S[T];
          L = ba.getNext();
          for (T != H || ba.equals(n[T]) && H < F ? b && (A = K.append(
              ba.clone(0, f))) : N ? h(ba, K, !1, C) : v && K.append(
              a.document.createText(ba.substring(G))); L;) {
            if (L.equals(n[T])) {
              da = T;
              break
            }
        ...
        K = c;
        for (T = O; T <= F; T++) {
          if (c = n[T], L = c.getPrevious(), c.equals(
              S[T])) {
            b && (K = K.getChild(0));
          } else {
            T != F || c.equals(S[T]) && F < H ? b && (A = K.append(
                c.clone(0, f)))
                : q ? h(c, K, !1, w) : Q && K.append(
                a.document.createText(c.substring(0, B)));
            if (T > da) {
              for (; L;) {
                L = h(L, K, !0);
              }
    ...
    function b() {
      ...
      return function (f) {
        return c(f) || b(f) ? !0 : d(f) && !a ? a = !0 : f.type
        == CKEDITOR.NODE_TEXT && (f.hasAscendant("pre") || CKEDITOR.tools.trim(
            f.getText()).length) || f.type == CKEDITOR.NODE_ELEMENT && !f.is(h)
            ? !1 : !0
      }
    }
    ...
    var h = {
        ...
        l = CKEDITOR.dom.walker.editable(), u = CKEDITOR.dom.walker.ignored(!0);
    CKEDITOR.dom.range.prototype = {
      ...
      collapse: function (a) {
        a ? (this._setEndContainer(
            this.startContainer), this.endOffset = this.startOffset)
            : (this._setStartContainer(
      ...
      equals: function (a) {
        return this.startOffset === a.startOffset && this.endOffset
            === a.endOffset && this.startContainer.equals(a.startContainer)
            ...
            if (b = a.data && a.data("cke-temp")) {
              b = -1
                  === CKEDITOR.tools.array.indexOf(
                      ["cke_copybin", "cke_pastebin"], a.getAttribute("id"));
            }
            return b
          }, !0)
        }

        var c = this.startContainer, d = this.endContainer, f = this.collapsed,
            h, m, g, k;
        h = this.document.createElement("span");
        h.data("cke-bookmark", 1);
        h.setStyle("display", "none");
        h.setHtml("\x26nbsp;");
        a && (g = "cke_bm_" + CKEDITOR.tools.getNextNumber(), h.setAttribute(
            "id", g + (f ? "C" : "S")));
        f || (m = h.clone(), m.setHtml("\x26nbsp;"), a && m.setAttribute("id",
            g + "E"), k = this.clone(), b(d) && (d = b(d),
            k.moveToPosition(d,
                CKEDITOR.POSITION_AFTER_END)), k.collapse(), k.insertNode(m));
        k = this.clone();
        b(c) && (d = b(c), k.moveToPosition(d, CKEDITOR.POSITION_BEFORE_START));
        k.collapse(!0);
        k.insertNode(h);
        m ? (this.setStartAfter(h), this.setEndBefore(m)) : this.moveToPosition(
            h, CKEDITOR.POSITION_AFTER_END);
        return {
      ...
      createBookmark2: function () {
        function a(b) {
          ...
          m = e;
          var f = d;
          m = m.type != CKEDITOR.NODE_ELEMENT || 0 === f || f
          == m.getChildCount() ?
              0 : m.getChild(f - 1).type == CKEDITOR.NODE_TEXT && m.getChild(
          ...
          if (e.type == CKEDITOR.NODE_TEXT) {
            m = e;
            for (f = 0; (m = m.getPrevious()) && m.type
            == CKEDITOR.NODE_TEXT;) {
              f += m.getText().replace(
                  CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE, "").length;
            }
            m = f;
            e.isEmpty() ? (f = e.getPrevious(c), m ? (d = m, e = f ? f.getNext()
                : e.getParent().getFirst()) : (e = e.getParent(),
        ...
        function b(a, c) {
          ...
          if (e) {
            var d = a.container;
            e.equals(d)
            && (a.offset -= CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE.length, 0
            >= a.offset
      ...
      moveToBookmark: function (a) {
        if (a.is2) {
          ...
          b = (c = a.serializable) ? this.document.getById(a.startNode)
              : a.startNode, a = c ? this.document.getById(a.endNode) :
              a.endNode, this.setStartBefore(b), b.remove(), a
              ? (this.setEndBefore(a), a.remove()) : this.collapse(!0)
        }
      },
      getBoundaryNodes: function () {
        var a = this.startContainer, b = this.endContainer,
            c = this.startOffset, d = this.endOffset, f;
        if (a.type == CKEDITOR.NODE_ELEMENT) {
          if (f = a.getChildCount(), f
          > c) {
            a = a.getChild(c);
          } else if (1
              > f) {
      ...
      optimizeBookmark: function () {
        var a = this.startContainer, b = this.endContainer;
        a.is && a.is("span") && a.data("cke-bookmark") && this.setStartAt(a,
            CKEDITOR.POSITION_BEFORE_START);
        b && b.is && b.is("span") && b.data("cke-bookmark") && this.setEndAt(b,
      ...
      trim: function (a,
        ...
        if ((!a || f) && c && c.type == CKEDITOR.NODE_TEXT) {
          if (d) {
            if (d >= c.getLength()) {
              ...
              this.startContainer.equals(this.endContainer) ? this.setEnd(h,
        ...
        d = this.endOffset;
        b || f || !c || c.type !=
        CKEDITOR.NODE_TEXT || (d ? (d >= c.getLength() || c.split(
            d), d = c.getIndex() + 1)
            : d = c.getIndex(), c = c.getParent(), this.setEnd(c, d))
      },
      enlarge: function (a, b) {
        function c(a) {
          return a && a.type == CKEDITOR.NODE_ELEMENT && a.hasAttribute(
              "contenteditable") ? null : a
        }
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_ELEMENT:
            ...
            var m = this.getCommonAncestor(), g = this.root, k, u, l, p, D,
                G = !1, B, N;
            B = this.startContainer;
            var q = this.startOffset;
            B.type == CKEDITOR.NODE_TEXT ? (q && (B = !CKEDITOR.tools.trim(
                B.substring(0, q)).length && B, G = !!B), B
            && ((p = B.getPrevious()) || (l = B.getParent()))) : (q
            && (p = B.getChild(q - 1) || B.getLast()), p || (l = B));
            for (l = c(l); l || p;) {
              if (l && !p) {
                !D && l.equals(m) && (D = !0);
                if (f ? l.isBlockBoundary() : !g.contains(l)) {
                  break;
                }
                G && "inline" == l.getComputedStyle("display") || (G = !1, D
                    ? k = l : this.setStartBefore(l));
                p = l.getPrevious()
              }
              for (; p;) {
                if (B = !1, p.type
                == CKEDITOR.NODE_COMMENT) {
                  ...
                  if (p.type == CKEDITOR.NODE_TEXT) {
                    N = p.getText(), d.test(N)
                    && (p = null), B = /[\s\ufeff]$/.test(
                        N);
                  } else if ((p.$.offsetWidth > (CKEDITOR.env.webkit ? 1
                      : 0) || b && p.is("br")) && !p.data("cke-bookmark")) {
                    if (G
                        && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                      N = p.getText();
                      if (d.test(
                          N)) {
                        p = null;
                      } else {
                        for (var q = p.$.getElementsByTagName(
                            "*"), C = 0, w;
                            w = q[C++];) {
            ...
            l = p = null;
            D = G = !1;
            B.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(
                B.substring(q)).length ? G = !0 : (G = !B.getLength(), q
            == B.getLength() ? (p = B.getNext()) || (l = B.getParent()) :
                h(B, q) && (l = B.getParent())) : (p = B.getChild(q))
                || (l = B);
            for (; l || p;) {
              if (l && !p) {
                !D && l.equals(m) && (D = !0);
              ...
              for (; p;) {
                ...
                if (p.type == CKEDITOR.NODE_TEXT) {
                  ...
                  || (p = null), B = /^[\s\ufeff]/.test(N);
                    ...
                    == CKEDITOR.NODE_ELEMENT) {
                  if ((0 < p.$.offsetWidth || b && p.is("br")) && !p.data(
                      "cke-bookmark")) {
                    if (G
                        && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                      N = p.getText();
            ...
            k && u && (m = k.contains(u) ? u : k, this.setStartBefore(
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            var v, Q, S = CKEDITOR.dom.walker.blockBoundary(
                a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null),
                n = null, O = function (a) {
                  if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute(
                      "contenteditable")) {
                    if (n) {
                      if (n.equals(a)) {
                        n = null;
            ...
            v = v || g;
            this.setStartAt(v,
                !v.is("br") && (!l && this.checkStartOfBlock() || l
                    && v.contains(l)) ? CKEDITOR.POSITION_AFTER_START
                    : CKEDITOR.POSITION_AFTER_END);
            if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
              ...
              if ((l = l.previous()) && l.type == CKEDITOR.NODE_ELEMENT && l.is(
                  "br")) {
                break
              }
            }
            ...
            l = l.lastForward();
            v = v || g;
            this.setEndAt(v, !l && this.checkEndOfBlock() || l && v.contains(l)
      ...
      shrink: function (a, b, c) {
        var d = "boolean" === typeof c ? c : c && "boolean"
            === typeof c.shrinkOnBlockBoundary ? c.shrinkOnBlockBoundary : !0,
            f = c && c.skipBogus;
        if (!this.collapsed) {
          a = a || CKEDITOR.SHRINK_TEXT;
          var h = this.clone(), m = this.startContainer, g = this.endContainer,
              k = this.startOffset, l = this.endOffset,
              u = c = 1;
          m && m.type == CKEDITOR.NODE_TEXT && (k ? k >= m.getLength()
              ? h.setStartAfter(m) : (h.setStartBefore(m), c = 0)
              : h.setStartBefore(m));
          g && g.type == CKEDITOR.NODE_TEXT && (l ? l >= g.getLength()
              ? h.setEndAfter(g) : (h.setEndAfter(g), u = 0) : h.setEndBefore(
              g));
          ...
          h.guard = function (b, c) {
            ...
            if (a == CKEDITOR.SHRINK_ELEMENT &&
                b.type == CKEDITOR.NODE_TEXT || c && b.equals(G) || !1 === d
                && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary()
                || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute(
                    "contenteditable")) {
              return !1;
            }
          ...
          c && (m = h[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]())
          && this.setStartAt(m, b ? CKEDITOR.POSITION_AFTER_START
              : CKEDITOR.POSITION_BEFORE_START);
          u && (h.reset(), (h = h[a == CKEDITOR.SHRINK_ELEMENT ? "lastBackward"
              : "previous"]()) && this.setEndAt(h,
      ...
      setStartAt: function (b, c) {
        switch (c) {
          ...
          case CKEDITOR.POSITION_BEFORE_END:
            b.type == CKEDITOR.NODE_TEXT ? this.setStart(b, b.getLength())
                : this.setStart(b,
                b.getChildCount());
            break;
      ...
      setEndAt: function (b, c) {
        switch (c) {
          case CKEDITOR.POSITION_AFTER_START:
            ...
            break;
          case CKEDITOR.POSITION_BEFORE_END:
            b.type == CKEDITOR.NODE_TEXT ? this.setEnd(b, b.getLength())
      ...
      splitBlock: function (a, b) {
        var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root),
            ...
            f = c.block, h = d.block, m = null;
        if (!c.blockLimit.equals(d.blockLimit)) {
          return null;
        }
        "br" !=
        a && (f || (f = this.fixBlock(!0, a), h = (new CKEDITOR.dom.elementPath(
            this.endContainer, this.root)).block), h || (h = this.fixBlock(!1,
            a)));
        c = f && this.checkStartOfBlock();
        d = h && this.checkEndOfBlock();
        this.deleteContents();
        f && f.equals(h) && (d ? (m = new CKEDITOR.dom.elementPath(
            this.startContainer, this.root), this.moveToPosition(h,
            CKEDITOR.POSITION_AFTER_END), h = null) : c
            ? (m = new CKEDITOR.dom.elementPath(this.startContainer,
                this.root), this.moveToPosition(f,
      ...
      removeEmptyBlocksAtEnd: function () {
        function a(e) {
          return function (a) {
            return b(a) || c(a) || a.type == CKEDITOR.NODE_ELEMENT
        ...
        return function (b) {
          for (var c = this.createBookmark(),
              ...
              f = d.block || d.blockLimit, h;
              f && !f.equals(d.root) && !f.getFirst(
                  a(f));) {
            h = f.getParent(), this[b ? "setEndAt"
                : "setStartAt"](f, CKEDITOR.POSITION_AFTER_END), f.remove(
                1), f = h;
          }
          this.moveToBookmark(c)
        }
      ...
      checkStartOfBlock: function () {
        ...
        CKEDITOR.env.ie && c && a.type == CKEDITOR.NODE_TEXT
        && (a = CKEDITOR.tools.ltrim(a.substring(0, c)), g.test(a) && this.trim(
            0, 1));
        this.trim();
      ...
      checkEndOfBlock: function () {
        ...
        CKEDITOR.env.ie && a.type == CKEDITOR.NODE_TEXT
        && (a = CKEDITOR.tools.rtrim(a.substring(c)), g.test(a) && this.trim(1,
            0));
        this.trim();
      ...
      checkReadOnly: function () {
        function a(b, c) {
          for (; b;) {
            if (b.type ==
                CKEDITOR.NODE_ELEMENT) {
              if ("false" == b.getAttribute("contentEditable") && !b.data(
                  "cke-editable")) {
                return 0;
              }
              if (b.is("html") || "true" == b.getAttribute("contentEditable")
      ...
      moveToElementEditablePosition: function (a, b) {
        if (a.type == CKEDITOR.NODE_ELEMENT && !a.isEditable(
            !1)) {
          return this.moveToPosition(a,
              b ? CKEDITOR.POSITION_AFTER_END : CKEDITOR.POSITION_BEFORE_START),
              !0;
        }
        for (var c = 0; a;) {
          if (a.type == CKEDITOR.NODE_TEXT) {
            b && this.endContainer && this.checkEndOfBlock() && g.test(
                a.getText()) ? this.moveToPosition(a,
                CKEDITOR.POSITION_BEFORE_START) : this.moveToPosition(a,
          ...
          if (a.type
            ...
            if (a.isEditable()) {
              this.moveToPosition(
                  a, b ? CKEDITOR.POSITION_BEFORE_END
                      : CKEDITOR.POSITION_AFTER_START), c = 1;
            } else if (b && a.is(
                "br") && this.endContainer
                && this.checkEndOfBlock()) {
              this.moveToPosition(a,
                  CKEDITOR.POSITION_BEFORE_START);
            } else if ("false" == a.getAttribute("contenteditable") && a.is(
                CKEDITOR.dtd.$block)) {
              return this.setStartBefore(
                  a), this.setEndAfter(a), !0;
            }
          }
          var d = a, f = c, h = void 0;
          d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(!1) && (h = d[b
              ? "getLast" : "getFirst"](u));
      ...
      moveToClosestEditablePosition: function (a, b) {
        ...
        a ? (c = new CKEDITOR.dom.range(this.root), c.moveToPosition(a,
            m[b ? 0 : 1])) : c = this.clone();
        if (a &&
          ...
          d = 1, (h = f.type
              == CKEDITOR.NODE_ELEMENT) && f.is(CKEDITOR.dtd.$block) && "false"
          == f.getAttribute("contenteditable") ? (c.setStartAt(f,
              CKEDITOR.POSITION_BEFORE_START), c.setEndAt(f,
              CKEDITOR.POSITION_AFTER_END)) : !CKEDITOR.env.needsBrFiller && h
          && f.is(CKEDITOR.dom.walker.validEmptyBlockContainers) ? (c.setEnd(f,
              0), c.collapse()) : c.moveToPosition(f, m[b ? 1 : 0]);
        }
      ...
      getTouchedStartNode: function () {
        ...
        return this.collapsed || a.type != CKEDITOR.NODE_ELEMENT ? a
      ...
      _getTableElement: function (a) {
        ...
        var b = this.getTouchedStartNode(), c = this.getTouchedEndNode(),
            d = b.getAscendant("table", !0), c = c.getAscendant("table", !0);
        return d && !this.root.contains(d) ?
            null : this.getEnclosedNode() ? this.getEnclosedNode().getAscendant(
                a, !0) : d && c && (d.equals(c) || d.contains(c) || c.contains(
                d)) ? b.getAscendant(a, !0) : null
      },
      scrollIntoView: function () {
        var a = new CKEDITOR.dom.element.createFromHtml(
            "\x3cspan\x3e\x26nbsp;\x3c/span\x3e", this.document), b, c, d,
            f = this.clone();
        f.optimize();
        (d = f.startContainer.type == CKEDITOR.NODE_TEXT)
            ? (c = f.startContainer.getText(), b = f.startContainer.split(
            f.startOffset), a.insertAfter(f.startContainer)) : f.insertNode(a);
        a.scrollIntoView();
      ...
      getClientRects: function () {
        function a(b, c) {
          ...
          c.startContainer instanceof CKEDITOR.dom.element && (h = 0
              === c.startOffset && c.startContainer.hasAttribute(
                  "data-widget"));
          c.endContainer instanceof CKEDITOR.dom.element
          && (g = (g = c.endOffset === (c.endContainer.getChildCount
              ? c.endContainer.getChildCount() : c.endContainer.length))
              && c.endContainer.hasAttribute("data-widget"));
          h && e.setStart(c.startContainer.getParent(),
              c.startContainer.getIndex());
          g && e.setEnd(c.endContainer.getParent(),
            ...
            return e = CKEDITOR.tools.array.map(e, function (a) {
              ...
              function b(e) {
                CKEDITOR.tools.array.forEach(d, function (b, f) {
                  ...
                  h && (Array.prototype.splice.call(d, f, a.length - e,
                      a.widgetRect), c = !0)
                });
        ...
        function b(a, c, e) {
          ...
          c.collapsed ? e.startContainer instanceof CKEDITOR.dom.element ?
              (a = e.checkStartOfBlock(), f = new CKEDITOR.dom.text("​"), a
                  ? e.startContainer.append(f, !0) : 0 === e.startOffset
                      ? f.insertBefore(e.startContainer.getFirst())
                      : (e = e.startContainer.getChildren().getItem(
                          e.startOffset - 1), f.insertAfter(e)), c.setStart(f.$,
                  0), c.setEnd(f.$, 0), a = c.getClientRects(), f.remove())
              : e.startContainer instanceof CKEDITOR.dom.text && (""
          === e.startContainer.getText() ? (e.startContainer.setText(
              "​"), a = c.getClientRects(), e.startContainer.setText(""))
        ...
        function c(a, b, d) {
          ...
          b && (a = CKEDITOR.tools.getAbsoluteRectPosition(
              d.document.getWindow(), a));
        ...
        function d(a) {
          ...
          a ? (a.setText("​"), a.removeStyle("display"), c = [b.getClientRect(),
            a.getClientRect()], a.remove()) : c = [b.getClientRect(),
            b.getClientRect()];
          b.remove();
          return {
            ...
            height: Math.max(c[0].bottom, c[1].bottom) - Math.min(c[0].top,
                c[1].top)
          }
        }
      ...
      _find: function (a, b) {
        var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), f = [],
            h, m, g, k;
        if (c && c.find) {
          for (m = c.find(a), h = 0; h < m.count();
              h++) {
            if (c = m.getItem(h), b || !c.isReadOnly()) {
              g = c.getPosition(
                  d.startNode) & CKEDITOR.POSITION_FOLLOWING
                  || d.startNode.equals(
                      c), k = c.getPosition(d.endNode)
                  & CKEDITOR.POSITION_PRECEDING
  ...
  (function () {
    ...
    function b(a, c, f, h) {
      ...
      if ((g = CKEDITOR.filter.instances[h.element.data("cke-filter")])
          && !g.check(c)) {
        return b(a,
            c, f, h.remaining);
      }
    ...
    a.prototype = {
      getNextParagraph: function (a) {
        ...
        if (this._.nestedEditable) {
          if (d = this._.nestedEditable.iterator.getNextParagraph(
              a)) {
          ...
          if (b(this, a, this._.nestedEditable.container,
            ...
            return this.activeFilter = this._.nestedEditable.iterator.activeFilter, this._.nestedEditable.iterator.getNextParagraph(
                a);
          }
        ...
        if (!this._.started) {
          ...
          k = r.startPath();
          var m = r.endPath(), M = !r.collapsed && c(r, k.block),
          ...
          k = r.endContainer.hasAscendant("pre", !0)
              || r.startContainer.hasAscendant("pre", !0);
          r.enlarge(this.forceBrBreak && !k || !this.enlargeBr
              ? CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS
              : CKEDITOR.ENLARGE_BLOCK_CONTENTS);
          r.collapsed || (k = new CKEDITOR.dom.walker(
              r.clone()), m = CKEDITOR.dom.walker.bookmark(!0,
              !0), k.evaluator = m, this._.nextNode = k.next(), k = new CKEDITOR.dom.walker(
              r.clone()), k.evaluator = m, k = k.previous(), this._.lastNode = k.getNextSourceNode(
              !0, null, r.root), this._.lastNode && this._.lastNode.type
          == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(
              this._.lastNode.getText())
          && this._.lastNode.getParent().isBlockBoundary()
          && (m = this.range.clone(), m.moveToPosition(this._.lastNode,
              CKEDITOR.POSITION_AFTER_END), m.checkEndOfBlock() &&
          (m = new CKEDITOR.dom.elementPath(m.endContainer,
              m.root), this._.lastNode = (m.block
              || m.blockLimit).getNextSourceNode(!0))), this._.lastNode
          && r.root.contains(this._.lastNode)
          || (this._.lastNode = this._.docEndMarker = r.document.createText(
              ""), this._.lastNode.insertAfter(k)), r = null);
          this._.started = 1;
          k = r
        }
        m = this._.nextNode;
        ...
        for (this._.nextNode = null; m;) {
          var M = 0, y = m.hasAscendant("pre"),
              J = m.type != CKEDITOR.NODE_ELEMENT, E = 0;
          if (J) {
            m.type == CKEDITOR.NODE_TEXT && f.test(m.getText())
            && (J = 0);
          } else {
            var p = m.getName();
            if (CKEDITOR.dtd.$block[p] && "false" == m.getAttribute(
              ...
              if ("br" == p) {
                J = 1;
              } else if (!k && !m.getChildCount() && "hr"
                  != p) {
                d = m;
                t = m.equals(r);
                break
              }
              k && (k.setEndAt(m, CKEDITOR.POSITION_BEFORE_START), "br" != p
              && (this._.nextNode = m));
              M = 1
            } else {
              if (m.getFirst()) {
                k || (k = this.range.clone(), k.setStartAt(m,
                    CKEDITOR.POSITION_BEFORE_START));
                m = m.getFirst();
                continue
              }
          ...
          J && !k && (k = this.range.clone(), k.setStartAt(m,
              CKEDITOR.POSITION_BEFORE_START));
          t = (!M || J) && m.equals(r);
          if (k && !M) {
            for (; !m.getNext(g) && !t;) {
        ...
        if (!d) {
          if (!k) {
            return this._.docEndMarker
            && this._.docEndMarker.remove(), this._.nextNode = null;
          }
          d = new CKEDITOR.dom.elementPath(k.startContainer, k.root);
          m = d.blockLimit;
          M = {div: 1, th: 1, td: 1};
          d = d.block;
          !d && m && !this.enforceRealBlocks && M[m.getName()]
          && k.checkStartOfBlock() && k.checkEndOfBlock() && !m.equals(k.root)
              ? d = m : !d || this.enforceRealBlocks && d.is(l)
              ? (d = this.range.document.createElement(
                  a), k.extractContents().appendTo(d), d.trim(), k.insertNode(
                  d), z = I = !0) : "li" != d.getName() ? k.checkStartOfBlock()
                  && k.checkEndOfBlock() || (d = d.clone(
                      !1), k.extractContents().appendTo(
                      d), d.trim(), I = k.splitBlock(), z = !I.wasStartOfBlock, I = !I.wasEndOfBlock, k.insertNode(
                      d)) : t || (this._.nextNode = d.equals(r) ? null
                  : this._getNextSourceNode(k.getBoundaryNodes().endNode,
                      1, r))
        }
        z && (z = d.getPrevious()) && z.type == CKEDITOR.NODE_ELEMENT && ("br"
        == z.getName() ? z.remove() : z.getLast() && "br"
            == z.getLast().$.nodeName.toLowerCase() && z.getLast().remove());
        I && (z = d.getLast()) && z.type == CKEDITOR.NODE_ELEMENT && "br"
        == z.getName() && (!CKEDITOR.env.needsBrFiller || z.getPrevious(h)
            || z.getNext(h)) && z.remove();
        this._.nextNode || (this._.nextNode = t || d.equals(r) || !r ? null
            : this._getNextSourceNode(d, 1, r));
        return d
        ...
        var f =
            this.range.root;
        for (a = a.getNextSourceNode(b, null, d);
            !h(a);) {
  ...
  CKEDITOR.command = function (a, d) {
    ...
    this.refresh = function (a, b) {
      ...
      if (this.context && !b.isContextFor(this.context) || !this.checkAllowed(
          !0)) {
      ...
      return !1 === this.fire("refresh",
          {editor: a, path: b}) ? !0 : d.refresh && !1 !== d.refresh.apply(this,
          arguments)
    };
    var b;
    this.checkAllowed = function (c) {
      return c || "boolean" != typeof b ? b = a.activeFilter.checkFeature(this)
          : b
    };
  ...
  CKEDITOR.command.prototype = {
    enable: function () {
      ...
      if (this.state == a || a != CKEDITOR.TRISTATE_DISABLED
          && !this.checkAllowed()) {
        return !1;
      }
      ...
      this.state == CKEDITOR.TRISTATE_OFF ?
          this.setState(CKEDITOR.TRISTATE_ON) : this.state
          == CKEDITOR.TRISTATE_ON && this.setState(CKEDITOR.TRISTATE_OFF)
    }
  };
  ...
  CKEDITOR.config = {
    ...
    width: "",
    baseFloatZIndex: 1E4,
    blockedKeystrokes: [CKEDITOR.CTRL + 66, CKEDITOR.CTRL + 73,
      CKEDITOR.CTRL + 85]
  };
  (function () {
    function a(a, b, c, d, e) {
      ...
      for (f in b) {
        p = b[f];
        p = "boolean" == typeof p ? {} : "function" == typeof p ? {match: p}
            : C(p);
        ...
        for (q in Q) {
          n[q] = k(n[q], w) || null;
          var h = n, m = S[q], g = k(n[S[q]], w), H = n[q], v = [], D = !0,
              O = void 0;
          g ? D = !1 : g = {};
          for (O in H) {
            "!" == O.charAt(0) && (O = O.slice(1), v.push(
                O), g[O] = !0, D = !1);
          }
          for (; O = v.pop();) {
            H[O] =
      ...
      for (d = a.length; c < d; ++c) {
        ...
        for (q in S) {
          ...
          for (H in m) {
            -1 < H.indexOf("*") ? g.push(
                new RegExp("^" + H.replace(/\*/g, ".*") + "$")) : g.push(H);
          }
          m = g;
          m.length && (n[w] = m, h = !1)
        }
        ...
        if (!0 === f.elements ||
          ...
          for (F in
              n = f.elements, delete f.elements, n) {
            if (b[F]) {
              b[F][p ? "unshift"
                  : "push"](f);
            } else {
    ...
    function d(a, c, d, e) {
      if (!a.match || a.match(c)) {
        if (e || g(a, c)) {
          if (a.propertiesOnly
          || (d.valid = !0), d.allAttributes || (d.allAttributes = b(
              a.attributes,
              c.attributes, d.validAttributes)), d.allStyles
          || (d.allStyles = b(
              a.styles, c.styles, d.validStyles)), !d.allClasses) {
            a = a.classes;
            c = c.classes;
            e = d.validClasses;
            if (a) {
    ...
    function c(a, b, c) {
      if (!a.match || a.match(b)) {
        ...
        c.hadInvalidAttribute = f(a.attributes, b.attributes)
    ...
    function g(a, b) {
      ...
      if (e = a.requiredClasses) {
        for (f = b.classes, c = 0; c < e.length;
            ++c) {
          if (d = e[c], "string" == typeof d) {
            if (-1 == CKEDITOR.tools.indexOf(f, d)) {
              return !1
            }
      ...
      return l(b.styles, a.requiredStyles) && l(b.attributes,
    ...
    function l(a, b) {
      ...
      for (var c = 0, d; c < b.length; ++c) {
        ...
        } else if (!CKEDITOR.tools.checkIfAnyObjectPropertyMatches(a,
            d)) {
          return !1;
        }
      }
    ...
    function e(a) {
      ...
      for (a = w(a); b = a.match(n);) {
        (c = b[2]) ? (d = x(c, "styles"), e = x(c,
            "attrs"), c = x(c, "classes")) : d = e = c = null, f["$" + p++] = {
          elements: b[1],
          classes: c,
          styles: d,
          attributes: e
      ...
      if (f.doFilter) {
        a:{
          ...
          if (a || w) {
            ...
            if (h) {
              for (v = 0, C = h.length; v < C; ++v) {
                c(h[v], b, k);
              }
            }
            if (a) {
              for (v = 0, C = a.length; v < C; ++v) {
                d(a[v], b, k, g);
              }
            }
            if (w) {
              for (v = 0, C = w.length; v < C; ++v) {
                d(w[v], b, k, g);
              }
            }
            a = k
        ...
        var O = a.validStyles;
        w = a.validClasses;
        var q = b.attributes, D = b.styles, h = b.classes;
        g = b.classBackup;
        var B = b.styleBackup, G, l, K = [], k = [], N = /^data-cke-/;
        v = !1;
        delete q.style;
        delete q["class"];
        ...
        if (!a.allAttributes) {
          for (G in q) {
            C[G] || (N.test(G) ? G
                == (l = G.replace(/^data-cke-saved-/, "")) || C[l]
                || (delete q[G], v = !0) : (delete q[G], v = !0));
          }
        }
        if (!a.allStyles || a.hadInvalidStyle) {
          for (G in D) {
            a.allStyles || O[G] ? K.push(G + ":" + D[G]) : v = !0;
          }
    ...
    function E(a, b, c) {
      ...
      if (q.$empty[d] || !a.children.length) {
        "hr" == d && "br" == b
            ? a.replaceWith(y()) : (a.parent && c.push(
            {check: "it", el: a.parent}), a.remove());
      } else if (q.$block[d]
          || "tr" == d) {
        if ("br" == b) {
          a.previous && !J(a.previous)
          && (b = y(), b.insertBefore(a)), a.next && !J(a.next)
          && (b = y(), b.insertAfter(a)), a.replaceWithChildren();
        } else {
          var d = a.children, e;
          b:{
            e = q[b];
            for (var f = 0, p = d.length, n; f < p; ++f) {
              if (n = d[f], n.type
              == CKEDITOR.NODE_ELEMENT && !e[n.name]) {
                e = !1;
                break b
              }
            }
          ...
          if (e) {
            ...
            e = a.parent;
            for (var f = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body"
                == e.name, w, h, p = d.length; 0 < p;) {
              n = d[--p], f && (n.type
                  == CKEDITOR.NODE_TEXT || n.type == CKEDITOR.NODE_ELEMENT
                  && q.$inline[n.name]) ? (w
                  || (w = new CKEDITOR.htmlParser.element(b), w.insertAfter(
                  a), c.push(
                  {check: "parent-down", el: w})), w.add(n, 0))
                  : (w = null, h = q[e.name] || q.span, n.insertAfter(a), e.type
                  == CKEDITOR.NODE_DOCUMENT_FRAGMENT || n.type
                  != CKEDITOR.NODE_ELEMENT || h[n.name] || c.push(
                      {check: "el-up", el: n}));
            }
            a.remove()
          }
        ...
        {style: 1, script: 1} ? a.remove() : (a.parent && c.push(
            {check: "it", el: a.parent}), a.replaceWithChildren())
      }
    }
    ...
    function p(a, b, c) {
      ...
      for (d = 0; d < c.length; ++d) {
        if (e = c[d], !(e.check && !a.check(
            e.check, !1) || e.left && !e.left(b))) {
          e.right(b, K);
          break
        }
      }
    ...
    function D(a, b) {
      var c = b.getDefinition(), d = c.attributes, e = c.styles, f, p, n, w;
      if (a.name != c.element) {
        return !1;
      }
      for (f in d) {
        if ("class" == f) {
          for (c = d[f].split(
              /\s+/), n = a.classes.join("|"); w = c.pop();) {
            if (-1 == n.indexOf(w)) {
              return !1
            }
          }
        } else if (a.attributes[f] != d[f]) {
          return !1;
        }
      }
      for (p in e) {
    ...
    function G(a, b) {
      var c, d;
      "string" == typeof a ? c = a : a instanceof CKEDITOR.style ? d = a
          : (c = a[0], d = a[1]);
      return [{
    ...
    var q = CKEDITOR.dtd, C = CKEDITOR.tools.copy, w = CKEDITOR.tools.trim,
        v = ["", "p", "br", "div"];
    ...
    CKEDITOR.filter = function (a, b) {
      ...
      if (c && !b) {
        ...
        !0 === d ? this.disabled = !0 : (d
        || (this.customConfig = !1), this.allow(d, "config", 1), this.allow(
            c.config.extraAllowedContent, "extra", 1), this.allow(
            v[c.enterMode] +
            " " + v[c.shiftEnterMode], "default", 1), this.disallow(
            c.config.disallowedContent))
      } else {
        this.customConfig = !1, this.allow(b || a, "default", 1)
      }
    };
      ...
      allow: function (b, c, d) {
        ...
        if ("string" == typeof b) {
          b = e(b);
            ...
            instanceof CKEDITOR.style) {
          if (b.toAllowedContentRules) {
            return this.allow(
                b.toAllowedContentRules(this.editor), c, d);
          }
          f = b.getDefinition();
          b = {};
          d = f.attributes;
          ...
          d && (d = C(d), f.classes = d["class"] ? d["class"].split(/\s+/)
              : null, f.requiredClasses = f.classes, delete d["class"], f.attributes = d, f.requiredAttributes = d
              && CKEDITOR.tools.object.keys(d))
        } else if (CKEDITOR.tools.isArray(b)) {
          for (f = 0; f < b.length; ++f) {
            p = this.allow(b[f], c, d);
          }
          return p
        }
        ...
        var e = this, f = [],
            p = this.editor && this.editor.config.protectedSource, n, w = !1,
        ...
        a.forEach(function (a) {
          if (a.type == CKEDITOR.NODE_ELEMENT) {
            ...
            if (!b || "span" != a.name || !~CKEDITOR.tools.object.keys(
                a.attributes).join("|").indexOf("data-cke-")) {
              if (n = z(e, a, f,
                  h), n & 1) {
                w = !0;
              } else if (n & 2) {
            ...
            a:{
              ...
              1 == d.children.length && (A = d.children[0]).type
              == CKEDITOR.NODE_ELEMENT && z(e, A, c, h);
              c = !c.length
            }
            c || f.push(a)
          }
        ...
        for (var k; c = f.pop();) {
          c.type == CKEDITOR.NODE_ELEMENT ? E(c, d, a)
              : c.remove();
        }
        for (;
            g = a.pop();) {
          if (c = g.el, c.parent) {
            switch (k = q[c.parent.name]
                || q.span, g.check) {
              case "it":
                q.$removeEmpty[c.name] && !c.children.length ? E(c, d, a) : m(c)
                    || E(c, d, a);
                break;
              case "el-up":
                c.parent.type ==
                ...
                break;
              case "parent-down":
                c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || k[c.name]
                || E(
                    c.parent, d, a)
            }
          }
      ...
      addContentForms: function (a) {
        if (!this.disabled && a) {
          ...
          for (b = 0; b < a.length && !e; ++b) {
            c = a[b], ("string" == typeof c
                || c instanceof CKEDITOR.style) && this.check(c) && (e = c);
          }
          if (e) {
        ...
        return a.requiredContent && (this.customConfig
            || this.disallowedContent.length) ? this.check(a.requiredContent)
            : !0
        ...
        if (!this.disabled && a) {
          ...
          for (e = 0; e < a.length; ++e) {
            b = a[e];
            var f = void 0, p = void 0, n = void 0, w = void 0, q = void 0,
                h = void 0;
            c = [];
            for (p = 0; p < b.length; ++p) {
              n = b[p], "string" == typeof n
                  ? (n = n.split(/\s*:\s*/), w = n[0], q = null, h = n[1])
                  : (w = n.check, q = n.left, h = n.right), f
              || (f = n, f = f.element ? f.element : w ? w.match(
                  /^([a-z0-9]+)/i)[0] :
                  f.left.getDefinition().element), q instanceof CKEDITOR.style
              && (q = B(q)), c.push({
                check: w == f ? null : w,
                left: q,
        ...
        if ("string" == typeof a) {
          ...
          if (n in this._.cachedChecks) {
            return this._.cachedChecks[n];
          }
          f = e(a).$1;
          var w = f.styles, d = f.classes;
          f.name = f.elements;
          ...
          f = a.getDefinition(), w = f.styles, d = f.attributes || {}, w
          && !CKEDITOR.tools.isEmpty(w) ? (w = C(
              w), d.style = CKEDITOR.tools.writeCssText(w, !0)) : w = {}, f = {
            name: f.element,
            attributes: d,
        ...
        var w = CKEDITOR.tools.clone(f), q = [], h;
        ...
        0 < q.length ? c = !1 : ((b = f.attributes["class"])
        && (f.attributes["class"] = f.attributes["class"].split(
            " ").sort().join(" ")), c = CKEDITOR.tools.objectCompare(
            f.attributes, w.attributes, !0), b && (f.attributes["class"] = b));
    ...
    var Q = {styles: 1, attributes: 1, classes: 1}, S = {
        ...
        O = {
          ...
          attrs: /\[([^\]]+)\]/,
          classes: /\(([^\)]+)\)/
        }, H = /^cke:(object|embed|param)$/, F = /^(object|embed|param)$/, K;
    K = CKEDITOR.filter.transformationsTools = {
      sizeToStyle: function (a) {
        ...
        if (!(c in a.attributes)) {
          ...
          f ? a.attributes[c] = f[1] : "cke-test" == d
        ...
        if ("string" == typeof b) {
          ...
          var c = b.getDefinition(), d = c.styles, f = c.attributes, e, p, n, w;
          a.name = c.element;
          for (e in f) {
            if ("class" == e) {
              for (c =
                  a.classes.join("|"), n = f[e].split(/\s+/); w = n.pop();) {
                -1
                == c.indexOf(w) && a.classes.push(w);
              }
            } else {
              a.attributes[e] = f[e];
            }
  ...
  (function () {
    ...
    CKEDITOR.focusManager.prototype = {
      focus: function (a) {
        ...
        && a.focusManager.blur(
            1), this.hasFocus = !0, (a = this._.editor.container) && a.addClass(
            "cke_focus"), this._.editor.fire("focus"))
      }, lock: function () {
        this._.locked =
            1
      }, unlock: function () {
        ...
        if (!this._.locked) {
          ...
          a || !b ? d.call(this) : this._.timer = CKEDITOR.tools.setTimeout(
              function () {
                delete this._.timer;
                d.call(this)
              }, b, this)
        ...
        if (!b || b != this) {
          ...
          var b =
              "focus", c = "blur";
          d && (CKEDITOR.env.ie ? (b = "focusin", c = "focusout")
              : CKEDITOR.event.useCapture = 1);
          var f = {
            blur: function () {
  ...
  (function () {
    var a, d = function (b) {
      ...
      a || (h && (a = !1 !== k.execCommand(h, {from: "keystrokeHandler"})), a
      || (a = !!this.blockedKeystrokes[d]));
  ...
  (function () {
    CKEDITOR.lang = {
      languages: {
        ...
        this[a] ? d() : CKEDITOR.scriptLoader.load(
            CKEDITOR.getUrl("lang/" + a + ".js"), d, this)
      }, detect: function (a, d) {
        var b = this.languages;
        d = d || navigator.userLanguage || navigator.language || a;
        var c = d.toLowerCase().match(/([a-z]+)(?:-([a-z]+))?/), f = c[1],
            c = c[2];
  ...
  CKEDITOR.scriptLoader = function () {
    ...
    return {
      load: function (b, c, f, h) {
        ...
        k && (b = [b]);
        f || (f = CKEDITOR);
        var g = b.length, l = [], u = [], e = function (a) {
        ...
        if (0 === g) {
          ...
          var x = function (a, b) {
            (b ? l : u).push(a);
            0 >= --g && (h
            && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), e(
                b))
          }, t = function (b, c) {
            a[b] = 1;
            var f = d[b];
            ...
            if (a[b]) {
              ...
              if (!(1 < f.length)) {
                ...
                c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version
                    || CKEDITOR.env.ie9Compat)
                    ? e.$.onreadystatechange = function () {
                      if ("loaded" == e.$.readyState || "complete"
                          == e.$.readyState) {
                        e.$.onreadystatechange = null, t(b,
                            !0)
                      }
                    } : (e.$.onload = function () {
                      setTimeout(function () {
  ...
  CKEDITOR.resourceManager.prototype = {
    add: function (a, d) {
      if (this.registered[a]) {
        throw Error(
            '[CKEDITOR.resourceManager.add] The resource name "' + a
      ...
      for (var c = this.loaded, f = this.registered, h = [], k = {}, g = {},
          l = 0; l < a.length; l++) {
        var u = a[l];
        if (u) {
          if (c[u] || f[u]) {
          ...
          function (a, e) {
            if (e.length) {
              throw Error(
                  ...
                  + k[e[0]].join(",") + '" was not found at "' + e[0] + '".');
            }
          ...
          var h = {}, k = function (b) {
            a.call(this, b, function (a) {
              ...
              for (e in a) {
                ...
                if (!d[e]) {
                  if (g.icons) {
                    for (var z = g.icons.split(","), I = z.length;
                        I--;) {
                      CKEDITOR.skin.addIcon(z[I],
                          g.path + "icons/" + (CKEDITOR.env.hidpi && g.hidpi
                          ? "hidpi/" : "") + z[I] + ".png");
                    }
                  }
              ...
              if (b.length) {
                ...
                for (e in h) {
                  g = h[e], g.onLoad && !g.onLoad._called && (!1
                  === g.onLoad() && delete h[e], g.onLoad._called = 1);
                }
                c && c.call(f || window, h)
              }
            }, this)
  ...
  (function () {
    function a(a, e, f) {
      ...
      if (void 0 !== e) {
        if (!(e instanceof CKEDITOR.dom.element)) {
          throw Error(
              "Expect element of type CKEDITOR.dom.element.");
        }
        if (!f) {
          throw Error("One of the element modes must be specified.");
        }
        if (CKEDITOR.env.ie && CKEDITOR.env.quirks && f
    ...
    function b(a, b) {
      return b == CKEDITOR.ELEMENT_MODE_INLINE ? a.is(CKEDITOR.dtd.$editable)
          || a.is("textarea") : b == CKEDITOR.ELEMENT_MODE_REPLACE ? !a.is(
    ...
    function k(a) {
      ...
      var b = CKEDITOR.getUrl(b), c = r[b] || (r[b] = {});
      c.fn ? (c.fn.call(a, a.config), CKEDITOR.getUrl(a.config.customConfig)
          != b && k(a) || a.fireOnce("customConfigLoaded"))
    ...
    function g(a, b) {
      a.on("customConfigLoaded",
          function () {
            ...
            c = a.config;
            a.readOnly = c.readOnly ? !0 : a.elementMode
            == CKEDITOR.ELEMENT_MODE_INLINE ? a.element.is("textarea")
                ? a.element.hasAttribute("disabled") || a.element.hasAttribute(
                "readonly") : a.element.isReadOnly() : a.elementMode
            == CKEDITOR.ELEMENT_MODE_REPLACE ? a.element.hasAttribute(
                "disabled") || a.element.hasAttribute("readonly") : !1;
            a.blockless = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE
                ? !(a.element.is("textarea") ||
                    CKEDITOR.dtd[a.element.getName()].p) : !1;
            a.tabIndex = c.tabIndex || a.element && a.element.getAttribute(
                "tabindex") || 0;
            a.activeEnterMode = a.enterMode = a.blockless ? CKEDITOR.ENTER_BR
                : c.enterMode;
            a.activeShiftEnterMode = a.shiftEnterMode = a.blockless
                ? CKEDITOR.ENTER_BR : c.shiftEnterMode;
    ...
    function u(a) {
      CKEDITOR.lang.load(a.config.language, a.config.defaultLanguage,
          function (b, c) {
            ...
            a.title = "string" == typeof d || !1 === d ? d : [a.lang.editor,
              a.name].join(", ");
            a.config.contentsLangDirection
            || (a.config.contentsLangDirection = a.elementMode
            == CKEDITOR.ELEMENT_MODE_INLINE ? a.element.getDirection(1)
                : a.lang.dir);
            a.fire("langLoaded");
            e(a)
          })
    ...
    function x(a) {
      ...
      var c = a.config, d = b(c.plugins), e = b(c.extraPlugins),
          f = b(c.removePlugins);
      if (e) {
        var h = new RegExp(
            "(?:^|,)(?:" + e.replace(/,/g, "|") + ")(?\x3d,|$)", "g"),
      ...
      CKEDITOR.plugins.load(d.split(","), function (b) {
        ...
        for (var p in b) {
          var h = b[p], k = h.lang, D = null, n = h.requires, O;
          CKEDITOR.tools.isArray(n) && (n = n.join(","));
          if (n && (O = n.match(g))) {
            for (; n = O.pop();) {
              CKEDITOR.error(
                  "editor-plugin-required",
                  {plugin: n.replace(",", ""), requiredBy: p});
            }
          }
          k && !a.lang[p] && (k.split && (k = k.split(",")), 0
          <= CKEDITOR.tools.indexOf(k, a.langCode) ? D = a.langCode
              : (D = a.langCode.replace(/-.*/, ""), D =
                  D != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, D) ? D : 0
                  <= CKEDITOR.tools.indexOf(k, "en") ? "en"
                      : k[0]), h.langEntries && h.langEntries[D]
              ? (a.lang[p] = h.langEntries[D], D = null) : f.push(
                  CKEDITOR.getUrl(h.path + "lang/" + D + ".js")));
          e.push(D);
          d.push(h)
        }
        CKEDITOR.scriptLoader.load(f, function () {
          if (!a.isDestroyed() && !a.isDetached()) {
            for (var b = ["beforeInit", "init", "afterInit"], f = 0;
                f < b.length; f++) {
              for (var p = 0; p < d.length; p++) {
                var n = d[p];
                0 === f && e[p] && n.lang && n.langEntries
            ...
            for (p = 0; p < a.config.blockedKeystrokes.length;
                p++) {
    ...
    function z(a, b) {
      function c(a) {
        ...
        return b.is && (b.is("tr") || b.is("td") && b.equals(d) && a.endOffset
            === b.getChildCount()) ? !0 : !1
      }
      ...
      for (var e = new CKEDITOR.dom.documentFragment, f, h, g, k = 0;
          k < a.length; k++) {
        var l = a[k], q = l.startContainer.getAscendant("tr", !0);
        c(l) ? (f || (f = q.getAscendant("table").clone(), f.append(
            q.getAscendant({thead: 1, tbody: 1, tfoot: 1}).clone()), e.append(
            f), f = f.findOne("thead, tbody, tfoot")), h && h.equals(q) || (h =
            q, g = q.clone(), f.append(g)), g.append(d(l))) : e.append(
            l.cloneContents())
      }
      ...
      plugins: {
        detectConflict: function (a, b) {
          for (var c = 0; c < b.length; c++) {
            var d = b[c];
            if (this[d]) {
              return CKEDITOR.warn("editor-plugin-conflict",
        ...
        d.is("textarea") && e && (e.on("submit", a), b(e.$.submit)
        ...
        CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(b),
            function (a) {
              a = b[a];
        ...
        return c && c.state != CKEDITOR.TRISTATE_DISABLED && !1 !== this.fire(
            "beforeCommandExec", d) && (d.returnValue = c.exec(
            d.commandData), !c.async && !1 !== this.fire("afterCommandExec", d))
            ? d.returnValue : !1
        ...
        var b = this._.data;
        "string" != typeof b && (b = (b = this.element) && this.elementMode
        == CKEDITOR.ELEMENT_MODE_REPLACE ? b.is("textarea") ? b.getValue()
            : b.getHtml() : "");
        b = {dataValue: b};
        ...
        == CKEDITOR.ELEMENT_MODE_REPLACE ? a.is("textarea") ? a.getValue()
            : a.getHtml() : "");
        return a
        ...
        a = null == a || a;
        this.readOnly != a
        && (this.readOnly = a, this.keystrokeHandler.blockedKeystrokes[8] = +a, this.editable().setReadOnly(
            a), this.fire("readOnly"))
        ...
        var b = this.editable(), c = this.getSelection(),
            c = c && c.getRanges();
        if (!b || !c || 0 === c.length) {
          return null;
        }
        ...
        var c = this.editable(), d = this.getSelection().getRanges(),
            e = new CKEDITOR.dom.documentFragment, f;
        if (!c || 0 === d.length) {
          return null;
        }
        for (f = 0; f < d.length; f++) {
          e.append(c.extractHtmlFromRange(d[f],
              b));
        }
        ...
        for (var a = this.keystrokeHandler.keystrokes,
            b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0]
                : [[].slice.call(arguments, 0)], c, d, e = b.length;
            e--;) {
          c = b[e], d = 0, CKEDITOR.tools.isArray(c) &&
        ...
        a || (a = this.filter);
        this.activeFilter !== a && (this.activeFilter = a, this.fire(
            "activeFilterChange"),
            a === this.filter ? this.setActiveEnterMode(null, null)
                : this.setActiveEnterMode(a.getAllowedEnterMode(this.enterMode),
        ...
        if (this.activeEnterMode != a || this.activeShiftEnterMode
            != b) {
          this.activeEnterMode = a, this.activeShiftEnterMode = b, this.fire(
    ...
    CKEDITOR.editor._getEditorElement = function (a) {
      ...
      return b ? b.getEditor() ? (CKEDITOR.error("editor-element-conflict",
          {editorName: b.getEditor().name}), null) : b : (CKEDITOR.error(
          "editor-incorrect-element", {element: a}), null)
    }
  })();
    ...
    CKEDITOR.htmlParser.prototype = {
      onTagOpen: function () {
        ...
        for (var c, f, h = 0, k; c = this._.htmlPartsRegex.exec(b);) {
          ...
          if (f = c[1]) {
            if (f = f.toLowerCase(), k && CKEDITOR.dtd.$cdata[f]
            && (this.onCDATA(k.join("")), k = null), !k) {
              this.onTagClose(f);
              continue
            }
          }
  ...
  (function () {
    ...
    CKEDITOR.htmlParser.node.prototype = {
      remove: function () {
        var a = this.parent.children, d = CKEDITOR.tools.indexOf(a, this),
        ...
        var d = this.parent.children, b = CKEDITOR.tools.indexOf(d, this),
    ...
    CKEDITOR.htmlParser.text.prototype = CKEDITOR.tools.extend(
        new CKEDITOR.htmlParser.node, {
          type: CKEDITOR.NODE_TEXT, filter: function (a, d) {
            if (!(this.value = a.onText(d, this.value,
                this))) {
              return this.remove(), !1
            }
          }, writeHtml: function (a, d) {
  ...
  (function () {
    function a(a) {
      return a.attributes["data-cke-survive"] ? !1 : "a" == a.name
          && a.attributes.href || CKEDITOR.dtd.$removeEmpty[a.name]
    }

    var d = CKEDITOR.tools.extend({table: 1, ul: 1, ol: 1, dl: 1},
        CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl),
        b = {ol: 1, ul: 1},
        c = CKEDITOR.tools.extend({}, {html: 1}, CKEDITOR.dtd.html,
            CKEDITOR.dtd.body, CKEDITOR.dtd.head, {style: 1, script: 1}), f = {
          ul: "li",
          ol: "li",
          dl: "dd",
          table: "tbody",
        ...
        function (h, k, g) {
          function l(a) {
            ...
            if (0 < m.length) {
              for (var c = 0; c < m.length; c++) {
                var d = m[c], e = d.name, f = CKEDITOR.dtd[e],
                    h = y.name && CKEDITOR.dtd[y.name];
                h && !h[e] || a && f && !f[a] && CKEDITOR.dtd[a] ? e == y.name
                    && (x(y, y.parent, 1), c--) : (b
                || (u(), b = 1), d = d.clone(), d.parent = y, y = d, m.splice(c,
                    1), c--)
              }
            }
          }
          ...
          function e(a) {
            if (a._.isBlockLike && "pre" != a.name && "textarea" != a.name) {
              ...
              c && c.type == CKEDITOR.NODE_TEXT && ((d = CKEDITOR.tools.rtrim(
                  c.value)) ?
          ...
          function x(b, c, d) {
            c = c || y || r;
            var f = y;
            void 0 === b.previous && (t(c, b) && (y = c, I.onTagOpen(g,
                {}), b.returnPoint = c = y), e(b), a(b) && !b.children.length
            || c.add(b), "pre" == b.name && (E = !1), "textarea" == b.name
            && (J = !1));
            b.returnPoint ? (y = b.returnPoint, delete b.returnPoint) : y = d
                ? c : f
          }

          function t(a, b) {
            if ((a == r || "body" == a.name) && g && (!a.name
                || CKEDITOR.dtd[a.name][g])) {
              var c, d;
              return (c = b.attributes
                  && (d = b.attributes["data-cke-real-element-type"]) ? d : b.name)
          ...
          function z(a, b) {
            return a in CKEDITOR.dtd.$listItem || a
            in CKEDITOR.dtd.$tableContent ? a == b || "dt" == a && "dd" == b
                || "dd" == a && "dt" == b : !1
          }

          var I = new CKEDITOR.htmlParser,
              r = k instanceof CKEDITOR.htmlParser.element ? k : "string"
              == typeof k ? new CKEDITOR.htmlParser.element(k)
                  : new CKEDITOR.htmlParser.fragment, m = [], M = [], y = r,
              J = "textarea" == r.name, E = "pre" == r.name;
          I.onTagOpen = function (e, f, h, g) {
            ...
            if (a(f)) {
              ...
              if ("br" == e) {
                ...
                for (; !(g = (h = y.name) ? CKEDITOR.dtd[h] || (y._.isBlockLike
                    ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown
                || y.isUnknown || g[e]);) {
                  if (y.isOptionalClose) {
                    I.onTagClose(
                        h);
                  } else if (e in b && h
                      in b) {
                    h = y.children, (h = h[h.length - 1]) && "li"
                    == h.name || x(h = new CKEDITOR.htmlParser.element("li"),
                        y), !f.returnPoint && (f.returnPoint = y), y = h;
                  } else if (e
                      in CKEDITOR.dtd.$listItem &&
                      !z(e, h)) {
                    I.onTagOpen("li" == e ? "ul" : "dl", {}, 0,
                        1);
                  } else if (h in d && !z(e, h)) {
                    !f.returnPoint
                    && (f.returnPoint = y), y = y.parent;
                  } else if (h
                  in CKEDITOR.dtd.$inline && m.unshift(y), y.parent) {
                    x(y,
                        y.parent, 1);
                  } else {
                    f.isOrphan = 1;
          ...
          I.onTagClose = function (a) {
            ...
            for (var c = [], d = [], e = y;
                e != r && e.name != a;) {
              e._.isBlockLike || d.unshift(e), c.push(
                  e), e = e.returnPoint || e.parent;
            }
            if (e != r) {
          ...
          I.onText = function (a) {
            if (!(y._.hasInlineStarted && !M.length || E || J)
                && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) {
              return;
            }
            var b = y.name,
                e = b ? CKEDITOR.dtd[b] || (y._.isBlockLike ? CKEDITOR.dtd.div
                    : CKEDITOR.dtd.span) : c;
            if (!J && !e["#"] && b in d) {
              I.onTagOpen(f[b] || ""), I.onText(
                  a);
            } else {
              u();
              l();
      ...
      type: CKEDITOR.NODE_DOCUMENT_FRAGMENT, add: function (a, b) {
        ...
        if (c) {
          if (a._.isBlockLike && c.type == CKEDITOR.NODE_TEXT
              && (c.value = CKEDITOR.tools.rtrim(c.value), 0
              === c.value.length)) {
            this.children.pop();
            this.add(a);
            return
        ...
        this._.hasInlineStarted || (this._.hasInlineStarted = a.type
            == CKEDITOR.NODE_TEXT || a.type == CKEDITOR.NODE_ELEMENT
            && !a._.isBlockLike)
      }, filter: function (a, b) {
        ...
        if (!1 !== d) {
          ...
          for (var f = 0; f < c.length; f++) {
            d = c[f], d.type
            == CKEDITOR.NODE_ELEMENT ? d.forEach(a, b) : b && d.type != b || a(
                d)
          }
        }
      }, getFilterContext: function (a) {
  ...
  (function () {
    ...
    CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
      $: function (b) {
        ...
        addRules: function (a, c) {
          ...
          for (var d = [this.elementsRules["^"], this.elementsRules[c.name],
            this.elementsRules.$], h, k = 0; 3 > k; k++) {
            if (h = d[k]) {
              h = h.exec(a, c, this);
              if (!1 === h) {
                return null;
        ...
        onNode: function (a, c) {
          var d = c.type;
          return d == CKEDITOR.NODE_ELEMENT ? this.onElement(a, c) : d
          == CKEDITOR.NODE_TEXT ? new CKEDITOR.htmlParser.text(
              this.onText(a, c.value, c)) : d == CKEDITOR.NODE_COMMENT
    ...
    a.prototype = {
      add: function (a, c, d) {
        ...
        for (var c = this.rules, d = c.length - 1;
            0 <= d && a < c[d].priority;) {
          d--;
        }
        return d + 1
      }, exec: function (a, c) {
        var d = c instanceof CKEDITOR.htmlParser.node || c
            instanceof CKEDITOR.htmlParser.fragment,
            h = Array.prototype.slice.call(arguments, 1), k = this.rules,
            g = k.length, l, u, e, x;
        for (x = 0; x < g; x++) {
          if (d
          && (l = c.type, u = c.name), e = k[x], !(a.nonEditable
              && !e.options.applyToAll ||
              a.nestedEditable && e.options.excludeNestedEditable)) {
            e = e.value.apply(null, h);
            if (!1 === e || d && e && (e.name != u || e.type != l)) {
              return e;
            }
            null != e && (h[0] = c = e)
          }
        ...
        for (var d = 0, h = this.rules, k = h.length, g; c && d < k;
            d++) {
          g = h[d], a.nonEditable && !g.options.applyToAll
  ...
  (function () {
    function a(a, d) {
          ...
          if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
            ...
            if (q) {
              for (w(q, 1) && n.push(q); q;) {
                h(q) && (g = c(q)) && w(g)
                && ((A = c(g)) && !h(A) ? n.push(g) : (e(p).insertAfter(
                    g), g.remove())), q = q.previous;
              }
            }
            ...
            if (n = !a || !1 !== ("function" == typeof d ? d(f) : d)) {
              ...
              f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? p
              || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode
                  || f.name in CKEDITOR.dtd.tr || f.name
                  in CKEDITOR.dtd.$listItem) ? (n = b(f), n = !n || "form"
                  == f.name && "input" == n.name) : n = !1 : n = !1;
            }
            n && f.add(e(a))
          }
        }
      ...
      function w(a, b) {
        if ((!p || CKEDITOR.env.needsBrFiller) && a.type
            == CKEDITOR.NODE_ELEMENT && "br" == a.name
            && !a.attributes["data-cke-eol"]) {
          return !0;
        }
        var c;
        return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(y))
        && (c.index && ((new CKEDITOR.htmlParser.text(
            a.value.substring(0, c.index))).insertBefore(a),
            a.value = c[0]), !CKEDITOR.env.needsBrFiller && p && (!b
            || a.parent.name in g) || !p && ((c = a.previous) && "br" == c.name
            || !c || h(c))) ? !0 : !1
      }

      var q = {elements: {}}, p = "html" == d, g = CKEDITOR.tools.extend({}, D),
          v;
      for (v in g) {
        "#" in E[v] || delete g[v];
      }
      for (v in g) {
        q.elements[v] = n(p, a.config.fillEmptyBlocks);
      }
      q.root = n(p, !1);
      q.elements.br = function (a) {
        return function (b) {
          if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
            var d = b.attributes;
            if ("data-cke-bogus" in d || "data-cke-eol"
                in d) {
              ...
              var n = c(b);
              !d && h(b.parent) ? k(b.parent, e(a)) : h(d) && n && !h(n) && e(
                  a).insertBefore(d)
            }
          }
        }
    ...
    function d(a, b) {
      return a != CKEDITOR.ENTER_BR && !1 !== b ? a == CKEDITOR.ENTER_DIV
          ? "div" : "p" : !1
    }
    ...
    function h(a) {
      return a &&
          (a.type == CKEDITOR.NODE_ELEMENT && a.name in D || a.type
              == CKEDITOR.NODE_DOCUMENT_FRAGMENT)
    }
    ...
    function e(a, b) {
      return a.replace(b, function (a, b, c) {
        0 === a.indexOf("\x3ctextarea") && (a = b + r(c).replace(/</g,
            "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e");
        return "\x3ccke:encoded\x3e" + encodeURIComponent(a)
            + "\x3c/cke:encoded\x3e"
      })
    }
    ...
    function t(a) {
      return a.replace(/\x3c!--(?!{cke_protected})[\s\S]+?--\x3e/g,
          function (a) {
            return "\x3c!--" + J + "{C}" + encodeURIComponent(a).replace(/--/g,
                "%2D%2D") + "--\x3e"
          })
    }
    ...
    function z(a) {
      return CKEDITOR.tools.array.reduce(a.split(""), function (a, b) {
        var c = b.toLowerCase(), d = b.toUpperCase(), e = I(c);
        c !== d && (e += "|" + I(d));
        return a + ("(" + e + ")")
      }, "")
    }
    ...
    function M(a, b) {
      var c = [], d = b.config.protectedSource,
          e = b._.dataStore || (b._.dataStore = {id: 1}),
          f = /<\!--\{cke_temp(comment)?\}(\d*?)--\x3e/g,
          d = [/<script[\s\S]*?(<\/script>|$)/gi,
            /<noscript[\s\S]*?<\/noscript>/gi, /<meta[\s\S]*?\/?>/gi].concat(d);
      ...
      for (var n = 0; n < d.length; n++) {
        a = a.replace(d[n], function (a) {
          ...
          return /cke_temp(comment)?/.test(a) ? a : "\x3c!--{cke_temp}"
              + (c.push(
                  a) - 1) + "--\x3e"
        });
      }
      a = a.replace(f, function (a, b, d) {
        return "\x3c!--" + J + (b ? "{C}" : "") + encodeURIComponent(
            c[d]).replace(/--/g, "%2D%2D") + "--\x3e"
      });
      a = a.replace(
          /<\w+(?:\s+(?:(?:[^\s=>]+\s*=\s*(?:[^'"\s>]+|'[^']*'|"[^"]*"))|[^\s=\/>]+))+\s*\/?>/g,
          function (a) {
    ...
    CKEDITOR.htmlDataProcessor = function (b) {
      ...
      b.on("toHtml", function (a) {
            a = a.data;
            var c = a.dataValue, f, c = c.replace(O, ""), c = M(c, b), c = e(c, S),
                c = u(c), c = e(c, Q), c = c.replace(H, "$1cke:$2"),
            ...
            f && (n = c, !n.children.length && CKEDITOR.dtd[n.name][f]
            && (f = new CKEDITOR.htmlParser.element(f), n.add(f)));
            a.dataValue = c
          }, null, null,
          5);
      b.on("toHtml", function (a) {
        a.data.filter.applyTo(a.data.dataValue, !0, a.data.dontFilter,
            a.data.enterMode) && b.fire("dataFiltered")
      }, null, null, 6);
      b.on("toHtml", function (a) {
      ...
      b.on("toDataFormat", function (a) {
        var c = a.data.dataValue, d = n.writer;
        d.reset();
    ...
    CKEDITOR.htmlDataProcessor.prototype =
        {
          toHtml: function (a, b, c, d) {
            var e = this.editor, f, n, q, w;
            b && "object" == typeof b
                ? (f = b.context, c = b.fixForBody, d = b.dontFilter, n = b.filter, q = b.enterMode, w = b.protectedWhitespaces)
                : f = b;
        ...
        G = {elements: {input: g, textarea: g}}, B = {
          ...
          elements: {
            embed: function (a) {
              ...
              var b = a.attributes;
              if (!(a.children.length || b.name || b.id
          ...
          elements: {
            $: function (a) {
              ...
              if (b) {
                ...
                for (var c = ["name", "href", "src"], d, e = 0; e < c.length;
                    e++) {
              ...
              a.children.slice(0).sort(function (a, b) {
                var c, d;
                a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type
                && (c = CKEDITOR.tools.indexOf(p,
                    a.name), d = CKEDITOR.tools.indexOf(p, b.name));
                -1 < c && -1 < d && c != d || (c = a.parent ? a.getIndex()
    ...
    var C = /<(a|area|img|input|source)\b([^>]*)>/gi,
        ...
        n = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, O = new RegExp(
        "(" + z("\x3ccke:encoded\x3e") + "(.*?)" + z("\x3c/cke:encoded\x3e")
        + ")|(" + z("\x3c") + z("/") + "?" + z("cke:encoded\x3e") + ")", "gi"),
  ...
  CKEDITOR.htmlParser.element = function (a, d) {
    ...
    c && (b = c[1]);
    b = !!(CKEDITOR.dtd.$nonBodyContent[b] || CKEDITOR.dtd.$block[b]
        || CKEDITOR.dtd.$listItem[b] || CKEDITOR.dtd.$tableContent[b]
        || CKEDITOR.dtd.$nonEditable[b] || "br" == b);
  ...
  CKEDITOR.htmlParser.cssStyle = function (a) {
    ...
    return {
      rules: d, populate: function (a) {
        var c = this.toString();
        c && (a instanceof CKEDITOR.dom.element ? a.setAttribute("style", c) : a
        instanceof CKEDITOR.htmlParser.element ? a.attributes.style = c
            : a.style = c)
      }, toString: function () {
        var a = [], c;
        for (c in d) {
  ...
  (function () {
    function a(a) {
      return function (b) {
        return b.type == CKEDITOR.NODE_ELEMENT && ("string" == typeof a ? b.name
            == a : b.name in a)
      }
    }
        ...
        new CKEDITOR.htmlParser.node, {
          ...
          filter: function (a, b) {
            ...
            for (l in k) {
              ...
              u && (!1 === (g = a.onAttribute(b, d, u, g)) ? delete k[u]
                  : k[u] = g)
            }
            d.isEmpty ||
            this.filterChildren(a, !1, b);
          ...
          writeHtml: function (a, b) {
            b && this.filter(b);
            var h = this.name, k = [], g = this.attributes, l, u;
            a.openTag(h, g);
            for (l in g) {
              k.push([l, g[l]]);
            }
            ...
            l = 0;
            for (u = k.length; l < u; l++) {
              g = k[l], a.attribute(g[0], g[1]);
            }
          ...
          find: function (a, b) {
            ...
            for (k = 0; k < this.children.length; k++) {
              ...
              "function" == typeof a && a(g) ? d.push(g) : "string" == typeof a
                  && g.name === a && d.push(g);
          ...
          removeClass: function (a) {
            ...
            b && ((b = CKEDITOR.tools.trim(b.replace(new RegExp("(?:\\s+|^)" +
                a + "(?:\\s+|$)"), " "))) ? this.attributes["class"] = b
                : delete this.attributes["class"])
          },
          hasClass: function (a) {
            var b = this.attributes["class"];
            return b ? (new RegExp("(?:^|\\s)" + a + "(?\x3d\\s|$)")).test(b)
                : !1
          },
          getFilterContext: function (a) {
            var b = [];
  ...
  (function () {
    ...
    CKEDITOR.template.prototype.output = function (d, b) {
      var c = ("function" === typeof this.source ? this.source(d)
          : this.source).replace(a, function (a, b) {
  ...
  (function () {
    CKEDITOR.inline = function (a, d) {
      ...
      c ? (b.setData(c.getValue(), null,
          !0), a = CKEDITOR.dom.element.createFromHtml(
          '\x3cdiv contenteditable\x3d"' + !!b.readOnly
          + '" class\x3d"cke_textarea_inline"\x3e' + c.getValue()
          + "\x3c/div\x3e", CKEDITOR.document), a.insertAfter(
          c), c.hide(), c.$.form && b._attachToForm()) : b.setData(a.getHtml(),
          null, !0);
    ...
    CKEDITOR.inlineAll = function () {
      ...
      for (b in
        ...
        for (var c = CKEDITOR.document.getElementsByTag(
            b),
            f = 0, h = c.count(); f < h; f++) {
          a = c.getItem(f), "true"
          == a.getAttribute("contenteditable") && (d = {
            element: a,
            config: {}
          }, !1
          !== CKEDITOR.fire("inline", d) && CKEDITOR.inline(a, d.config))
        }
      }
    };
    CKEDITOR.domReady(function () {
  ...
  (function () {
    function a(a, f, h, k) {
      ...
      k == CKEDITOR.ELEMENT_MODE_REPLACE && (a.setStyle("visibility",
          "hidden"), g._.required = a.hasAttribute(
          "required"), a.removeAttribute("required"));
      h && g.setData(h, null, !0);
      g.on("loaded", function () {
        g.isDestroyed() || g.isDetached() || (b(g), k
        == CKEDITOR.ELEMENT_MODE_REPLACE && g.config.autoUpdateElement
        && a.$.form && g._attachToForm(), g.setMode(g.config.startupMode,
            function () {
              g.resetDirty();
              g.status =
                  "ready";
    ...
    function d() {
      ...
      b && (b.clearCustomData(), this.elementMode
      == CKEDITOR.ELEMENT_MODE_REPLACE && (b.show(), this._.required
      && b.setAttribute("required", "required")), delete this.element)
    }

    function b(a) {
      var b = a.name, d = a.element, k = a.elementMode,
          ...
          b = CKEDITOR.dom.element.createFromHtml(u.output({
            ...
            langCode: a.langCode,
            voiceLabel: a.title,
            topHtml: g ? '\x3cspan id\x3d"' + a.ui.spaceId("top")
                + '" class\x3d"cke_top cke_reset_all" role\x3d"presentation" style\x3d"height:auto"\x3e'
                + g + "\x3c/span\x3e" : "",
            contentId: a.ui.spaceId("contents"),
            bottomHtml: l ? '\x3cspan id\x3d"' + a.ui.spaceId("bottom")
      ...
      k && a.ui.space("contents").setStyle("height",
    ...
    CKEDITOR.replaceAll = function () {
      for (var a = document.getElementsByTagName("textarea"), b = 0;
          b < a.length; b++) {
        var d = null, k = a[b];
        if (k.name || k.id) {
          if ("string" == typeof arguments[0]) {
            if (!(new RegExp("(?:^|\\s)" + arguments[0] + "(?:$|\\s)")).test(
                k.className)) {
              continue
            }
          } else if ("function" == typeof arguments[0] && (d = {}, !1
          === arguments[0](k, d))) {
            continue;
          }
          this.replace(k, d)
    ...
    CKEDITOR.editor.prototype.setMode = function (a, b) {
      ...
      if (a != d.mode && k && k[a]) {
        ...
        if (d.mode) {
          var g = d.checkDirty(), k = d._.previousModeData, l, u = 0;
        ...
        this._.modes[a](function () {
          ...
          void 0 !== g && !g &&
          d.resetDirty();
          u ? d.fire("unlockSnapshot") : "wysiwyg" == a && d.fire(
              "saveSnapshot");
          setTimeout(function () {
            d.isDestroyed() || d.isDetached() || (d.fire("mode"), b && b.call(
                d))
          }, 0)
        })
      }
    ...
    CKEDITOR.editor.prototype.resize = function (a, b, d, k) {
      var g = this.container, l = this.ui.space("contents"),
          u = CKEDITOR.env.webkit && this.document
  ...
  (function () {
    function a(a) {
      var b = a.editor, e = a.data.path, f = e.blockLimit, g = a.data.selection,
          q = g.getRanges()[0], h;
      if (CKEDITOR.env.gecko || CKEDITOR.env.ie
          && CKEDITOR.env.needsBrFiller) {
        if (g = d(g,
            e)) {
          g.appendBogus(), h = CKEDITOR.env.ie && !CKEDITOR.env.edge
              || CKEDITOR.env.edge && b._.previousActive;
        }
      }
      k(b, e.block, f) && q.collapsed && !q.getCommonAncestor().isReadOnly()
      && (e = q.clone(), e.enlarge(
          CKEDITOR.ENLARGE_BLOCK_CONTENTS), f = new CKEDITOR.dom.walker(
          e), f.guard = function (a) {
        return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly()
      },
      !f.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock())
      && (b = q.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div"
          : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type
      == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(
          /^(?:&nbsp;|\xa0)$/) && b.remove(), h = 1, a.cancel());
      h && q.select()
    }
    ...
    function b(a) {
      ...
      b.is("input") && (b = b.getAttribute("type"), "submit" != b && "reset"
    ...
    function f(a, b) {
      return function (c) {
        var d = c.data.$.toElement || c.data.$.fromElement
            || c.data.$.relatedTarget;
        (d = d && d.nodeType == CKEDITOR.NODE_ELEMENT
            ? new CKEDITOR.dom.element(d) : null) && (b.equals(d) || b.contains(
            d)) || a.call(this, c)
      }
    }
    ...
    function h(a) {
      ...
      if (e.startPath().contains(f)) {
        ...
        a.checkBackward();
        if (d) {
          return q = e.clone(), q.collapse(), q.setEndAt(d,
              CKEDITOR.POSITION_AFTER_END), a = new CKEDITOR.dom.walker(
              q), a.guard = b(!0), d = !1, a.checkForward(), d
        }
      }
      return null
    }
    ...
    function k(a, b, c) {
      return !1 !== a.config.autoParagraph && a.activeEnterMode
          != CKEDITOR.ENTER_BR && (a.editable().equals(c) &&
              !b || b && "true" == b.getAttribute("contenteditable"))
    }

    function g(a) {
      return a.activeEnterMode != CKEDITOR.ENTER_BR && !1
      !== a.config.autoParagraph ? a.activeEnterMode == CKEDITOR.ENTER_DIV
          ? "div" : "p" : !1
    }
    ...
    CKEDITOR.editable = CKEDITOR.tools.createClass({
      base: CKEDITOR.dom.element, $: function (a, b) {
        ...
        focus: function () {
          ...
          if (CKEDITOR.env.webkit && !this.hasFocus
              && (a = this.editor._.previousActive
                  || this.getDocument().getActive(), this.contains(a))) {
            a.focus();
            return
          }
          CKEDITOR.env.edge && 14 < CKEDITOR.env.version && !this.hasFocus
          && this.getDocument().equals(CKEDITOR.document)
          && (this.editor._.previousScrollTop = this.$.scrollTop);
          try {
            if (!CKEDITOR.env.ie || CKEDITOR.env.edge && 14
                < CKEDITOR.env.version || !this.getDocument().equals(
                    CKEDITOR.document)) {
          ...
          && (a = CKEDITOR.document.getActive(), a.equals(
              this.getWindow().getFrame()) || this.getWindow().focus())
        }, on: function (a, b) {
          var c = Array.prototype.slice.call(arguments, 0);
          CKEDITOR.env.ie && /^focus|blur$/.exec(a) &&
          (a = "focus" == a ? "focusin" : "focusout", b = f(b,
              this), c[0] = a, c[1] = b);
          ...
          for (c in a) {
            a.hasOwnProperty(c) && (b = a[c], null !== b
                ? this.setAttribute(c,
                    b) : this.removeAttribute(c))
          }
        }, attachClass: function (a) {
          var b = this.getCustomData("classes");
          this.hasClass(a) || (!b && (b = []), b.push(a), this.setCustomData(
              "classes", b), this.addClass(a))
        }, changeAttr: function (a, b) {
          var c = this.getAttribute(a);
          b !== c && (!this._.attrChanges && (this._.attrChanges = {}), a
          in this._.attrChanges
          || (this._.attrChanges[a] = c), this.setAttribute(a, b))
        }, insertText: function (a) {
          this.editor.focus();
          this.insertHtml(this.transformPlainTextToHtml(a), "text")
        }, transformPlainTextToHtml: function (a) {
          var b =
              this.editor.getSelection().getStartElement().hasAscendant("pre",
                  !0) ? CKEDITOR.ENTER_BR : this.editor.activeEnterMode;
          ...
          d.focus();
          d.fire("saveSnapshot");
          var e = d.activeEnterMode, d = d.getSelection(), f = a.getName(),
          ...
          this.insertElementIntoRange(a, b) && (b.moveToPosition(a,
            ...
            return c(a) && !I(a)
              ...
              ? f.getDtd()["#"] ? b.moveToElementEditStart(f)
                  : b.moveToElementEditEnd(a) : f || e == CKEDITOR.ENTER_BR
              || (f = b.fixBlock(!0, e == CKEDITOR.ENTER_DIV ? "div"
                  : "p"), b.moveToElementEditStart(f))));
          d.selectRanges([b]);
          u(this)
          ...
          && (b.startContainer.is(
              {tr: 1, table: 1, tbody: 1, thead: 1, tfoot: 1}) ? M(b)
            ...
            for (;
              ...
              if (g.getName() in
                ...
                b.checkStartOfBlock() && b.checkEndOfBlock()
                    ...
                    : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p",
                    c.editable());
              }
            }
          }
          ...
          try {
            ...
            if (!CKEDITOR.env.ie || -2146828218 !== a.number) {
              throw a;
            }
          }
        ...
        fixInitialSelection: function () {
          function a() {
            ...
            a:if (d.anchorNode && d.anchorNode == c.$) {
              ...
              if (CKEDITOR.env.webkit && (e = c.getDocument().getActive())
                  && e.equals(c) && !d.anchorNode) {
                e = !0;
                break a
              }
              e = void 0
            }
            e && (e = new CKEDITOR.dom.range(c), e.moveToElementEditStart(
                c), b = b.createRange(), b.setStart(e.startContainer.$,
                e.startOffset), b.collapse(!0), d.removeAllRanges(), d.addRange(
                b))
          }
          ...
          function b() {
            ...
            "None" ==
            d.type && e.equals(c) && (d = new CKEDITOR.dom.range(
                c), a = a.body.createTextRange(), d.moveToElementEditStart(
                c), d = d.startContainer, d.type != CKEDITOR.NODE_ELEMENT
            && (d = d.getParent()), a.moveToElementText(d.$), a.collapse(
                !0), a.select())
          }
          ...
          var c = E, d = {range: a, doc: a.document},
          ...
          f.moveToPosition(d.bookmark.startNode,
              CKEDITOR.POSITION_BEFORE_START);
          d.targetBookmark = f.createBookmark();
          c.list.detectMerge(d, this);
          c.table.detectRanges(d, this);
          c.block.detectMerge(d, this);
          d.tableContentsRanges ? (c.table.deleteRanges(d), a.moveToBookmark(
              d.bookmark), d.range = a) : (a.moveToBookmark(
              d.bookmark), d.range = a, a.extractContents(
              c.detectExtractMerge(d)));
          ...
          if (b) {
            c = a.startPath();
            if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block
            ...
            c.autoParagraph(this.editor, a), z(a.startContainer)
            && a.startContainer.appendBogus();
          }
          ...
          this.attachListener(a, "beforeGetData", function () {
            var b =
                this.getData();
            this.is("textarea") || !1 !== a.config.ignoreEmptyParagraph
          ...
          a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? this.attachClass(
              "cke_editable_inline") : a.elementMode
              != CKEDITOR.ELEMENT_MODE_REPLACE && a.elementMode
          ...
          if (CKEDITOR.env.edge && 14 < CKEDITOR.env.version) {
            var d = function () {
              var b = a.editable();
              null != a._.previousScrollTop && b.getDocument().equals(
                  CKEDITOR.document)
              && (b.$.scrollTop = a._.previousScrollTop, a._.previousScrollTop = null, this.removeListener(
                  "scroll", d))
            };
            this.on("scroll", d)
          }
          ...
          if (!this.is("textarea")) {
            ...
            if (k) {
              ...
              q ? k != q.getText() && (CKEDITOR.env.ie && 9
              > CKEDITOR.env.version ? q.$.styleSheet.cssText = k : q.setText(
                  k)) : (k = f.appendStyleText(k), k = new CKEDITOR.dom.element(
                  k.ownerNode || k.owningElement), g.setCustomData("stylesheet",
                  k), k.data("cke-temp", 1))
            }
            g = f.getCustomData("stylesheet_ref") || 0;
            f.setCustomData("stylesheet_ref",
                g + 1);
            this.setCustomData("cke_includeReadonly",
                !a.config.disableReadonlyStyling);
            this.attachListener(this, "click", function (a) {
              a = a.data;
              var b = (new CKEDITOR.dom.elementPath(a.getTarget(),
                  this)).contains("a");
            ...
            this.attachListener(a, "key", function (b) {
              ...
              if (0 !== b.getRanges().length) {
                if (c in C) {
                  var e, f = b.getRanges()[0], q = f.startPath(), g, k, l,
                      c = 8 == c;
                  CKEDITOR.env.ie &&
                  11 > CKEDITOR.env.version && (e = b.getSelectedElement())
                  || (e = h(b)) ? (a.fire("saveSnapshot"), f.moveToPosition(e,
                      CKEDITOR.POSITION_BEFORE_START), e.remove(), f.select(), a.fire(
                      "saveSnapshot"), d = 1) : f.collapsed && ((g = q.block)
                  && (l = g[c ? "getPrevious" : "getNext"](x)) && l.type
                  == CKEDITOR.NODE_ELEMENT && l.is("table") && f[c
                      ? "checkStartOfBlock" : "checkEndOfBlock"]() ? (a.fire(
                      "saveSnapshot"), f[c ? "checkEndOfBlock"
                      : "checkStartOfBlock"]()
                  && g.remove(), f["moveToElementEdit" + (c ? "End" : "Start")](
                      l), f.select(), a.fire("saveSnapshot"),
                      d = 1) : q.blockLimit && q.blockLimit.is("td")
                  && (k = q.blockLimit.getAscendant("table"))
                  && f.checkBoundaryOfElement(k,
                      c ? CKEDITOR.START : CKEDITOR.END) && (l = k[c
                      ? "getPrevious" : "getNext"](x)) ? (a.fire(
                      "saveSnapshot"), f["moveToElementEdit" + (c ? "End"
                      : "Start")](l), f.checkStartOfBlock()
                  && f.checkEndOfBlock() ? l.remove() : f.select(), a.fire(
                      "saveSnapshot"), d = 1) : (k = q.contains(
                      ["td", "th", "caption"])) && f.checkBoundaryOfElement(k,
            ...
            this.attachListener(this, "keyup", function (b) {
              b.data.getKeystroke() in C && !this.getFirst(c)
              && (this.appendBogus(), b = a.createRange(), b.moveToPosition(
            ...
            CKEDITOR.env.ie && !CKEDITOR.env.edge || this.attachListener(this,
                "mousedown", function (b) {
                  var c = b.data.getTarget();
                  c.is("img", "hr",
                      "input", "textarea", "select") && !c.isReadOnly()
                  && (a.getSelection().selectElement(c), c.is("input",
                      "textarea", "select") && b.data.preventDefault())
                });
            CKEDITOR.env.edge && this.attachListener(this, "mouseup",
                function (b) {
                  (b = b.data.getTarget()) && b.is("img") && !b.isReadOnly()
                  && a.getSelection().selectElement(b)
                });
            CKEDITOR.env.gecko && this.attachListener(this, "mouseup",
                function (b) {
                  if (2 == b.data.$.button
                      && (b = b.data.getTarget(), !b.getAscendant("table")
                      && !b.getOuterHtml().replace(r, ""))) {
                    var c = a.createRange();
            ...
            CKEDITOR.env.webkit && this.attachListener(a, "key", function (b) {
              ...
              !== b.getRanges().length)) {
                ...
                if (d.collapsed) {
                  ...
                  c = d, q = b.block, d = c.endPath().block, q && d
                  && !q.equals(d) ? (a.fire("saveSnapshot"), (f = q.getBogus())
                      && f.remove(), c.enlarge(
                      CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent()
                      && (d.moveChildren(q, !1), b.lastElement.mergeSiblings(), e(q,
                      d, !0)), c = a.getSelection().getRanges()[0], c.collapse(
                      1), c.optimize(), "" === c.startContainer.getHtml()
                      && c.startContainer.appendBogus(), c.select(), b = !0)
                      : b = !1;
                }
                if (!b) {
                  return;
        ...
        cleanCustomData: function () {
          ...
          this.restoreAttrs();
          for (var a = this.removeCustomData("classes");
              a && a.length;) {
          ...
          if (!this.is("textarea")) {
            ...
            if (b.getCustomData("stylesheet")) {
              ...
              --c ? a.setCustomData("stylesheet_ref", c) : (a.removeCustomData(
                  "stylesheet_ref"), b.removeCustomData("stylesheet").remove())
            }
          }
        }
      }
    ...
    CKEDITOR.editor.prototype.editable = function (a) {
      ...
      a ? b = a instanceof CKEDITOR.editable ? a : new CKEDITOR.editable(this,
          a) : (b && b.detach(), b = null);
    ...
    CKEDITOR.on("instanceLoaded", function (b) {
      ...
      c.on("insertElement", function (a) {
        ...
        a.type == CKEDITOR.NODE_ELEMENT && (a.is("input") ||
            a.is("textarea")) && ("false" != a.getAttribute("contentEditable")
        && a.data("cke-editable",
            a.hasAttribute("contenteditable") ? "true" : "1"), a.setAttribute(
            "contentEditable", !1))
      });
      c.on("selectionChange", function (b) {
        if (!c.readOnly) {
          var d = c.getSelection();
          d && !d.isLocked && (d = c.checkDirty(), c.fire("lockSnapshot"), a(
              b), c.fire("unlockSnapshot"), !d && c.resetDirty())
        }
      })
    });
    CKEDITOR.on("instanceCreated", function (a) {
      ...
      b.on("mode", function () {
        ...
        if (a && a.isInline()) {
          ...
          if (d && (c = this.ui.space(
              this.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? "top"
                  : "contents"))) {
            var e = CKEDITOR.tools.getNextId(),
                d = CKEDITOR.dom.element.createFromHtml(
                    '\x3cspan id\x3d"' + e + '" class\x3d"cke_voice_label"\x3e'
                    + d + "\x3c/span\x3e");
            c.append(d);
    ...
    m = function () {
      ...
      function b(c, d) {
        ...
        e = d.range.startPath();
        for (var k = w[k.getName()], C = 0, v = c.getChildren(), l = v.count(),
            m = -1, u = -1, Q = 0, B = e.contains(w.$list); C <
        l; ++C) {
          e = v.getItem(C), a(e) ? (q = e.getName(), B && q
          in CKEDITOR.dtd.$list ? h = h.concat(b(e, d)) : (g = !!k[q], "br" != q
          || !e.data("cke-eol") || C && C != l - 1 || (Q = (f = C ? h[C
              - 1].node
              : v.getItem(C + 1)) && (!a(f) || !f.is("br")), f = f && a(f)
              && w.$block[f.getName()]), -1 != m || g || (m = C), g
          || (u = C), h.push({
            isElement: 1,
            isLineBreak: Q,
            ...
            name: q,
            allowed: g
          }), f = Q = 0)) : h.push({isElement: 0, node: e, allowed: 1});
        }
      ...
      function d(b, c) {
        var e = [],
            f = b.getChildren(), q = f.count(), g, h = 0, k = w[c],
            C = !b.is(w.$inline) || b.is("br");
        for (C && e.push(" "); h < q; h++) {
          g = f.getItem(h), a(g) && !g.is(k)
              ? e = e.concat(d(g, c)) : e.push(g);
        }
        C && e.push(" ");
        return e
      }
      ...
      function e(b) {
        return a(b.startContainer) && b.startContainer.getChild(
            b.startOffset - 1)
      }

      function f(b) {
        return b && a(b) && (b.is(w.$removeEmpty) || b.is("a")
            && !b.isBlockBoundary())
      }
      ...
      function q(b, c, d, e) {
        ...
        (h = g.getPrevious()) && a(h) && !h.getParent().equals(b.startContainer)
        && d.contains(h) && e.contains(g) && g.isIdentical(h)
        && (g.moveChildren(h), g.remove(), q(b, c, d, e))
      }

      function h(b, c) {
        function d(b, c) {
          if (c.isBlock && c.isElement && !c.node.is("br") && a(b) && b.is(
              "br")) {
            return b.remove(), 1
          }
        }
        ...
        e && d(e, b[b.length - 1]);
        f && d(f, b[0]) && (c.setEnd(c.endContainer,
            c.endOffset - 1), c.collapse())
      }

      var w = CKEDITOR.dtd, v = {
      ...
      return function (n, v, H, F) {
        ...
        if (!F.checkReadOnly()) {
          var t = (new CKEDITOR.dom.elementPath(F.startContainer,
              F.root)).blockLimit || F.root;
          v = {
            type: v,
            dontFilter: A,
            editable: n,
          ...
          var A = v.range, t = v.mergeCandidates, L = "html" === v.type, r, x,
              z, y, I, U;
          "text" == v.type &&
          A.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1)
          && (x = CKEDITOR.dom.element.createFromHtml(
              "\x3cspan\x3e\x26nbsp;\x3c/span\x3e", A.document), A.insertNode(
              x), A.setStartAfter(x));
          ...
          if (!A.collapsed) {
            ...
            r && !r.equals(aa) && !r.contains(aa) && A.checkEndOfBlock()
            && v.zombies.push(r);
            A.deleteContents()
          }
          for (; (I = e(A)) && a(I) && I.isBlockBoundary() && z.contains(
              I);) {
            A.moveToPosition(I,
                CKEDITOR.POSITION_BEFORE_END);
          }
          ...
          if (r = x.contains(f, !1, 1)) {
            U = A.splitElement(
                r), v.inlineStylesRoot = r, v.inlineStylesPeak = x.lastElement;
          }
          x = A.createBookmark();
          L && (l(r), l(U));
          (r = x.startNode.getPrevious(c)) && a(r) && f(r) && t.push(r);
          (r = x.startNode.getNext(c)) && a(r) && f(r) && t.push(r);
          for (r = x.startNode; (r = r.getParent()) && f(r);) {
            t.push(r);
          }
          A.moveToBookmark(x);
          K.enterMode === CKEDITOR.ENTER_DIV && "" === K.getData(!0)
          ...
          if (n = H) {
            ...
            if ("text" == v.type && v.inlineStylesRoot) {
              ...
              for (U = v.inlineStylesRoot.getParent();
                  !F.equals(U);) {
            ...
            if ((J = n.startPath().block) && (1 != J.getChildCount()
                || !J.getBogus())) {
              a:{
                var P;
                if (1 == F.getChildCount() && a(P = F.getFirst()) && P.is(m)
                    && !P.hasAttribute("contenteditable")) {
                  J = P.getElementsByTag("*");
                  n = 0;
                  for (U = J.count(); n < U; n++) {
                    if (K = J.getItem(n), !K.is(
                        u)) {
                      break a;
                    }
                  }
          ...
          if (n) {
            ...
            var Z, A = I.getPosition(K),
                t = !!I.getCommonAncestor(K) && A != CKEDITOR.POSITION_IDENTICAL
                    && !(A & CKEDITOR.POSITION_CONTAINS
                        + CKEDITOR.POSITION_IS_CONTAINED),
                K = b(v.dataWrapper, v);
            for (h(K, P); U < K.length; U++) {
              A = K[U];
              if (L = A.isLineBreak) {
                L = P, r = F, y = z = void 0, A.hasBlockSibling
                    ? L = 1 : (z = L.startContainer.getAscendant(w.$block, 1))
                    && z.is({div: 1, p: 1}) ? (y = z.getPosition(r), y ==
                    CKEDITOR.POSITION_IDENTICAL || y
                    == CKEDITOR.POSITION_CONTAINS
                        ? L = 0 : (r = L.splitElement(z), L.moveToPosition(r,
                            CKEDITOR.POSITION_AFTER_START), L = 1)) : L = 0;
              }
              if (L) {
                H = 0 < U;
              } else {
                L = P.startPath();
                !A.isBlock && k(v.editor, L.block, L.blockLimit) && (M = g(
                    v.editor)) && (M = n.createElement(
                    M), M.appendBogus(), P.insertNode(
                    M), CKEDITOR.env.needsBrFiller && (R = M.getBogus())
                && R.remove(), P.moveToPosition(M,
                    CKEDITOR.POSITION_BEFORE_END));
                ...
                if (x && A.isElement) {
                  ...
                  if (L) {
                    r && (Y = P.splitElement(r), v.zombies.push(
                        Y), v.zombies.push(r));
                  } else {
                    r = F.getName();
                    Z = !U;
                    ...
                    z = [];
                    y = r.length;
                    for (var aa = 0, ca = void 0, W = 0, V = -1; aa < y;
                        aa++) {
                      ca = r[aa], " " == ca ? (W || Z && !aa || (z.push(
                          new CKEDITOR.dom.text(" ")), V = z.length), W = 1)
                          : (z.push(ca), W = 0);
                    }
                    L && V == z.length && z.pop();
                    Z = z
                ...
                A.lastNotAllowed && U < K.length - 1 && ((Y = t ? I : Y)
                && P.setEndAt(Y, CKEDITOR.POSITION_AFTER_START), x = 0);
                P.collapse()
              }
            }
            1 != K.length ? R = !1 : (R = K[0], R = R.isElement && "false"
                == R.node.getAttribute("contenteditable"));
            R && (H = !0, L = K[0].node, P.setStartAt(L,
                CKEDITOR.POSITION_BEFORE_START), P.setEndAt(L,
                CKEDITOR.POSITION_AFTER_END));
            v.dontMoveCaret = H;
          ...
          for (Z = R.createBookmark(); E = v.zombies.pop();) {
            E.getParent()
            && (M = R.clone(), M.moveToElementEditStart(
                E), M.removeEmptyBlocksAtEnd());
          }
          if (Y) {
            for (; E = Y.pop();) {
              CKEDITOR.env.needsBrFiller
                  ? E.appendBogus() : E.append(R.document.createText(" "));
            }
          }
          for (; E = v.mergeCandidates.pop();) {
            E.mergeSiblings();
          }
          R.moveToBookmark(Z);
          if (!v.dontMoveCaret) {
    ...
    M = function () {
      ...
      function c(a) {
        var b = a.count(), d;
        for (b; 0 < b--;) {
          d = a.getItem(b), CKEDITOR.tools.trim(d.getHtml())
          || (d.appendBogus(), CKEDITOR.env.ie && 9 > CKEDITOR.env.version
      ...
      return function (d) {
        ...
        f.setStart(e, 0);
        f = a(f).lastBackward();
        f || (f = d.clone(), f.setEndAt(e, CKEDITOR.POSITION_BEFORE_END), f = a(
            f).lastForward(), g = !0);
        f || (f = e);
        f.is("table") ? (d.setStartAt(f,
            CKEDITOR.POSITION_BEFORE_START), d.collapse(!0), f.remove())
            : (f.is({tbody: 1, thead: 1, tfoot: 1}) && (f = b(f, "tr",
            g)), f.is("tr") && (f = b(f,
            f.getParent().is("thead") ? "th" : "td", g)), (e = f.getBogus())
            && e.remove(), d.moveToPosition(f,
    ...
    y = function () {
      ...
      return function (b) {
        ...
        e.setStart(c, 0);
        e = a(e).lastBackward();
        e || (e = b.clone(), e.setEndAt(c, CKEDITOR.POSITION_BEFORE_END), e = a(
            e).lastForward(), d = !0);
        e || (e = c);
        e.is(CKEDITOR.dtd.$list) ?
            (b.setStartAt(e, CKEDITOR.POSITION_BEFORE_START), b.collapse(
                !0), e.remove()) : ((c = e.getBogus())
            && c.remove(), b.moveToPosition(e, d ? CKEDITOR.POSITION_AFTER_START
    ...
    J = {
      eol: {
        detect: function (a, b) {
          ...
          d.collapse(1);
          e.collapse();
          f.block && d.checkBoundaryOfElement(f.block, CKEDITOR.END)
          ...
          !a.prependEolBr || d && !d.getPrevious() || a.fragment.append(
              this.createEolBr(c), 1)
        ...
        rebuild: function (a, b) {
          ...
          if (e.blockLimit.is({tr: 1, table: 1})) {
            ...
            g = function (a) {
              ...
              && (f = f.contains(CKEDITOR.dtd.$list), c = c.contains(
          ...
          for (var e; c && !c.equals(b) && d(c);) {
            e = c.clone(0,
                1), a.fragment.appendTo(e), a.fragment = e, c = c.getParent()
          }
        }
      }, cell: {
        shrink: function (a) {
          a = a.range;
          var b = a.startContainer, c = a.endContainer, d = a.startOffset,
              e = a.endOffset;
          b.type == CKEDITOR.NODE_ELEMENT && b.equals(c) && b.is("tr") && ++d
      ...
      return {
        list: {
          detectMerge: function (a, b) {
            ...
            a.mergeList = g && h && g.getParent().equals(h.getParent())
                && !g.equals(h);
            a.mergeListItems = e.block && f.block && e.block.is(
                CKEDITOR.dtd.$listItem) && f.block.is(CKEDITOR.dtd.$listItem);
            if (a.mergeList
                || a.mergeListItems) {
              d = d.clone(), d.setStartBefore(
                  a.bookmark.startNode), d.setEndAfter(
                  a.bookmark.endNode), a.mergeListBookmark = d.createBookmark()
            }
          }, merge: function (a, c) {
            if (a.mergeListBookmark) {
              ...
              a.mergeListItems && (f = f.contains(
                  CKEDITOR.dtd.$listItem), g = g.contains(
                  CKEDITOR.dtd.$listItem), f.equals(g) || b(g, d, e));
              d.remove();
              e.remove()
            }
          }
          ...
          detectMerge: function (a, b) {
            ...
            if (a.mergeBlockBookmark && !a.purgeTableBookmark) {
              var d =
                  ...
                  f = new CKEDITOR.dom.elementPath(d, c),
                  g = new CKEDITOR.dom.elementPath(e, c), f = f.block,
                  g = g.block;
          ...
          function a(c) {
            var e = [], f, g = new CKEDITOR.dom.walker(c),
                h = c.startPath().contains(d), n = c.endPath().contains(d),
                k = {};
            g.guard = function (a, g) {
              ...
              if (g &&
                  h && a.equals(h)) {
                f = c.clone(), f.setEndAt(h,
                    CKEDITOR.POSITION_BEFORE_END), e.push(f);
              } else if (!g && n
                  && a.equals(n)) {
                f = c.clone(), f.setStartAt(n,
                    CKEDITOR.POSITION_AFTER_START), e.push(f);
              } else {
                if (l = !g) {
                  l = a.type == CKEDITOR.NODE_ELEMENT && a.is(d)
                      && (!h || b(a, h)) && (!n || b(a, n));
                }
                if (!l && (l = g)) {
                  if (a.is(d)) {
                    var l = h && h.getAscendant(
                        "table", !0), m = n && n.getAscendant("table", !0),
                        p = a.getAscendant("table", !0),
                        l = l && l.contains(p) || m && m.contains(
                            p);
                  } else {
                    l = void 0;
                  }
            ...
            detectPurge: function (a) {
              ...
              if (1 < e) {
                ...
                c && f && b.checkBoundaryOfElement(c,
                    CKEDITOR.START) && b.checkBoundaryOfElement(f, CKEDITOR.END)
                && (b = a.range.clone(), b.setStartBefore(c), b.setEndAfter(
                    f), a.purgeTableBookmark = b.createBookmark())
              }
            }, detectRanges: function (e, f) {
              var g = c(f, e.bookmark), h = g.clone(), k, n,
                  l = g.getCommonAncestor();
              l.is(CKEDITOR.dtd.$tableContent) && !l.is(d)
              ...
              n = n.contains("table");
              if (l || n) {
                l && n && b(l, n) ? (e.tableSurroundingRange =
                    h, h.setStartAt(l, CKEDITOR.POSITION_AFTER_END), h.setEndAt(
                    n,
                    CKEDITOR.POSITION_BEFORE_START), h = g.clone(), h.setEndAt(
                    l,
                    CKEDITOR.POSITION_AFTER_END), k = g.clone(), k.setStartAt(n,
                    CKEDITOR.POSITION_BEFORE_START), k = a(h).concat(a(k))) : l
                    ? n || (e.tableSurroundingRange = h, h.setStartAt(l,
                    CKEDITOR.POSITION_AFTER_END), g.setEndAt(l,
                    CKEDITOR.POSITION_AFTER_END))
                    : (e.tableSurroundingRange = h, h.setEndAt(n,
                        CKEDITOR.POSITION_BEFORE_START), g.setStartAt(n,
                        CKEDITOR.POSITION_AFTER_START)), e.tableContentsRanges = k
                    ? k : a(g)
              }
              ...
              for (var b; b =
                ...
                b.extractContents(), z(
                    b.startContainer) && b.startContainer.appendBogus();
              }
          ...
          a.startContainer.getDtd()["#"] || a.moveToClosestEditablePosition(
              null, !0)
        }, autoParagraph: function (a, b) {
          var c = b.startPath(), d;
          k(a, c.block, c.blockLimit) && (d = g(a))
          && (d = b.document.createElement(d), d.appendBogus(), b.insertNode(
              d), b.moveToPosition(d, CKEDITOR.POSITION_AFTER_START))
        }
      }
    }()
  })();
  (function () {
    ...
    function d(b, c) {
      if (0 === b.length || a(b[0].getEnclosedNode())) {
        return !1;
      }
      var d, e;
      if ((d = !c && 1 === b.length) && !(d = b[0].collapsed)) {
        ...
        d && d.equals(g) && !d.findOne("td, th, tr, tbody, table")
            ? (f = f.cloneContents(), d = f.getFirst() ? e(
            f.getFirst().getText()) !== e(d.getText()) : !0) : d = !1
      }
      if (d) {
        return !1;
      }
    ...
    function b(a) {
      ...
      for (e = 0; e < a.length; e++) {
        d = a[e]._getTableElement(), d.is && d.is(
            {td: 1, th: 1}) ? c.push(d) : c = c.concat(b(d));
      }
      return c
    }
    ...
    function c(a) {
      ...
      for (f = 0; f < a.length; f++) {
        e && !e.equals(a[f].getAscendant("tr"))
            ...
            : 0
            === f && (e = a[f].getAscendant("tr")), d.push(a[f].getText());
      }
      return c += d.join("\t")
    }
    ...
    function h() {
      ...
      if (b) {
        ...
        if (!(e = !c) && (e = !c.isHidden())) {
          ...
          var f = c.getRanges(), g = e.getRanges(),
              h = f.length && f[0]._getTableElement()
                  && f[0]._getTableElement().getAscendant("table", !0),
              n = g.length && g[0]._getTableElement()
                  && g[0]._getTableElement().getAscendant("table", !0),
              k = 1 === f.length && f[0]._getTableElement()
                  && f[0]._getTableElement().is("table"),
              H = 1 === g.length && g[0]._getTableElement()
      ...
      || (e = this._.selectionPreviousPath
          && this._.selectionPreviousPath.blockLimit.equals(
              c.blockLimit), !CKEDITOR.env.webkit && !CKEDITOR.env.gecko || e
      || (this._.previousActive = this.document.getActive()), this._.selectionPreviousPath =
    ...
    function l(a) {
      return G(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(
          CKEDITOR.dtd.$empty) ? !0 : !1
    }

    function u(a) {
      function b(c, d) {
        return c && c.type != CKEDITOR.NODE_TEXT ? a.clone()["moveToElementEdit"
        + (d ? "End" : "Start")](c) : !1
      }
      ...
      return b(d) || b(e, 1) || !(d || e || c.type == CKEDITOR.NODE_ELEMENT
          && c.isBlockBoundary() && c.getBogus()) ? !0 : !1
    }
      ...
      if (c) {
        if (!1 !== b) {
          var d = a.getDocument().getSelection().getNative(),
              e = d && "None" != d.type && d.getRangeAt(0), f = y.length;
        ...
        g
        && (c = a.getDocument().$, d = c.getSelection(), c = c.createRange(), c.setStart(
            g[0].node, g[0].offset), c.collapse(
            !0), d.removeAllRanges(), d.addRange(c), d.extend(g[1].node,
            g[1].offset))
      }
    }
    ...
    function I(a) {
      ...
      return function (c) {
        ...
        if (b[d]) {
          ...
          1 == e.length && f.collapsed && (d = f[38 > d
              ? "getPreviousEditableNode" : "getNextEditableNode"]()) && d.type
          == CKEDITOR.NODE_ELEMENT && "false" == d.getAttribute(
              "contenteditable") && (a.getSelection().fake(
              d), c.data.preventDefault(), c.cancel())
        }
      }
    }
      ...
      for (var b = 0; b < a.length; b++) {
        ...
        if (!c.collapsed) {
          if (c.startContainer.isReadOnly()) {
            for (var d = c.startContainer, e;
                d && !((e = d.type == CKEDITOR.NODE_ELEMENT) && d.is("body")
                    || !d.isReadOnly());) {
              e && "false" == d.getAttribute(
                  "contentEditable") && c.setStartAfter(d), d = d.getParent();
            }
          }
          d = c.startContainer;
          e = c.endContainer;
          var f = c.startOffset, g = c.endOffset, h = c.clone();
          d && d.type == CKEDITOR.NODE_TEXT && (f >= d.getLength()
              ? h.setStartAfter(d) : h.setStartBefore(d));
    ...
    var m = "function" != typeof window.getSelection, M = 1,
        y = CKEDITOR.tools.repeat("​", 7), J = new RegExp(y + "( )?", "g"), E,
        p, D, G = CKEDITOR.dom.walker.invisible(1), B = function () {
          function a(b) {
            return function (a) {
              var c =
          ...
          function b(a) {
            return function (b) {
              ...
              if (!c.readOnly) {
                return (e = d.moveToClosestEditablePosition(
                    b.selected, a)) || (e = d.moveToClosestEditablePosition(
                    b.selected, !a)), e && c.getSelection().selectRanges(
                    [d]), c.fire(
                    "saveSnapshot"), b.selected.remove(), e
                || (d.moveToElementEditablePosition(
                    c.editable()), c.getSelection().selectRanges([d])), c.fire(
                    "saveSnapshot"),
                    !1
              }
            }
    ...
    CKEDITOR.on("instanceCreated", function (a) {
      ...
      c.on("contentDom", function () {
        ...
        function b() {
          ...
          "None" != a.type && c.parentElement()
          && c.parentElement().ownerDocument == e.$ && c.select()
        }
        ...
        function d(a) {
          ...
          return a ? (a = a.startContainer.getAscendant(function (a) {
                return a.type == CKEDITOR.NODE_ELEMENT && a.hasAttribute(
                    "contenteditable")
              }, !0)) && "false" === a.getAttribute("contenteditable") ? a : null
              : null
        }

        var e = c.document, f = CKEDITOR.document, g = c.editable(),
            q = e.getBody(), l = e.getDocumentElement(), A = g.isInline(), C, p;
        CKEDITOR.env.gecko && g.attachListener(g, "focus", function (a) {
          a.removeListener();
          0 !== C && (a = c.getSelection().getNative()) && a.isCollapsed
          && a.anchorNode == g.$
          && (a = c.createRange(), a.moveToElementEditStart(g),
              a.select())
        }, null, null, -2);
        g.attachListener(g,
            ...
            function () {
              if (C && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                C = c._.previousActive && c._.previousActive.equals(
                    e.getActive());
                var a = null != c._.previousScrollTop && c._.previousScrollTop
                    != g.$.scrollTop;
                CKEDITOR.env.webkit && C && a
        ...
        if (CKEDITOR.env.ie || CKEDITOR.env.gecko || A) {
          m ? g.attachListener(g,
              "beforedeactivate", a, null, null, -1) : g.attachListener(c,
              "selectionCheck", a, null, null, -1), g.attachListener(g,
        ...
        if (CKEDITOR.env.ie && !A) {
          ...
          g.attachListener(g, "mouseup", function (a) {
            2 == a.data.$.button && u
            && (c.document.$.documentElement.scrollLeft = u.x, c.document.$.documentElement.scrollTop = u.y);
            u = null
          });
              ...
              l.on("mousedown", function (a) {
                function b(a) {
                  ...
                  if (r) {
                    ...
                    r.setEndPoint(
                        0 > t.compareEndPoints("StartToStart", c) ? "EndToEnd"
                            : "StartToStart", c);
                    r.select()
                  }
                }
            ...
            if (7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version) {
              l.on(
                  "mousedown", function (a) {
                    a.data.getTarget().is("html") && (f.on("mouseup", b), l.on(
                        "mouseup", b))
                  })
            }
          }
        ...
        if (A && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
          ...
          g.attachListener(CKEDITOR.env.ie ? g : e.getDocumentElement(),
              "mouseup", k, c);
        }
      ...
      if (CKEDITOR.env.ie9Compat) {
        c.on("beforeDestroy", b, null, null, 9);
      }
      ...
      c.on("loadSnapshot", function () {
            ...
            && (b.remove(), CKEDITOR.env.gecko && (a = c.editable().getFirst(a))
    ...
    if (CKEDITOR.env.webkit) {
      CKEDITOR.on("instanceReady", function (a) {
        ...
        b.on("selectionChange", function () {
          ...
          c && (c.getCustomData("ready") ? (x(a), a.editor.fire(
              "selectionCheck"))
    ...
    CKEDITOR.editor.prototype.getSelection = function (a) {
      return !this._.savedSelection && !this._.fakeSelection || a
          ? (a = this.editable()) && "wysiwyg" == this.mode
              ? new CKEDITOR.dom.selection(a) : null : this._.savedSelection
          || this._.fakeSelection
    };
    ...
    CKEDITOR.dom.range.prototype.select =
        function () {
          var a = this.root instanceof CKEDITOR.editable
              ? this.root.editor.getSelection() : new CKEDITOR.dom.selection(
                  this.root);
          a.selectRanges([this]);
          return a
        };
    ...
    CKEDITOR.dom.selection = function (a) {
      ...
      if (a) {
        if (a.getRangeAt) {
          ...
          d = e && CKEDITOR.dom.element.get(
              e.item && e.item(0) || e.parentElement())
        }
      }
      if (!d || d.type != CKEDITOR.NODE_ELEMENT && d.type != CKEDITOR.NODE_TEXT
          || !this.root.equals(d) && !this.root.contains(
              d)) {
    ...
    CKEDITOR.dom.selection.prototype = {
      getNative: function () {
        return void 0 !==
        this._.cache.nativeSel ? this._.cache.nativeSel
            : this._.cache.nativeSel = m ? this.document.$.selection
        ...
        var a = m ? function () {
          ...
          var b = function (b, c) {
            ...
            for (var e = d.children, f, g, h = b.duplicate(), k = 0,
              ...
              if (q = Math.floor(
                  (k + l) / 2), f = e[q], h.moveToElementText(
                  f), m = h.compareEndPoints("StartToStart", b), 0 < m) {
                l = q
                    - 1;
              } else if (0 > m) {
                k = q + 1;
            ...
            if (-1 == q || q == e.length - 1 && 0 > m) {
              ...
              e = d.childNodes;
              if (!h) {
                return f = e[e.length - 1], f.nodeType
                != CKEDITOR.NODE_TEXT ? {container: d, offset: e.length}
            ...
            h = h.text.replace(/(\r\n|\r)/g, "\n").length;
            if (!h) {
              return {container: d, offset: a(f) + (0 < m ? 0 : 1)};
            }
            for (; 0 < h;) {
              try {
                g = f[0 < m ? "previousSibling" : "nextSibling"], g.nodeType
                == CKEDITOR.NODE_TEXT && (h -= g.nodeValue.length, p = g), f = g
              } catch (u) {
          ...
          return function () {
            ...
            if (d == CKEDITOR.SELECTION_TEXT) {
              return a = new CKEDITOR.dom.range(
                  this.root), d = b(c, !0), a.setStart(
                  new CKEDITOR.dom.node(d.container), d.offset), d = b(
                  c), a.setEnd(new CKEDITOR.dom.node(d.container),
                  d.offset), a.endContainer.getPosition(a.startContainer)
              & CKEDITOR.POSITION_PRECEDING && a.endOffset
              <= a.startContainer.getIndex() && a.collapse(), [a];
            }
            if (d == CKEDITOR.SELECTION_ELEMENT) {
              for (var d = [], e = 0; e < c.length; e++) {
                for (var f =
                        c.item(e), g = f.parentNode, h = 0,
        ...
        switch (this.getType()) {
          ...
          case CKEDITOR.SELECTION_TEXT:
            ...
            if (c) {
              if (c.collapsed) {
                b = c.startContainer, b.type
                != CKEDITOR.NODE_ELEMENT && (b = b.getParent());
              } else {
                for (c.optimize(); b =
                    c.startContainer, c.startOffset == (b.getChildCount
        ...
        var b = this, c = CKEDITOR.tools.tryThese(function () {
          ...
          for (var a = b.getRanges()[0].clone(), c, d, e = 2;
              e && !((c = a.getEnclosedNode()) && c.type
                  == CKEDITOR.NODE_ELEMENT && N[c.getName()] && (d = c));
              e--) {
        ...
        if (this.isLocked) {
          if (a) {
            var b = this.getSelectedElement(), c = this.getRanges(),
                e = this.isFake;
          }
          this.isLocked = 0;
          this.reset();
          a && (a = b || c[0] && c[0].getCommonAncestor()) && a.getAscendant(
              "body", 1) && (this.root.editor.plugins.tableselection && d(c)
              ? f.call(this, c) : e ? this.fake(b) : b && 2 > c.length
        ...
        this.reset();
        if (c) {
          for (var c = this.root, g, h = 0; h < a.length;
              ++h) {
            g = a[h], g.endContainer.equals(c) && (g.endOffset = Math.min(
                g.endOffset, c.getChildCount()));
          }
        }
        if (a.length) {
          if (this.isLocked) {
            ...
            a:{
              var l, H;
              if (1 == a.length && !(H = a[0]).collapsed
                  && (n = H.getEnclosedNode()) && n.type
                  == CKEDITOR.NODE_ELEMENT
                  &&
                  (H = H.clone(), H.shrink(CKEDITOR.SHRINK_ELEMENT,
                      !0), (l = H.getEnclosedNode()) && l.type
                  == CKEDITOR.NODE_ELEMENT && (n = l), "false"
                  == n.getAttribute(
                      "contenteditable"))) {
                break a;
              }
            ...
            if (n) {
              this.fake(n);
                ...
                && b.plugins.tableselection.isSupportedEnvironment() && d(a)
                && !E
                && !a[0]._getTableElement({table: 1}).hasAttribute(
              ...
              if (m) {
                ...
                if ((c = b.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT
                    && c.getName() in N && (!c.is("a") || !c.getText())) {
                  try {
                ...
                if (b.startContainer.type == CKEDITOR.NODE_ELEMENT
                    && b.startContainer.getName() in H || b.endContainer.type
                    == CKEDITOR.NODE_ELEMENT && b.endContainer.getName()
                    in H) {
                ...
                k
                    ? (n = b.document.$.body.createTextRange(), n.moveToElementText(
                    k.$), A.setEndPoint("EndToEnd", n), A.moveEnd("character",
                    -1)) : (F = H.getNext(l), p = H.hasAscendant("pre"), F = !(F
                    && F.getText && F.getText().match(n)) && (p
                    || !H.hasPrevious() || H.getPrevious().is
                    && H.getPrevious().is("br")), p = b.document.createElement(
                    "span"), p.setHtml("\x26#65279;"), p.insertBefore(H), F
                    && b.document.createText("﻿").insertBefore(H));
                b.setStartBefore(H);
                H.remove();
                a ? (F ? (A.moveStart("character",
                    -1), A.select(), b.document.$.selection.clear())
                    : A.select(), b.moveToPosition(p,
                    CKEDITOR.POSITION_BEFORE_START), p.remove())
                ...
                for (A = 0; A < a.length; A++) {
                  if (A < a.length - 1 && (F = a[A], p = a[A
                  + 1], n = F.clone(), n.setStart(F.endContainer,
                      F.endOffset), n.setEnd(p.startContainer,
                      p.startOffset), !n.collapsed && (n.shrink(
                      CKEDITOR.NODE_ELEMENT,
                      !0), b = n.getCommonAncestor(), n = n.getEnclosedNode(),
                  ...
                  b.collapsed && CKEDITOR.env.webkit && u(b) && (n = e(
                      this.root), b.insertNode(n), (F = n.getNext())
                  && !n.getPrevious() && F.type == CKEDITOR.NODE_ELEMENT && "br"
                  == F.getName() ? (x(this.root), b.moveToPosition(F,
                      CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(n,
                      CKEDITOR.POSITION_AFTER_END));
        ...
        void 0 === b && a.hasAttribute("aria-label") && (b = a.getAttribute(
            "aria-label"));
        this.reset();
        z(c, b);
        ...
        a.isFake && (c = d(b) ? b[0]._getTableElement()
            : b[0].getEnclosedNode(), c && c.type == CKEDITOR.NODE_ELEMENT
  ...
  (function () {
    ...
    function b(c) {
      var e = c.document;
      if (c.collapsed) {
        e = M(this, e), c.insertNode(e), c.moveToPosition(e,
            CKEDITOR.POSITION_BEFORE_END);
      } else {
        var g = this.element, h = this._.definition, k, l = h.ignoreReadonly,
        ...
        c.trim();
        var q = c.createBookmark(), u = q.startNode, r = q.endNode, t = u, x;
        if (!l) {
          var v = c.getCommonAncestor(), l = a(u, v), v = a(r, v);
        ...
        for (t.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (t = 0); t;) {
          ...
          if (t.equals(r)) {
            ...
            if (z && t.data("cke-bookmark") || t.type
                === CKEDITOR.NODE_COMMENT) {
            ...
            if (v && m && CKEDITOR.dtd.$block[z]) {
              for (var D = t, B = f(D),
                  C = void 0, E = B.length, G = 0,
                  D = E && new CKEDITOR.dom.range(D.getDocument()); G < E;
                  ++G) {
                var C = B[G],
                    J = CKEDITOR.filter.instances[C.data("cke-filter")];
                if (J ? J.check(this) : 1) {
                  D.selectNodeContents(C), b.call(this,
                      D)
                }
              }
            }
            ...
            if (B) {
              if (C = t.getParent(), B = h, E = g, G = k, !C
              || !(C.getDtd() || CKEDITOR.dtd.span)[E] && !G || B.parentRule &&
              !B.parentRule(C)) {
                l = !0;
              } else {
                if (x || z && CKEDITOR.dtd.$removeEmpty[z] && (t.getPosition(r)
                    | Q) != Q || (x = c.clone(), x.setStartBefore(
                    t)), z = t.type, z == CKEDITOR.NODE_TEXT || v || z
                == CKEDITOR.NODE_ELEMENT && !t.getChildCount()) {
                  for (var z = t, N;
                      (l = !z.getNext(w)) && (N = z.getParent(), p[N.getName()])
                      && d(N, u, h, S);) {
                    z = N;
                  }
                  x.setEndAfter(z)
          ...
          if (l && x && !x.collapsed) {
            for (var l = M(this, e), v = l.hasAttributes(),
                y = x.getCommonAncestor(), z = {}, B = {}, C = {}, E = {}, W, V,
                X; l && y;) {
              if (y.getName() == g) {
                for (W in h.attributes) {
                  !E[W] &&
                  (X = y.getAttribute(V)) && (l.getAttribute(W) == X ? B[W] = 1
                      : E[W] = 1);
                }
                for (V in h.styles) {
                  !C[V] && (X = y.getStyle(V)) && (l.getStyle(
                      V) == X ? z[V] = 1 : C[V] = 1)
                }
              }
              y = y.getParent()
            ...
            l ? (x.extractContents().appendTo(l), x.insertNode(l), I.call(this,
                l), l.mergeSiblings(), CKEDITOR.env.ie || l.$.normalize())
                : (l = new CKEDITOR.dom.element(
                "span"), x.extractContents().appendTo(l), x.insertNode(
                l), I.call(this, l), l.remove(!0));
            x = null
          }
        }
        c.moveToBookmark(q);
    ...
    function c(a) {
      ...
      if (a.collapsed) {
        for (var f = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g,
            h = 0, k;
            h < f.elements.length && (k = f.elements[h]) && k != f.block && k
            != f.blockLimit; h++) {
          if (this.checkElementRemovable(k)) {
            var l;
            !e && a.collapsed && (a.checkBoundaryOfElement(k, CKEDITOR.END)
                || (l = a.checkBoundaryOfElement(k, CKEDITOR.START)))
                ? (g = k, g.match = l ? "start" : "end")
                : (k.mergeSiblings(), k.is(this.element) ? z.call(this, k) : r(
                k,
                E(this)[k.getName()]))
          }
        }
        ...
        b();
        for (f = d; !f.equals(m);) {
          g = f.getNextSourceNode(), f.type
          == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f)
          && (f.getName() == this.element ? z.call(this, f) : r(f,
              E(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT
          && g.contains(d) && (b(), g = d.getNext())), f = g
        }
      }
      a.moveToBookmark(c);
    ...
    function g(a) {
      ...
      for (var d, e = a.document, f; d = c.getNextParagraph();) {
        !d.isReadOnly()
        && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = M(this, e,
            d), u(d, f));
      }
      a.moveToBookmark(b)
    }
    ...
    function l(a) {
      ...
      for (var d, e; d = c.getNextParagraph();) {
        ...
        (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null
            : a.document.createElement(
                this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div"))
        && d.copyAttributes(e), u(d, e)) : z.call(this, d));
      }
      a.moveToBookmark(b)
    }
    ...
    function u(a, b) {
      ...
      if (d && !f) {
        ...
        g ? b = t(c ? [a.getHtml()] : e(a), b) : a.moveChildren(b);
      }
      b.replace(a);
      if (d) {
        var c = b, k;
        (k = c.getPrevious(v)) && k.type == CKEDITOR.NODE_ELEMENT && k.is("pre")
        && (d = x(k.getHtml(), /\n$/, "") + "\n\n" + x(c.getHtml(), /^\n/,
            ""), CKEDITOR.env.ie ? c.$.outerHTML = "\x3cpre\x3e" + d
            + "\x3c/pre\x3e" :
    ...
    function z(a, b) {
      ...
      for (g in d) {
        if ("class" != g && !this._.definition.fullMatch
      ...
      for (var h in c) {
        this._.definition.fullMatch && a.getStyle(h) != p(h,
            c[h], !0) || (f = f || !!a.getStyle(h), a.removeStyle(h));
      }
      r(a, e, B[a.getName()]);
      f && (this._.definition.alwaysRemoveElement ?
          m(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode
          == CKEDITOR.ENTER_BR && !a.hasAttributes() ? m(a) : a.renameNode(
              this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div"))
    }

    function I(a) {
      for (var b = E(this), c = a.getElementsByTag(this.element), d,
          e = c.count(); 0 <= --e;) {
        d = c.getItem(e), d.isReadOnly() || z.call(
            this, d, !0);
      }
      for (var f in b) {
        if (f != this.element) {
          for (c = a.getElementsByTag(
              f), e = c.count() - 1; 0 <= e; e--) {
            d = c.getItem(e), d.isReadOnly()
            || r(d, b[f])
          }
        }
      }
      ...
      if (b = b && b.attributes) {
        for (var d = 0; d < b.length; d++) {
          ...
          if (f = a.getAttribute(e)) {
            var g = b[d][1];
            (null === g || g.test && g.test(f) || "string" == typeof g && f
                == g)
            && a.removeAttribute(e)
          }
        }
    ...
    function m(a, b) {
      if (!a.hasAttributes() || b) {
        if (CKEDITOR.dtd.$block[a.getName()]) {
          ...
          c = a.getFirst(), d = a.getLast(), a.remove(!0), c && (c.type
          == CKEDITOR.NODE_ELEMENT && c.mergeSiblings(),
    ...
    function M(a, b, c) {
      ...
      b.getCustomData("doc_processing_style") && d.hasAttribute("id")
          ? d.removeAttribute("id") : b.setCustomData("doc_processing_style",
          1);
      return d
    }

    function y(a, b) {
      var c = b._.definition, d = c.attributes,
    ...
    function E(a) {
      ...
      if (c) {
        ...
        for (var d = 0; d < c.length; d++) {
          var e = c[d], f, g;
          "string" == typeof e ? f = e.toLowerCase() : (f = e.element
              ? e.element.toLowerCase() : a.element, g = e.attributes);
          e = b[f] || (b[f] = {});
          if (g) {
    ...
    function D(a, b) {
      ...
      for (var d in a) {
        if (!(d in b) || c(b[d], d) != c(a[d], d) && "inherit"
            != a[d] && "inherit" != b[d]) {
          return !1;
        }
      }
    ...
    var B = {
        ...
        w = CKEDITOR.dom.walker.bookmark(0,
            1), v = CKEDITOR.dom.walker.whitespaces(1);
    CKEDITOR.style = function (a, b) {
      ...
      var c = a.attributes;
      c && c.style && (a.styles = CKEDITOR.tools.extend({}, a.styles,
          CKEDITOR.tools.parseCssText(c.style)), delete c.style);
      b && (a = CKEDITOR.tools.clone(a), J(a.attributes, b), J(a.styles, b));
      c = this.element = a.element ? "string" == typeof a.element
          ? a.element.toLowerCase() : a.element : "*";
      this.type = a.type || (B[c] ? CKEDITOR.STYLE_BLOCK : N[c]
    ...
    CKEDITOR.style.prototype = {
      apply: function (a) {
        ...
        == CKEDITOR.STYLE_BLOCK ? g : this.type == CKEDITOR.STYLE_OBJECT ? h
            : null;
        return this.applyToRange(a)
      }, removeFromRange: function (a) {
        this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c
            : this.type == CKEDITOR.STYLE_BLOCK ? l : this.type
            == CKEDITOR.STYLE_OBJECT ? k : null;
        ...
        switch (this.type) {
          ...
          case CKEDITOR.STYLE_INLINE:
            for (var c = a.elements, d = 0, e; d < c.length;
                d++) {
              if (e = c[d], this.type != CKEDITOR.STYLE_INLINE || e
              != a.block && e != a.blockLimit) {
                if (this.type == CKEDITOR.STYLE_OBJECT) {
                  var f = e.getName();
                  if (!("string" == typeof this.element ? f == this.element : f
                      in this.element)) {
                    continue
                  }
                }
        ...
        var d = a.getName();
        if ("string" == typeof this.element ? d == this.element : d
            in this.element) {
    ...
    var Q = CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL
        | CKEDITOR.POSITION_IS_CONTAINED,
        S = CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL
            | CKEDITOR.POSITION_IS_CONTAINED
  })();
  ...
  CKEDITOR.styleCommand.prototype.exec = function (a) {
    a.focus();
    this.state == CKEDITOR.TRISTATE_OFF ? a.applyStyle(this.style) : this.state
        == CKEDITOR.TRISTATE_ON && a.removeStyle(this.style)
  };
  CKEDITOR.stylesSet = new CKEDITOR.resourceManager("", "stylesSet");
  CKEDITOR.addStylesSet = CKEDITOR.tools.bind(CKEDITOR.stylesSet.add,
      CKEDITOR.stylesSet);
  ...
  CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
    attachStyleStateChange: function (a, d) {
      ...
      b || (b = this._.styleStateChangeCallbacks = [], this.on(
          "selectionChange", function (a) {
            for (var d = 0; d < b.length; d++) {
              var h = b[d], k = h.style.checkActive(a.data.path, this)
      ...
      if (this._.stylesDefinitions) {
        ...
        if (!1 === b) {
          ...
          b || (b = "default");
          var b = b.split(":"), c = b[0];
          CKEDITOR.stylesSet.addExternal(c,
  ...
  (function () {
    if (window.Promise) {
      ...
      if ("function" === typeof window.define && window.define.amd && "function"
      ...
      CKEDITOR.scriptLoader.load(a, function (d) {
        if (!d) {
          return CKEDITOR.error("no-vendor-lib", {path: a});
        }
        if ("undefined"
            !== typeof window.ES6Promise) {
  ...
  (function () {
    ...
    CKEDITOR.dom.selection.prototype.optimizeInElementEnds = function () {
      ...
      if (this.root.editor._.shiftPressed || this.isFake || b.isCollapsed
        ...
        var k = b.endContainer.type === CKEDITOR.NODE_TEXT,
            g = h ? b.startContainer.getLength()
  ...
  (function () {
    ...
    for (b in CKEDITOR.dtd.$block) {
      b in CKEDITOR.dtd.$blockLimit || b
      in CKEDITOR.dtd.$empty || (d[b] = 1);
    }
    CKEDITOR.dom.elementPath = function (b, f) {
      var h = null, k = null, g = [], l = b, u;
      f = f || b.getDocument().getBody();
      l || (l = f);
      do {
        if (l.type == CKEDITOR.NODE_ELEMENT) {
          g.push(l);
          if (!this.lastElement && (this.lastElement = l, l.is(
              CKEDITOR.dtd.$object) || "false" == l.getAttribute(
              "contenteditable"))) {
            continue;
          }
          if (l.equals(f)) {
          ...
          if (!k && (u = l.getName(),
              "true" == l.getAttribute("contenteditable") ? k = l : !h && d[u]
                  && (h = l), a[u])) {
            if (u = !h && "div" == u) {
              a:{
                u = l.getChildren();
  ...
  CKEDITOR.dom.elementPath.prototype = {
    compare: function (a) {
      ...
      } : "function" == typeof a ? f = a : "object" == typeof a
          && (f = function (b) {
            return b.getName() in
                a
          });
      ...
      var d;
      return a in CKEDITOR.dtd.$block ? (d = this.contains(
          CKEDITOR.dtd.$intermediate) || this.root.equals(this.block)
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
    type: CKEDITOR.NODE_TEXT, getLength: function () {
      ...
      var d = this.$.parentNode, b = d.childNodes.length, c = this.getLength(),
          f = this.getDocument(),
          h = new CKEDITOR.dom.text(this.$.splitText(a), f);
      d.childNodes.length ==
      b && (a >= c ? (h = f.createText(""), h.insertAfter(this))
          : (a = f.createText(""), a.insertAfter(h), a.remove()));
      return h
    }, substring: function (a, d) {
      return "number" != typeof d ? this.$.nodeValue.substr(a)
          : this.$.nodeValue.substring(a, d)
    }
  });
  (function () {
    function a(a, c, d) {
      var h = a.serializable, k = c[d ? "endContainer" : "startContainer"],
          g = d ? "endOffset" : "startOffset",
          l = h ? c.document.getById(a.startNode) : a.startNode;
      a = h ? c.document.getById(a.endNode) : a.endNode;
      k.equals(l.getPrevious()) ? (c.startOffset = c.startOffset - k.getLength()
          - a.getPrevious().getLength(), k = a.getNext()) : k.equals(
          a.getPrevious()) && (c.startOffset -= k.getLength(), k = a.getNext());
        ...
        return {
          getNextRange: function (k) {
            ...
            if (g && 1 < a.length) {
                  ...
                  for (e = e.getById(d[u + 1].startNode); ;) {
                    ...
                    if (e.equals(l)) {
                      k = 1;
                        ...
                        == CKEDITOR.NODE_ELEMENT && l.isBlockBoundary()) {
                      continue;
                    }
                    break
                  }
              ...
              for (g.moveToBookmark(d.shift());
                  u--;) {
                l = a[++h], l.moveToBookmark(d.shift()), g.setEnd(
                    l.endContainer, l.endOffset)
              }
            }
            return g
          }
  ...
  (function () {
    function a() {
      return CKEDITOR.getUrl(
          CKEDITOR.skinName.split(",")[1] || "skins/" + CKEDITOR.skinName.split(
          ",")[0] + "/")
    }
    ...
    function d(b) {
      ...
      if (c) {
        for (var c = c.split(",").sort(function (a, b) {
          ...
          if (g = c[f], d.ie && (g.replace(/^ie/,
              "") == d.version || d.quirks && "iequirks" == g)
          && (g = "ie"), d[g]) {
            b += "_" + c[f];
            break
          }
    ...
    CKEDITOR.skin = {
      path: a, loadPart: function (c, d) {
        CKEDITOR.skin.name != CKEDITOR.skinName.split(",")[0]
            ? CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(a() + "skin.js"),
            function () {
              b(c, d)
            }) : b(c, d)
      }, getPath: function (a) {
    ...
    CKEDITOR.on("instanceLoaded", function (a) {
      if (!CKEDITOR.env.ie || !CKEDITOR.env.quirks) {
        var b = a.editor;
        a = function (a) {
          a = (a.data[0] || a.data).element.getElementsByTag("iframe").getItem(
              0).getFrameDocument();
  ...
  (function () {
    ...
    if (a = CKEDITOR._.pending) {
      for (delete CKEDITOR._.pending, d = 0;
          d < a.length; d++) {
        CKEDITOR.editor.prototype.constructor.apply(a[d][0],
...
*/
    ...
    var b = function () {
      return function (b, d) {
        for (var a = b.match(/[^#]./g), e = 0; 3 > e; e++) {
          var f = e, c;
          c = parseInt(a[e], 16);
          c = ("0" + (0 > d ? 0 | c * (1 + d) : 0 | c + (255 - c) * d).toString(
              16)).slice(-2);
          a[f] = c
        }
        return "#" + a.join("")
  ...
  CKEDITOR.plugins.add("dialogui", {
    onLoad: function () {
      var h = function (b) {
        ...
        for (var a in b) {
          (x.test(a) || "title" == a || "type" == a)
          && delete b[a];
        }
        return b
      }, w = function (b) {
        b = b.data.getKeystroke();
        b == CKEDITOR.SHIFT + CKEDITOR.ALT + 36 ? this.setDirectionMarker("ltr")
        ...
        labeledElement: function (b, a, d, f) {
          ...
          if (!(3 > arguments.length)) {
            ...
            b.on("load", function () {
              ...
              e.getInputElement().on("keyup", function (a) {
                13 == a.data.getKeystroke() && m && (b.getButton("ok")
                && setTimeout(function () {
            ...
            CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function () {
              var b = ['\x3cdiv class\x3d"cke_dialog_ui_input_', a.type,
          ...
          if (!(3 > arguments.length)) {
            ...
            CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function () {
              ...
              var a = ['\x3cdiv class\x3d"cke_dialog_ui_input_textarea" role\x3d"presentation"\x3e\x3ctextarea id\x3d"',
                c, '" '], b;
              for (b in e) {
                a.push(
                    b + '\x3d"' + CKEDITOR.tools.htmlEncode(e[b]) + '" ');
              }
              a.push("\x3e", CKEDITOR.tools.htmlEncode(f._["default"]),
            ...
            CKEDITOR.ui.dialog.uiElement.call(this, b, a, d, "span", null, null,
                function () {
                  var c = CKEDITOR.tools.extend({}, a, {
                        id: a.id ? a.id + "_checkbox" : CKEDITOR.tools.getNextId()
                            + "_checkbox"
                      }, !0), e = [], d = CKEDITOR.tools.getNextId() + "_label",
                      g = {
                  ...
                  f.checkbox = new CKEDITOR.ui.dialog.uiElement(b, c, e,
                      "input", null, g);
                  e.push(' \x3clabel id\x3d"', d, '" for\x3d"', g.id,
                      '"' + (a.labelStyle ? ' style\x3d"' + a.labelStyle + '"'
                      : "") + "\x3e", CKEDITOR.tools.htmlEncode(a.label),
                      "\x3c/label\x3e");
                  return e.join("")
                })
          }
                ...
                b, a, d, function () {
                  for (var e = [], d = [],
                    ...
                    var l = a.items[k], h = void 0 !== l[2] ? l[2] : l[0],
                        ...
                        q = p + "_label", p = CKEDITOR.tools.extend({}, a,
                        {id: p, title: null, type: null}, !0),
                    ...
                    f.push(
                        new CKEDITOR.ui.dialog.uiElement(b, p, u, "input", null,
                            r));
                    u.push(" ");
          ...
          if (!(3 > arguments.length)) {
            ...
            CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function () {
              var c = CKEDITOR.tools.extend({}, a, {
                id: a.id ? a.id + "_select" : CKEDITOR.tools.getNextId()
                    + "_select"
              }, !0), e = [], d = [], g = {
                id: f.inputId,
              ...
              t(c);
              for (var k = 0, l; k < a.items.length && (l = a.items[k]);
                  k++) {
                d.push('\x3coption value\x3d"',
                    CKEDITOR.tools.htmlEncode(
                        void 0 !== l[1] ? l[1] : l[0]).replace(/"/g,
                        "\x26quot;"),
                    '" /\x3e ', CKEDITOR.tools.htmlEncode(l[0]));
              }
              "undefined" != typeof c.inputStyle && (c.style = c.inputStyle);
              f.select = new CKEDITOR.ui.dialog.uiElement(b, c, e, "select",
                  null,
                  g, d.join(""));
              e.push("\x3c/div\x3e");
              return e.join("")
          ...
          if (!(3 > arguments.length)) {
            ...
            CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function () {
              ...
              var b = ['\x3ciframe frameborder\x3d"0" allowtransparency\x3d"0" class\x3d"cke_dialog_ui_input_file" role\x3d"presentation" id\x3d"',
                f.frameId, '" title\x3d"', a.label,
                '" src\x3d"javascript:void('];
              b.push(CKEDITOR.env.ie ? "(function(){" + encodeURIComponent(
          ...
          if (!(3 > arguments.length)) {
            ...
            c.onClick = function (c) {
              var d =
                  a["for"];
              c = e ? e.call(this, c) : !1;
              !1 !== c && ("xhr" !== c && b.getContentElement(d[0],
          ...
          return function (f, c, e) {
            if (!(3 > arguments.length)) {
              var m = [], g = c.html;
              "\x3c" != g.charAt(0) && (g = "\x3cspan\x3e" + g
                  + "\x3c/span\x3e");
              var k = c.focus;
              if (k) {
                var l = this.focus;
              ...
              CKEDITOR.ui.dialog.uiElement.call(this, f, c, m, "span", null,
                  null, "");
              m = m.join("").match(b);
              g = g.match(a) || ["", "", ""];
          ...
          var e = c.label;
          this._ = {children: a};
          CKEDITOR.ui.dialog.uiElement.call(this, b, c, f, "fieldset", null,
              null, function () {
                var a =
                    [];
                e && a.push(
                    "\x3clegend" + (c.labelStyle ? ' style\x3d"' + c.labelStyle
                    + '"' : "") + "\x3e" + e + "\x3c/legend\x3e");
                for (var b = 0; b < d.length; b++) {
                  a.push(d[b]);
                }
                return a.join("")
      ...
      CKEDITOR.ui.dialog.labeledElement.prototype = CKEDITOR.tools.extend(
          new CKEDITOR.ui.dialog.uiElement, {
            setLabel: function (b) {
              ...
              1 > a.getChildCount() ? (new CKEDITOR.dom.text(b,
                  CKEDITOR.document)).appendTo(a) : a.getChild(0).$.nodeValue =
                  b;
              return this
            }, getLabel: function () {
      ...
      CKEDITOR.ui.dialog.textInput.prototype = CKEDITOR.tools.extend(
          new CKEDITOR.ui.dialog.labeledElement, {
            ...
            getValue: function () {
              var b = CKEDITOR.ui.dialog.uiElement.prototype.getValue.call(
                  this);
              if (this.bidi && b) {
              ...
              b ? a.setAttributes({dir: b, "data-cke-dir-marker": b})
                  : this.getDirectionMarker() && a.removeAttributes(
                  ["dir", "data-cke-dir-marker"])
      ...
      CKEDITOR.ui.dialog.checkbox.prototype = CKEDITOR.tools.extend(
          new CKEDITOR.ui.dialog.uiElement, {
            getInputElement: function () {
              ...
              onChange: function (b,
                  a) {
                if (!CKEDITOR.env.ie || 8
                    < CKEDITOR.env.version) {
                  return v.onChange.apply(this,
                      arguments);
                }
                b.on("load", function () {
      ...
      CKEDITOR.ui.dialog.radio.prototype = CKEDITOR.tools.extend(
          new CKEDITOR.ui.dialog.uiElement, {
            setValue: function (b, a) {
              for (var d = this._.children, f, c = 0;
                  c < d.length && (f = d[c]); c++) {
              ...
              for (var b = this._.children, a = 0; a < b.length;
                  a++) {
              ...
              onChange: function (b, a) {
                ...
                b.on("load", function () {
                  for (var a =
                      this._.children, b = this, c = 0; c < a.length;
                      c++) {
                    a[c].getElement().on("propertychange", function (a) {
                      a = a.data.$;
                      "checked" == a.propertyName && this.$.checked && b.fire(
                          "change", {value: this.getAttribute("value")})
                    })
                  }
                }, this);
                this.on("change", a);
      ...
      CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(
          new CKEDITOR.ui.dialog.labeledElement, q, {
            getInputElement: function () {
              var b = CKEDITOR.document.getById(
                  this._.frameId).getFrameDocument();
              return 0 < b.$.forms.length ? new CKEDITOR.dom.element(
                  b.$.forms[0].elements[0]) :
                  this.getElement()
            }, submit: function () {
              ...
              function b() {
                ...
                + '"\x3e\x3chead\x3e\x3ctitle\x3e\x3c/title\x3e\x3c/head\x3e\x3cbody style\x3d"margin: 0; overflow: hidden; background: transparent;"\x3e',
                  ...
                  + g + '" lang\x3d"' + k + '" action\x3d"',
                  CKEDITOR.tools.htmlEncode(f.action), '"\x3e\x3clabel id\x3d"',
                  a.labelId, '" for\x3d"', h, '" style\x3d"display:none"\x3e',
                  CKEDITOR.tools.htmlEncode(f.label),
                  '\x3c/label\x3e\x3cinput style\x3d"width:100%" id\x3d"', h,
                  '" aria-labelledby\x3d"', a.labelId,
                  '" type\x3d"file" name\x3d"',
                  CKEDITOR.tools.htmlEncode(f.id || "cke_upload"),
                  '" size\x3d"', CKEDITOR.tools.htmlEncode(0 < b ? b : ""),
              ...
              var a = this._,
                  ...
                  m = this.formUnloadNumber, g = a.dialog._.editor.lang.dir,
                  k = a.dialog._.editor.langCode;
              e || (e = this.formLoadedNumber = CKEDITOR.tools.addFunction(
                  function () {
                    this.fire("formLoaded")
                  },
                  this), m = this.formUnloadNumber = CKEDITOR.tools.addFunction(
                  function () {
  ...
  (function () {
    ...
    function K(a, b) {
      for (var c = a.$.getElementsByTagName("input"), d = 0, e = c.length;
          d < e; d++) {
        var f = new CKEDITOR.dom.element(c[d]);
        "text" == f.getAttribute("type").toLowerCase() && (b ? (f.setAttribute(
            "value", f.getCustomData("fake_value") || ""), f.removeCustomData(
            "fake_value")) : (f.setCustomData("fake_value",
            f.getAttribute("value")), f.setAttribute("value", "")))
      }
    }

    function W(a, b) {
      var c = this.getInputElement();
      c && (a ? c.removeAttribute("aria-invalid") : c.setAttribute(
          "aria-invalid", !0));
    ...
    function Y(a) {
      var b = CKEDITOR.dom.element.createFromHtml(
          ...
          })), c = b.getChild([0, 0, 0, 0, 0]), d = c.getChild(0),
          e = c.getChild(1);
      a.plugins.clipboard
      && CKEDITOR.plugins.clipboard.preventDefaultDropOnElement(c);
      !CKEDITOR.env.ie || CKEDITOR.env.quirks || CKEDITOR.env.edge
      || (a = "javascript:void(function(){" + encodeURIComponent(
          "document.open();(" + CKEDITOR.tools.fixDomain
          + ")();document.close();")
          + "}())", CKEDITOR.dom.element.createFromHtml(
          '\x3ciframe frameBorder\x3d"0" class\x3d"cke_iframe_shim" src\x3d"'
          + a + '" tabIndex\x3d"-1"\x3e\x3c/iframe\x3e').appendTo(
          c.getParent()));
      d.unselectable();
      e.unselectable();
      return {
    ...
    function ba(a) {
      function b(b) {
        var c = a.getSize(), k = a.parts.dialog.getParent().getClientSize(),
            q = b.data.$.screenX, l = b.data.$.screenY, r = q - d.x,
            n = l - d.y;
        d = {x: q, y: l};
        e.x += r;
        e.y += n;
        q =
            e.x + h[3] < g ? -h[3] : e.x - h[1] > k.width - c.width - g
                ? k.width - c.width + ("rtl" == f.lang.dir ? 0 : h[1]) : e.x;
        c = e.y + h[0] < g ? -h[0] : e.y - h[2] > k.height - c.height - g
            ? k.height - c.height + h[2] : e.y;
        q = Math.floor(q);
        c = Math.floor(c);
        a.move(q, c, 1);
        b.data.preventDefault()
      ...
      var d = null, e = null, f = a.getParentEditor(),
      ...
      a.parts.title.on("mousedown", function (g) {
            ...
            e = a.getPosition();
            CKEDITOR.env.ie6Compat && (f = u.getChild(0).getFrameDocument(), f.on(
                "mousemove", b), f.on("mouseup", c));
    ...
    function ca(a) {
      function b(b) {
        var c = "rtl" == f.lang.dir, q = k.width, l = k.height,
            w = q + (b.data.$.screenX - m.x) * (c ? -1 : 1) * (a._.moved ? 1
                : 2), C = l + (b.data.$.screenY - m.y) * (a._.moved ? 1 : 2),
        ...
        C = Math.floor(C);
        w = Math.floor(w);
        if (e == CKEDITOR.DIALOG_RESIZE_WIDTH || e
            == CKEDITOR.DIALOG_RESIZE_BOTH) {
          q = Math.max(d.minWidth || 0,
              w - g);
        }
        if (e == CKEDITOR.DIALOG_RESIZE_HEIGHT ||
            e == CKEDITOR.DIALOG_RESIZE_BOTH) {
          l = Math.max(d.minHeight || 0,
              C - h);
        }
        a.resize(q, l);
            ...
            l = CKEDITOR.tools.addFunction(function (e) {
              ...
              var f = a.parts.contents,
                  ...
                  w = !(CKEDITOR.env.gecko || CKEDITOR.env.ie
                      && CKEDITOR.env.quirks);
              l && (q = CKEDITOR.dom.element.createFromHtml(
                  '\x3cdiv class\x3d"cke_dialog_resize_cover" style\x3d"height: 100%; position: absolute; width: 100%; left:0; top:0;"\x3e\x3c/div\x3e'), f.append(
                  q));
              ...
              CKEDITOR.document.on("mousemove", b);
              CKEDITOR.document.on("mouseup", c);
              CKEDITOR.env.ie6Compat && (f = u.getChild(
                  0).getFrameDocument(), f.on("mousemove", b), f.on("mouseup",
                  c));
              e.preventDefault && e.preventDefault()
            });
        a.on("load", function () {
          var b = "";
          e == CKEDITOR.DIALOG_RESIZE_WIDTH ? b = " cke_resizer_horizontal" : e
              == CKEDITOR.DIALOG_RESIZE_HEIGHT && (b = " cke_resizer_vertical");
          b = CKEDITOR.dom.element.createFromHtml(
              '\x3cdiv class\x3d"cke_resizer' +
              b + " cke_resizer_" + f.lang.dir + '" title\x3d"'
              + CKEDITOR.tools.htmlEncode(f.lang.common.resize)
              + '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + l
              + ', event )"\x3e' + ("ltr" == f.lang.dir ? "◢" : "◣")
              + "\x3c/div\x3e");
    ...
    function O(a, b, c) {
      var d = a.parts.dialog.getParent().getClientSize(), e = a.getSize(),
          f = a._.viewportRatio, g = Math.max(d.width - e.width, 0),
    ...
    function P(a) {
      var b = a.config, c = CKEDITOR.skinName || a.config.skin,
          d = b.dialog_backgroundCoverColor || ("moono-lisa" == c ? "black"
              : "white"), c = b.dialog_backgroundCoverOpacity,
          e = b.baseFloatZIndex, b = CKEDITOR.tools.genKey(d, c, e), f = D[b];
      CKEDITOR.document.getBody().addClass("cke_dialog_open");
      f ? f.show() : (e = ['\x3cdiv tabIndex\x3d"-1" style\x3d"position: ',
        CKEDITOR.env.ie6Compat ? "absolute" : "fixed", "; z-index: ", e,
        "; top: 0px; left: 0px; ", "; width: 100%; height: 100%;",
        CKEDITOR.env.ie6Compat ? "" : "background-color: " + d,
        '" class\x3d"cke_dialog_background_cover"\x3e'], CKEDITOR.env.ie6Compat
      && (d = "\x3chtml\x3e\x3cbody style\x3d\\'background-color:" + d
          + ";\\'\x3e\x3c/body\x3e\x3c/html\x3e", e.push(
          '\x3ciframe hidefocus\x3d"true" frameborder\x3d"0" id\x3d"cke_dialog_background_iframe" src\x3d"javascript:'), e.push(
          "void((function(){" + encodeURIComponent(
          "document.open();(" + CKEDITOR.tools.fixDomain
          + ")();document.write( '" + d + "' );document.close();")
          + "})())"), e.push(
          ...
          e.push("\x3c/div\x3e"), f = CKEDITOR.dom.element.createFromHtml(
          e.join("")), f.setOpacity(void 0 !== c ? c : .5), f.on("keydown",
          J), f.on("keypress", J), f.on("keyup", J), f.appendTo(
          CKEDITOR.document.getBody()), D[b] = f);
    ...
    function R(a) {
      var b = a.data.$.ctrlKey || a.data.$.metaKey, c = a.data.$.altKey,
          d = a.data.$.shiftKey, e = String.fromCharCode(a.data.$.keyCode);
      (b = x[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (d ? "SHIFT+" : "") + e])
      && b.length && (b = b[b.length - 1], b.keydown && b.keydown.call(
    ...
    function S(a) {
      var b = a.data.$.ctrlKey || a.data.$.metaKey, c = a.data.$.altKey,
          d = a.data.$.shiftKey, e = String.fromCharCode(a.data.$.keyCode);
      (b = x[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (d ? "SHIFT+" : "") + e])
      && b.length && (b = b[b.length - 1], b.keyup && (b.keyup.call(b.uiElement,
          b.dialog, b.key), a.data.preventDefault()))
    }
    ...
    var y = CKEDITOR.tools.cssLength, U, u,
        F = !CKEDITOR.env.ie || CKEDITOR.env.edge,
        Z = '\x3cdiv class\x3d"cke_reset_all cke_dialog_container {editorId} {editorDialogClass} {hidpi}" dir\x3d"{langDir}" style\x3d"'
            + (F ?
                "display:flex" : "")
            + '" lang\x3d"{langCode}" role\x3d"dialog" aria-labelledby\x3d"cke_dialog_title_{id}"\x3e\x3ctable class\x3d"cke_dialog '
            + CKEDITOR.env.cssClass + ' cke_{langDir}" style\x3d"' + (F
    ...
    CKEDITOR.dialog = function (a, b) {
      ...
      function e(b) {
        if (n == CKEDITOR.dialog._.currentTop) {
          var c = b.data.getKeystroke(), e = "rtl" == a.lang.dir,
              g = [37, 38, 39, 40];
          q = l = 0;
          if (9 == c || c == CKEDITOR.SHIFT + 9) {
            d(
                c == CKEDITOR.SHIFT + 9 ? -1 : 1), q = 1;
          } else if (c
              == CKEDITOR.ALT + 121 && !n._.tabBarMode && 1
              < n.getPageCount()) {
            z(n), q = 1;
          } else if (-1
              != CKEDITOR.tools.indexOf(g, c) && n._.tabBarMode) {
            c = -1
            != CKEDITOR.tools.indexOf([e ? 39 : 37, 38], c) ?
                A.call(n) : V.call(n), n.selectPage(
                c), n._.tabs[c][0].focus(), q = 1;
          } else if (13 != c && 32 != c
              || !n._.tabBarMode) {
            if (13 == c) {
              c = b.data.getTarget(), c.is("a",
                  "button", "select", "textarea") || c.is("input") && "button"
              == c.$.type || ((c = this.getButton("ok"))
              && CKEDITOR.tools.setTimeout(c.click, 0,
                  c), q = 1), l = 1;
            } else if (27 == c) {
              (c = this.getButton(
                  "cancel")) ? CKEDITOR.tools.setTimeout(c.click, 0, c) : !1
                  !== this.fire("cancel", {hide: !0}).hide
                  && this.hide(), l = 1;
            } else {
              return;
            }
            ...
            this.selectPage(
                this._.currentTabId), this._.tabBarMode = !1, this._.currentFocusIndex =
                -1, d(1), q = 1;
          }
          f(b)
        }
      ...
      var g = CKEDITOR.dialog._.dialogDefinitions[b],
          h = CKEDITOR.tools.clone(U), p = a.config.dialog_buttonsOrder || "OS",
          m = a.lang.dir, k = {}, q, l;
      ("OS" == p && CKEDITOR.env.mac || "rtl" == p && "ltr" == m || "ltr" == p
          && "rtl" == m) && h.buttons.reverse();
      ...
      this.on("cancel", function (b) {
        t(function (c) {
          if (c.isChanged()) {
            return a.config.dialog_noConfirmCancel || confirm(
                a.lang.common.confirmCancel) || (b.data.hide = !1), !0
          }
        })
      }, this, null, 0);
      ...
      this.on("iframeAdded", function (a) {
        (new CKEDITOR.dom.document(a.data.iframe.$.contentWindow.document)).on(
            "keydown", e, this, null, 0)
      });
      this.on("show", function () {
        c();
        var b = 1 < n._.pageCount;
        a.config.dialog_startupFocusTab && b
            ? (n._.tabBarMode = !0, n._.tabs[n._.currentTabId][0].focus(), n._.currentFocusIndex = -1)
            : this._.hasFocus || (this._.currentFocusIndex = b ? -1
      ...
      this.parts.tabs.on("click", function (a) {
        var b = a.data.getTarget();
        b.hasClass("cke_dialog_tab") && (b = b.$.id, this.selectPage(
            b.substring(4, b.lastIndexOf("_"))),
    ...
    CKEDITOR.dialog.prototype = {
      destroy: function () {
        ...
        if (!this._.contentSize || this._.contentSize.width != a
          ...
          if ("rtl" == this._.editor.lang.dir && this._.position) {
            ...
            this._.position.x = c - this._.contentSize.width - parseInt(
                this._.element.getFirst().getStyle("right"), 10)
          }
        ...
        a.getParent() && a.getParent().equals(c) ? a.setStyle("display",
            F ? "flex" : "block") : a.appendTo(c);
        ...
        null === CKEDITOR.dialog._.currentTop
            ? (CKEDITOR.dialog._.currentTop = this, this._.parentDialog = null, P(
            this._.editor))
            : (this._.parentDialog = CKEDITOR.dialog._.currentTop, c = this._.parentDialog.getElement().getFirst(), c.$.style.zIndex -=
                Math.floor(d / 2), this._.parentDialog.getElement().setStyle(
            "z-index", c.$.style.zIndex), CKEDITOR.dialog._.currentTop = this);
        a.on("keydown", R);
        a.on("keyup", S);
        this._.hasFocus = !1;
        for (var e in b.contents) {
          if (b.contents[e]) {
            var a = b.contents[e], d = this._.tabs[a.id], c = a.requiredContent,
                f = 0;
            if (d) {
              for (var g in this._.contents[a.id]) {
                var h = this._.contents[a.id][g];
                "hbox" != h.type && "vbox" != h.type && h.getInputElement()
                && (h.requiredContent && !this._.editor.activeFilter.check(
                    h.requiredContent) ? h.disable() : (h.enable(),
                    f++))
              }
              !f || c && !this._.editor.activeFilter.check(c) ? d[0].addClass(
                  "cke_dialog_tab_disabled") : d[0].removeClass(
        ...
        if (this._.moved || !F) {
          var b = this.getSize(),
              c = CKEDITOR.document.getWindow().getViewPaneSize(), d;
          this._.moved && this._.position
              ? (d = this._.position.x, b = this._.position.y) : (d = (c.width
              - b.width) / 2, b = (c.height - b.height) / 2);
          CKEDITOR.env.ie6Compat || (a.setStyle("position",
              "absolute"), a.removeStyle("margin"));
          d = Math.floor(d);
          b = Math.floor(b);
          this.move(d, b)
        }
        ...
        if (this.parts.dialog.isVisible()) {
          ...
          for (da(this); CKEDITOR.dialog._.currentTop
          != this;) {
          ...
          if (this._.parentDialog) {
            ...
            b.setStyle("z-index", parseInt(b.$.style.zIndex, 10) + Math.floor(
        ...
        if (!a.requiredContent || this._.editor.filter.check(
            a.requiredContent)) {
          for (var b = [],
              ...
              }, b), e = this._.contents[a.id] = {}, f = d.getChild(), g = 0;
              d = f.shift();) {
            d.notAllowed || "hbox" == d.type || "vbox"
            == d.type || g++, e[d.id] = d, "function" == typeof d.getChild
          ...
          a.accessKey && (T(this, this, "CTRL+" + a.accessKey, fa,
              ea), this._.accessKeyMap["CTRL+" + a.accessKey] = a.id)
        }
      }, selectPage: function (a) {
        if (this._.currentTabId != a && !this._.tabs[a][0].hasClass(
            "cke_dialog_tab_disabled") && !1 !== this.fire("selectPage",
            {page: a, currentPage: this._.currentTabId})) {
          ...
          CKEDITOR.env.ie6Compat || CKEDITOR.env.ie7Compat ? (K(
              e[1]), e[1].show(), setTimeout(function () {
            K(e[1], 1)
          }, 0)) : e[1].show();
        ...
        this.parts.dialog[(1 === this._.pageCount ? "add" : "remove")
        + "Class"]("cke_single_page")
      }, hidePage: function (a) {
        var b = this._.tabs[a] && this._.tabs[a][0];
        b && 1 != this._.pageCount &&
        b.isVisible() && (a == this._.currentTabId && this.selectPage(
            A.call(this)), b.hide(), this._.pageCount--, this.updateStyle())
      }, showPage: function (a) {
        if (a = this._.tabs[a]
            && this._.tabs[a][0]) {
        ...
        if ("undefined" == typeof b) {
          ...
          for (var c = b + 1; c < this._.focusList.length;
              c++) {
        ...
        if (this.state != a) {
          ...
          if (a == CKEDITOR.DIALOG_STATE_BUSY) {
            ...
            a == CKEDITOR.DIALOG_STATE_IDLE && (this.parts.spinner
            && this.parts.spinner.hide(), this.getButton("ok").enable());
          }
          this.fire("state", a)
        }
      }, getModel: function (a) {
        return this._.model ? this._.model : this.definition.getModel
            ? this.definition.getModel(a) : null
      }, setModel: function (a) {
        this._.model = a
      }, getMode: function (a) {
        if (this.definition.getMode) {
          return this.definition.getMode(a);
        }
        a = this.getModel(a);
        return !a || a instanceof CKEDITOR.dom.element && !a.getParent()
            ? CKEDITOR.dialog.CREATION_MODE : CKEDITOR.dialog.EDITING_MODE
      }
    };
    ...
    (function () {
      CKEDITOR.ui.dialog = {
        uiElement: function (a, b, c, d, e, f, g) {
          if (!(4 > arguments.length)) {
            var h = (d.call ? d(b) : d) || "div", p = ["\x3c", h, " "],
                m = (e && e.call ? e(b) : e) || {},
                k = (f && f.call ? f(b) : f) || {},
                q = (g && g.call ? g.call(this, a, b) : g) || "",
                l = this.domId = k.id || CKEDITOR.tools.getNextId()
                    + "_uiElement";
            b.requiredContent && !a.getParentEditor().filter.check(
                b.requiredContent)
            ...
            for (var n = k["class"] && k["class"].split ? k["class"].split(" ")
                : [], l = 0; l < n.length; l++) {
              n[l] && (r[n[l]] = 1);
            }
            n = [];
            ...
            r = (b.style || "").split(";");
            b.align && (n = b.align, m["margin-left"] = "left" == n ? 0
                : "auto", m["margin-right"] = "right" == n ? 0 : "auto");
            for (l in m) {
              r.push(l + ":" + m[l]);
            }
            ...
            for (l in k) {
              p.push(
                  l + '\x3d"' + CKEDITOR.tools.htmlEncode(k[l]) + '" ');
            }
            ...
            this.accessKeyUp && this.accessKeyDown && b.accessKey && T(this, a,
                "CTRL+" + b.accessKey);
            var t = this;
            a.on("load", function () {
              var b = t.getInputElement();
              if (b) {
                var c = t.type in {checkbox: 1, ratio: 1} && CKEDITOR.env.ie
                && 8 > CKEDITOR.env.version ? "cke_dialog_ui_focused" : "";
                b.on("focus", function () {
                  a._.tabBarMode = !1;
                  a._.hasFocus = !0;
                  t.fire("focus");
            ...
            this.keyboardFocusable && (this.tabIndex = b.tabIndex
                || 0, this.focusIndex = a._.focusList.push(this) - 1, this.on(
                "focus", function () {
          ...
          if (!(4 > arguments.length)) {
            this._ || (this._ = {});
            var f = this._.children = b, g = e && e.widths || null,
                h = e && e.height || null, p, m = {role: "presentation"};
            e && e.align && (m.align = e.align);
            CKEDITOR.ui.dialog.uiElement.call(this, a, e || {type: "hbox"}, d,
                "table", {}, m, function () {
                  var a =
                  ...
                  for (p = 0; p < c.length; p++) {
                    ...
                    g ? g[p] && d.push("width:" + y(g[p])) : d.push(
                        "width:" + Math.floor(100 / c.length) + "%");
                    h && d.push("height:" + y(h));
                    e && void 0 !== e.padding && d.push(
                        "padding:" + y(e.padding));
                    CKEDITOR.env.ie && CKEDITOR.env.quirks && f[p].align
          ...
          if (!(3 > arguments.length)) {
            this._ || (this._ = {});
            var f = this._.children = b, g = e && e.width || null,
                h = e && e.heights || null;
            CKEDITOR.ui.dialog.uiElement.call(this, a, e || {type: "vbox"}, d,
                "div", null, {role: "presentation"}, function () {
                  ...
                  b.push('"');
                  b.push('align\x3d"', CKEDITOR.tools.htmlEncode(
                      e && e.align || ("ltr" == a.getParentEditor().lang.dir
                      ? "left" : "right")), '" ');
                  ...
                  for (var d = 0; d < c.length; d++) {
                    ...
                    h ? k.push("height:" + y(h[d])) : e && e.expand && k.push(
                        "height:" + Math.floor(100 / c.length) + "%");
                    e && void 0 !== e.padding && k.push(
                        "padding:" + y(e.padding));
                    CKEDITOR.env.ie &&
                    CKEDITOR.env.quirks && f[d].align && k.push(
                        "text-align:" + f[d].align);
                    0 < k.length && b.push('style\x3d"', k.join("; "), '" ');
                    b.push(' class\x3d"cke_dialog_ui_vbox_child"\x3e', c[d],
    ...
    CKEDITOR.ui.dialog.uiElement.prototype = {
      getElement: function () {
        ...
        for (var a = this.getInputElement();
            (a = a.getParent()) && -1 == a.$.className.search(
        ...
        for (e in a) {
          if (c = e.match(b)) {
            this.eventProcessors[e]
                ? this.eventProcessors[e].call(this, this._.dialog, a[e]) : d(
                this,
                this._.dialog, c[1].toLowerCase(), a[e]);
          }
        }
        return this
      }, eventProcessors: {
    ...
    CKEDITOR.ui.dialog.hbox.prototype = CKEDITOR.tools.extend(
        new CKEDITOR.ui.dialog.uiElement,
        {
          getChild: function (a) {
            ...
            a.splice || (a = [a]);
            return 2 > a.length ? this._.children[a[0]] : this._.children[a[0]]
            && this._.children[a[0]].getChild ? this._.children[a[0]].getChild(
    ...
    (function () {
      var a = {
        build: function (a, c, d) {
          for (var e = c.children, f, g = [], h = [], p = 0;
              p < e.length && (f = e[p]); p++) {
            var m = [];
            g.push(m);
    ...
    (function () {
      ...
      CKEDITOR.dialog.validate = {
        functions: function () {
          var a = arguments;
          return function () {
            var b = this && this.getValue ? this.getValue() : a[0], c,
                d = CKEDITOR.VALIDATE_AND, e = [], f;
            for (f = 0; f < a.length; f++) {
              if ("function"
                  == typeof a[f]) {
                e.push(a[f]);
    ...
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
      openDialog: function (a, b, c) {
        ...
        if ("function" == typeof e) {
          e = this._.storedDialogs
              || (this._.storedDialogs = {}), d = e[a]
              || (e[a] = new CKEDITOR.dialog(this, a)), d.setModel(c), b
          && b.call(d, d), d.show();
        } else {
          if ("failed" == e) {
            throw Q(this), Error(
  ...
  CKEDITOR.plugins.add("dialog", {
    requires: "dialogui", init: function (z) {
      stylesLoaded || (CKEDITOR.document.appendStyleSheet(
          this.path + "styles/dialog.css"), stylesLoaded = !0);
  ...
  CKEDITOR.plugins.add("about", {
    requires: "dialog", init: function (a) {
      ...
      a.ui.addButton && a.ui.addButton("About",
          {label: a.lang.about.dlgTitle, command: "about", toolbar: "about"});
      ...
      init: function (b) {
        ...
        b.on("key", function (c) {
          if (27 == c.data.keyCode) {
            ...
            d.length && (a(b.lang.notification.closed), d[d.length
            - 1].hide(), c.cancel())
          }
        })
      }
    ...
    q.prototype = {
      show: function () {
        ...
        !1 === this.editor.fire("notificationUpdate",
            {notification: this, options: b}) && (a = !1);
        ...
        f && (c.removeClass(this._getClass()), c.removeAttribute(
            "aria-label"), this.type = f, c.addClass(
            this._getClass()), c.setAttribute("aria-label",
            this.type), "progress" != this.type || e ? "progress" != this.type
            && e && e.remove()
            : (e = this._createProgressElement(), e.insertBefore(d)));
        void 0 !== b.message && (this.message = b.message, d.setHtml(
            this.message));
        void 0 !== b.progress && (this.progress = b.progress,
        e && e.setStyle("width", this._getPercentageProgress()));
        a && b.important && (c.setAttribute("role", "alert"), this.isVisible()
        || this.area.add(this));
        ...
        return "progress" == this.type ? "cke_notification_info"
        ...
        if ("number" == typeof this.duration) {
          a = this.duration;
            ...
            == this.type || "success" == this.type) {
          a = "number"
          == typeof this.editor.config.notification_duration
              ? this.editor.config.notification_duration : 5E3;
        }
    ...
    r.prototype = {
      add: function (b) {
        ...
        var a = CKEDITOR.tools.indexOf(this.notifications,
            b);
        0 > a || (this.notifications.splice(a,
            1), b.element.remove(), this.element.getChildCount()
        ...
        var a = this.element, c = this.editor,
            d = c.ui.contentsElement.getClientRect(),
            e = c.ui.contentsElement.getDocumentPosition(), f, l,
            u = a.getClientRect(), m, g = this._notificationWidth,
            h = this._notificationMargin;
        m = CKEDITOR.document.getWindow();
        var p = m.getScrollPosition(), t = m.getViewPaneSize(),
            q = CKEDITOR.document.getBody(), r = q.getDocumentPosition(),
            k = CKEDITOR.tools.cssLength;
        g && h || (m = this.element.getChild(
            0), g = this._notificationWidth = m.getClientRect().width, h = this._notificationMargin = parseInt(
            m.getComputedStyle("margin-left"),
        ...
        f && f.isVisible() && l.bottom > d.top && l.bottom < d.bottom - u.height
            ? a.setStyles({position: "fixed", top: k(l.bottom)}) : 0 < d.top
            ? a.setStyles({position: "absolute", top: k(e.y)}) : e.y + d.height
            - u.height > p.y ? a.setStyles({position: "fixed", top: 0})
                : a.setStyles(
                    {position: "absolute", top: k(e.y + d.height - u.height)});
        var n = "fixed" == a.getStyle("position") ? d.left : "static"
        != q.getComputedStyle("position") ? e.x - r.x : e.x;
        d.width <
        g + h ? e.x + g + h > p.x + t.width ? b() : a.setStyle("left", k(n))
            : e.x + g + h > p.x + t.width ? a.setStyle("left", k(n)) : e.x
            + d.width / 2 + g / 2 + h > p.x + t.width ? a.setStyle("left",
            k(n - e.x + p.x + t.width - g - h)) : 0 > d.left + d.width - g - h
            ? b() : 0 > d.left + d.width / 2 - g / 2 ? a.setStyle("left",
                k(n - e.x + p.x)) : a.setStyle("left",
                k(n + d.width / 2 - g / 2 - h / 2))
      }
    };
    CKEDITOR.plugins.notification = q
  })();
  (function () {
    var c = '\x3ca id\x3d"{id}" class\x3d"cke_button cke_button__{name} cke_button_{state} {cls}"'
    ...
    var k = "";
    CKEDITOR.env.ie
    && (k = 'return false;" onmouseup\x3d"CKEDITOR.tools.getMouseButton(event)\x3d\x3dCKEDITOR.MOUSE_BUTTON_LEFT\x26\x26');
    var c = c
        ...
        v = CKEDITOR.addTemplate("buttonArrow",
            '\x3cspan class\x3d"cke_button_arrow"\x3e' + (CKEDITOR.env.hc
            ? "\x26#9660;" : "") + "\x3c/span\x3e"),
    ...
    CKEDITOR.ui.button.prototype = {
      render: function (a, b) {
        function c() {
          var f = a.mode;
          f && (f = this.modes[f] ? void 0 !== p[f] ? p[f]
              : CKEDITOR.TRISTATE_OFF
              : CKEDITOR.TRISTATE_DISABLED, f = a.readOnly && !this.readOnly
              ? CKEDITOR.TRISTATE_DISABLED :
              f, this.setState(f), this.refresh && this.refresh())
        }

        var p = null, q = CKEDITOR.env,
            r = this._.id = CKEDITOR.tools.getNextId(), g = "",
            d = this.command, k, l, m;
        this._.editor = a;
        var e = {
          ...
          if (e.onkey) {
            return a = new CKEDITOR.dom.event(a), !1 !== e.onkey(e,
                a.getKeystroke())
          }
        ...
        }, this), a.on("activeFilterChange", c, this), a.on("mode", c,
            this), !this.readOnly && a.on("readOnly", c, this)) : d
            && (d = a.getCommand(d)) && (d.on("state", function () {
              this.setState(d.state)
            }, this), g += d.state == CKEDITOR.TRISTATE_ON ?
                "on" : d.state == CKEDITOR.TRISTATE_DISABLED ? "disabled"
                    : "off");
        var n;
        if (this.directional) {
          a.on("contentDirChanged", function (b) {
            ...
            b = b.data;
            b != a.lang.dir ? c.addClass("cke_" + b) : c.removeClass(
                "cke_ltr").removeClass("cke_rtl");
            d.setAttribute("style",
                CKEDITOR.skin.getIconStyle(n, "rtl" == b, this.icon,
                    this.iconOffset))
          }, this);
        }
        d ? (l = a.getCommandKeystroke(d))
        ...
        var h =
            null, t = this.icon;
        n = l;
        this.icon && !/\./.test(this.icon) ? (n = this.icon, t = null)
            : (this.icon && (h = this.icon), CKEDITOR.env.hidpi
            && this.iconHiDpi && (h = this.iconHiDpi));
        ...
        g = {
          ...
          titleJs: q.gecko && !q.hc ? "" : (this.title ||
              "").replace("'", ""),
          hasArrow: "string" === typeof this.hasArrow && this.hasArrow
              || (this.hasArrow ? "true" : "false"),
          keydownFn: x,
          focusFn: y,
          clickFn: k,
          style: CKEDITOR.skin.getIconStyle(h, "rtl" == a.lang.dir, t,
              this.iconOffset),
        ...
        return b ? (b.setState(a, "cke_button"), b.setAttribute("aria-disabled",
            a == CKEDITOR.TRISTATE_DISABLED),
            this.hasArrow ? b.setAttribute("aria-expanded",
                a == CKEDITOR.TRISTATE_ON) : a === CKEDITOR.TRISTATE_ON
                ? b.setAttribute("aria-pressed", !0) : b.removeAttribute(
                    "aria-pressed"), !0) : !1
      }, getState: function () {
        return this._.state
  ...
  (function () {
    function D(a) {
      function d() {
        for (var b = f(),
            e = CKEDITOR.tools.clone(a.config.toolbarGroups) || v(a), n = 0;
            n < e.length; n++) {
          var g = e[n];
          if ("/" != g) {
      ...
      function f() {
        var b = {}, c, e, g;
        for (c in a.ui.items) {
          e = a.ui.items[c], g = e.toolbar
              || "others", g = g.split(","), e = g[0], g = parseInt(g[1] || -1,
              10), b[e] || (b[e] = []), b[e].push({name: c, order: g});
        }
        for (e in b) {
          b[e] = b[e].sort(function (b,
              a) {
            return b.order == a.order ? 0 : 0 > a.order ? -1 : 0 > b.order ? 1
                : b.order < a.order ? -1 : 1
          });
        }
        return b
      ...
      function c(c, e) {
        if (e.length) {
          ...
          for (var d; d = e.shift();) {
            d = "string" == typeof d ? d : d.name, b
            && -1 != CKEDITOR.tools.indexOf(b, d) || (d = a.ui.create(d))
            && a.addFeature(d) && c.items.push(d)
          }
        }
      }
      ...
      function h(b) {
        ...
        for (e = 0; e < b.length; ++e) {
          d = b[e], h = {}, "/" == d ? a.push(d)
              : CKEDITOR.tools.isArray(d) ? (c(h,
                  CKEDITOR.tools.clone(d)), a.push(h)) : d.items && (c(h,
                  CKEDITOR.tools.clone(d.items)),
                  h.name = d.name, a.push(h));
        }
        return a
      }

      var b = a.config.removeButtons, b = b && b.split(","),
          e = a.config.toolbar;
    ...
    var E = {
      modes: {wysiwyg: 1, source: 1}, readOnly: 1, exec: function (a) {
        a.toolbox && (a.toolbox.focusCommandExecuted = !0, CKEDITOR.env.ie
    ...
    CKEDITOR.plugins.add("toolbar", {
      requires: "button", init: function (a) {
        var d, f = function (c, h) {
          var b, e = "rtl" == a.lang.dir, k = a.config.toolbarGroupCycling,
              q = e ? 37 : 39, e = e ? 39 : 37, k = void 0 === k || k;
          switch (h) {
            case 9:
            case CKEDITOR.SHIFT + 9:
              for (; !b || !b.items.length;) {
                if (b = 9 == h ? (b ? b.next
                    : c.toolbar.next) || a.toolbox.toolbars[0] : (b ? b.previous
                    : c.toolbar.previous)
                    || a.toolbox.toolbars[a.toolbox.toolbars.length
                    - 1], b.items.length) {
                  for (c = b.items[d ? b.items.length - 1
                      : 0]; c && !c.focus;) {
            ...
            case q:
              ...
              return !1;
            case 40:
              return c.button && c.button.hasArrow ? c.execute() : f(c,
                  40 == h ? q : e), !1;
            case e:
            case 38:
              b = c;
        ...
        a.on("uiSpace", function (c) {
          if (c.data.space == a.config.toolbarLocation) {
            ...
            var d = CKEDITOR.tools.getNextId(),
                b = ['\x3cspan id\x3d"', d, '" class\x3d"cke_voice_label"\x3e',
                  a.lang.toolbar.toolbars, "\x3c/span\x3e",
                  '\x3cspan id\x3d"' + a.ui.spaceId("toolbox")
                  + '" class\x3d"cke_toolbox" role\x3d"group" aria-labelledby\x3d"',
                  d, '" onmousedown\x3d"return false;"\x3e'],
                d = !1 !== a.config.toolbarStartupExpanded, e, k;
            a.config.toolbarCanCollapse && a.elementMode
            != CKEDITOR.ELEMENT_MODE_INLINE && b.push(
                '\x3cspan class\x3d"cke_toolbox_main"' + (d ? "\x3e"
                : ' style\x3d"display:none"\x3e'));
            for (var q = a.toolbox.toolbars, n = D(a), g = n.length, l = 0;
                l < g; l++) {
              var r, m = 0, w, p = n[l],
                  v = "/" !== p && ("/" === n[l + 1] || l == g - 1), x;
              if (p) {
                if (e && (b.push("\x3c/span\x3e"), k = e = 0), "/"
                === p) {
                  b.push(
                    ...
                    if (t) {
                      ...
                      if (t.type == CKEDITOR.UI_SEPARATOR) {
                        ...
                        if (!m) {
                          ...
                          m = {id: r, items: []};
                          w = p.name && (a.lang.toolbar.toolbarGroups[p.name]
                              || p.name);
                          b.push('\x3cspan id\x3d"', r,
                              '" class\x3d"cke_toolbar' + (v
                              ? ' cke_toolbar_last"' : '"'),
                              w ? ' aria-labelledby\x3d"' + r + '_label"' : "",
                              ' role\x3d"toolbar"\x3e');
                          w && b.push('\x3cspan id\x3d"', r,
                              '_label" class\x3d"cke_voice_label"\x3e', w,
                              "\x3c/span\x3e");
                          b.push(
                        ...
                        A ? e || (b.push(
                            '\x3cspan class\x3d"cke_toolgroup" role\x3d"presentation"\x3e'), e = 1)
            ...
            if (a.config.toolbarCanCollapse && a.elementMode
                != CKEDITOR.ELEMENT_MODE_INLINE) {
              ...
              a.addCommand("toolbarCollapse", {
                readOnly: 1, exec: function (b) {
                  ...
                  f ? (c.show(), a.removeClass(
                      "cke_toolbox_collapser_min"), a.setAttribute("title",
              ...
              a.setKeystroke(
                  CKEDITOR.ALT + (CKEDITOR.env.ie || CKEDITOR.env.webkit ? 189
                  : 109), "toolbarCollapse");
              b.push('\x3ca title\x3d"' + (d ? a.lang.toolbar.toolbarCollapse
                  : a.lang.toolbar.toolbarExpand) + '" id\x3d"' + a.ui.spaceId(
                  "toolbar_collapser")
        ...
        a.on("destroy", function () {
          if (this.toolbox) {
            var a, d = 0, b, e, f;
            for (a = this.toolbox.toolbars; d < a.length;
                d++) {
              for (e = a[d].items, b = 0; b < e.length;
                  b++) {
                f = e[b], f.clickFn && CKEDITOR.tools.removeFunction(
                    f.clickFn), f.keyDownFn && CKEDITOR.tools.removeFunction(
                    f.keyDownFn)
              }
            }
          }
    ...
    CKEDITOR.ui.prototype.addToolbarGroup = function (a, d, f) {
      ...
      h ? c.splice(0, 0, a) : "number" == typeof d ? c.splice(d + 1, 0, b)
          : c.push(a)
    }
  })();
  ...
  (function () {
    function r(a, b, c) {
      b.type || (b.type = "auto");
      if (c && !1 === a.fire("beforePaste", b) || !b.dataValue
          && b.dataTransfer.isEmpty()) {
        return !1;
      }
    ...
    function x(a) {
      function b() {
        ...
        if (CKEDITOR.plugins.clipboard.isCustomCopyCutSupported) {
          var c = function (b) {
            a.getSelection().isCollapsed() || (a.readOnly && "cut" == b.name
            || p.initPasteDataTransfer(b,
        ...
        }), b.on("contextmenu", h, null, null, 0), b.on("beforepaste",
            function (a) {
        ...
        return {
          ...
          async: !0, fakeKeystroke: CKEDITOR.CTRL + 86, exec: function (a, b) {
            function c(b, g) {
              ...
              b ? (b.method = "paste", b.dataTransfer
              || (b.dataTransfer = p.initPasteDataTransfer()), r(a, b, g)) : e
                  && !a._.forcePasteDialog && a.showNotification(f, "info",
                      a.config.clipboard_notificationDuration);
              a._.forcePasteDialog = !1;
              a.fire("afterCommandExec",
                  {name: "paste", command: d, returnValue: !!b})
            }
            ...
            var d = this,
                ...
                m = CKEDITOR.tools.keystrokeToString(a.lang.common.keyboard,
                    a.getCommandKeystroke(this)), f = "string" === typeof e ? e
                : a.lang.clipboard.pasteNotification.replace(/%1/,
                    '\x3ckbd aria-label\x3d"' + m.aria + '"\x3e' + m.display
                    + "\x3c/kbd\x3e"),
                m = "string" === typeof b ? b : b.dataValue;
            g && !0 !== a.config.forcePasteAsPlainText && "allow-word"
            !== a.config.forcePasteAsPlainText ? a._.nextPasteType = g
      ...
      function e(b) {
        ...
        d.on(b, g);
        7 < CKEDITOR.env.version ? c.$.execCommand(b)
      ...
      function g() {
        if (CKEDITOR.env.ie && !CKEDITOR.env.quirks) {
          ...
          && (d = b.getRanges()[0], e = a.document.createText(
              ""), e.insertBefore(c), d.setStartBefore(e), d.setEndAfter(
              c), b.selectRanges([d]), setTimeout(function () {
      ...
      function l(b, c) {
        ...
        if (!d.getById("cke_pastebin")) {
          ...
          var k = new CKEDITOR.dom.element(
              !CKEDITOR.env.webkit && !e.is("body") || CKEDITOR.env.ie ? "div"
                  : "body", d);
          k.setAttributes({id: "cke_pastebin", "data-cke-temp": "1"});
          var h = 0, d = d.getWindow();
          CKEDITOR.env.webkit ? (e.append(k), k.addClass("cke_editable"), e.is(
              "body") || (h = "static" != e.getComputedStyle("position") ?
              e : CKEDITOR.dom.element.get(
                  e.$.offsetParent), h = h.getDocumentPosition().y))
          ...
          CKEDITOR.env.safari && k.setStyles(
              CKEDITOR.tools.cssVendorPrefix("user-select", "text"));
          (h = k.getParent().isReadOnly()) ? (k.setOpacity(0), k.setAttribute(
              "contenteditable", !0)) : k.setStyle(
          ...
          setTimeout(function () {
            ...
            k.remove();
            var b;
            CKEDITOR.env.webkit && (b = k.getFirst()) && b.is && b.hasClass(
                "Apple-style-span") && (k = b);
      ...
      function t() {
        if ("paste" == p.mainPasteEvent) {
          return a.fire("beforePaste",
              {type: "auto", method: "paste"}), !1;
        }
        a.focus();
        f();
        var b = a.focusManager;
        b.lock();
        if (a.editable().fire(p.mainPasteEvent) && !e(
            "paste")) {
          return b.unlock(), !1;
        }
        b.unlock();
      ...
      function k(b) {
        ...
        e && p.canClipboardApiBeTrusted(c.dataTransfer, a)
            ? (b.data.preventDefault(), setTimeout(function () {
              r(a, c)
            }, 0)) : l(b, function (b) {
      ...
      function q(b) {
        ...
        b = a.getSelection();
        c = b.getRanges();
        return b.getType() == CKEDITOR.SELECTION_NONE || 1 == c.length
        && c[0].collapsed ?
      ...
      (function () {
        ...
        if (a.ui.addButton) {
          a.once("instanceReady",
              function () {
                a._.pasteButtons && CKEDITOR.tools.array.forEach(
                    a._.pasteButtons,
                    function (b) {
                      if (b = a.ui.get(b)) {
                        if (b = CKEDITOR.document.getById(
                            b._.id)) {
      ...
      (function () {
        function b(c, e, d, g, m) {
          ...
          a.ui.addButton && a.ui.addButton(c,
              {label: k, command: e, toolbar: "clipboard," + g});
          a.addMenuItems && a.addMenuItem(e,
              {label: k, command: e, group: "clipboard", order: m})
        }
      ...
      a.getClipboardData = function (b, c) {
        ...
        g && a.fire("pasteDialog") ? (a.on("pasteDialogCommit", d), a.on(
            "dialogHide", function (a) {
              a.removeListener();
    ...
    function y(a) {
      if (CKEDITOR.env.webkit) {
        if (!a.match(/^[^<]*$/g) && !a.match(
            /^(<div><br( ?\/)?><\/div>|<div>[^<]*<\/div>)*$/gi)) {
          return "html"
        }
      } else if (CKEDITOR.env.ie) {
        if (!a.match(/^([^<]|<br( ?\/)?>)*$/gi) && !a.match(
            /^(<p>([^<]|<br( ?\/)?>)*<\/p>|(\r\n))*$/gi)) {
          return "html"
        }
    ...
    function z(a, b) {
      function c(a) {
        return CKEDITOR.tools.repeat("\x3c/p\x3e\x3cp\x3e", ~~(a / 2)) + (1 == a
        % 2 ? "\x3cbr\x3e" : "")
      }

      b = b.replace(/(?!\u3000)\s+/g, " ").replace(/> +</g, "\x3e\x3c").replace(
          /<br ?\/>/gi, "\x3cbr\x3e");
      ...
      CKEDITOR.env.webkit && -1 < b.indexOf("\x3cdiv\x3e") && (b = b.replace(
          /^(<div>(<br>|)<\/div>)(?!$|(<div>(<br>|)<\/div>))/g,
          "\x3cbr\x3e").replace(/^(<div>(<br>|)<\/div>){2}(?!$)/g,
          "\x3cdiv\x3e\x3c/div\x3e"),
      b.match(/<div>(<br>|)<\/div>/) && (b = "\x3cp\x3e" + b.replace(
          /(<div>(<br>|)<\/div>)+/g, function (a) {
            return c(a.split("\x3c/div\x3e\x3cdiv\x3e").length + 1)
          }) + "\x3c/p\x3e"), b = b.replace(/<\/div><div>/g,
          "\x3cbr\x3e"), b = b.replace(/<\/?div>/g, ""));
      CKEDITOR.env.gecko && a.enterMode != CKEDITOR.ENTER_BR
      && (CKEDITOR.env.gecko && (b = b.replace(/^<br><br>$/, "\x3cbr\x3e")), -1
      < b.indexOf("\x3cbr\x3e\x3cbr\x3e") && (b = "\x3cp\x3e" + b.replace(
          /(<br>){2,}/g, function (a) {
            return c(a.length / 4)
          }) + "\x3c/p\x3e"));
      return A(a, b)
    ...
    function B(a) {
      ...
      return {
        get: function (d) {
          return "plain-text" == d ? c.plainText
              || (c.plainText = new CKEDITOR.filter(a, "br"))
              : "semantic-content" == d ? ((d = c.semanticContent)
              || (d = new CKEDITOR.filter(a, {}), d.allow({
                $1: {
                  elements: b(),
                  attributes: !0,
                  styles: !1,
              ...
              }), d = c.semanticContent = d), d) : d ? new CKEDITOR.filter(a, d)
                  : null
        }
      }
    }
    ...
    function D(a) {
      ...
      a.on("contentDom", function () {
        ...
        var e = a.editable(), g = CKEDITOR.plugins.clipboard.getDropTarget(a),
            l = a.ui.space("top"), t = a.ui.space("bottom");
        ...
        e.attachListener(a, "dragstart", function () {
          ...
          && (b.dragStartContainerChildCount =
              c ? h(c.startContainer) : null, b.dragEndContainerChildCount = c
              ? h(c.endContainer) : null)
        }, null, null, 100);
        ...
        e.attachListener(g, "dragover", function (a) {
          if (CKEDITOR.env.edge) {
            ...
            var b = a.data.getTarget();
            b && b.is && b.is("html") ? a.data.preventDefault()
                : CKEDITOR.env.ie
        ...
        e.attachListener(g, "drop", function (c) {
          if (!c.data.$.defaultPrevented
            ...
            if (!e.isReadOnly() || e.type == CKEDITOR.NODE_ELEMENT && e.is(
                "html")) {
        ...
        e.attachListener(a, "drop", function (e) {
          if (e = e.data) {
            ...
            l.getTransferType(a) == CKEDITOR.DATA_TRANSFER_INTERNAL ?
                ...
                }, 0) : l.getTransferType(a)
                == CKEDITOR.DATA_TRANSFER_CROSS_EDITORS ? c(f, g, l) : d(g, l)
          }
        }, null, null, 9999)
      })
    }
    ...
    CKEDITOR.plugins.add("clipboard", {
      requires: "dialog,notification,toolbar", init: function (a) {
        ...
        var c, d = B(a);
        a.config.forcePasteAsPlainText ? c = "plain-text" : a.config.pasteFilter
            ? c = a.config.pasteFilter : !CKEDITOR.env.webkit || "pasteFilter"
            in
        ...
        if (CKEDITOR.env.gecko) {
          ...
          a.on("paste", function (c) {
            ...
            if (!d.dataValue && "paste" == d.method && b(l) && (l = l.getFile(
                0), -1 != CKEDITOR.tools.indexOf(f, l.type))) {
          ...
          if (!b.data.dataValue) {
            ...
            if (d) {
              b.data.dataValue = d, b.data.type = "html";
                ...
                "text/plain")) {
              b.data.dataValue = a.editable().transformPlainTextToHtml(
                  d),
                  b.data.type = "text"
            }
          }
          ...
          CKEDITOR.env.ie ? b = b.replace(/^&nbsp;(?: |\r\n)?<(\w+)/g,
              function (b, d) {
                return d.toLowerCase() in c
                    ? (a.data.preSniffing = "html", "\x3c" + d) : b
              }) : CKEDITOR.env.webkit ? b = b.replace(
              /<\/(\w+)><div><br><\/div>$/,
              function (b, d) {
                return d in c ? (a.data.endsWithEOL = 1, "\x3c/" + d + "\x3e")
                    : b
        ...
        a.on("paste", function (b) {
          ...
          var c = a._.nextPasteType || b.type, f = b.dataValue, h,
              ...
              k = b.dataTransfer.getTransferType(a)
          ...
          if ("text" == c && "html" == h) {
            f = w(a, f,
                d.get("plain-text"));
          } else if (k && a.pasteFilter && !b.dontFilter
              || n) {
        ...
        a.on("paste", function (b) {
          b = b.data;
          b.dataValue && (a.insertHtml(b.dataValue, b.type,
              b.range), setTimeout(function () {
                a.fire("afterPaste")
              },
              0))
        }, null, null, 1E3);
    ...
    CKEDITOR.plugins.clipboard = {
      isCustomCopyCutSupported: CKEDITOR.env.ie && 16 > CKEDITOR.env.version
      || CKEDITOR.env.iOS && 605 > CKEDITOR.env.version ? !1 : !0,
      isCustomDataTypesSupported: !CKEDITOR.env.ie || 16
          <= CKEDITOR.env.version,
      ...
      addPasteButton: function (a, b, c) {
        a.ui.addButton &&
        (a.ui.addButton(b, c), a._.pasteButtons
      ...
      canClipboardApiBeTrusted: function (a, b) {
        ...
        || CKEDITOR.env.chrome && !a.isEmpty() || CKEDITOR.env.gecko
        && (a.getData("text/html") || a.getFilesCount()) || CKEDITOR.env.safari
        && 603 <= CKEDITOR.env.version && !CKEDITOR.env.iOS || CKEDITOR.env.iOS
        && 605 <= CKEDITOR.env.version || CKEDITOR.env.edge && 16
        <= CKEDITOR.env.version ? !0 : !1
      },
      ...
      fixSplitNodesAfterDrop: function (a, b, c, d) {
        function f(a, c, d) {
          ...
          if (f.equals(c) && d
              != c.getChildCount()) {
            return a = b.startContainer.getChild(
                b.startOffset - 1), c = b.startContainer.getChild(
                b.startOffset), a && a.type == CKEDITOR.NODE_TEXT && c && c.type
            == CKEDITOR.NODE_TEXT && (d = a.getLength(), a.setText(
                a.getText() + c.getText()), c.remove(), b.setStart(a,
                d), b.collapse(!0)), !0
          }
        }
        ...
        typeof c && h.type == CKEDITOR.NODE_ELEMENT && (f(a.startContainer, h,
            c) || f(a.endContainer, h, d))
      },
      isDropRangeAffectedByDragRange: function (a, b) {
        ...
        || a.startContainer.getParent().equals(c) && a.startContainer.getIndex()
      ...
      internalDrop: function (a, b, c, d) {
        ...
        CKEDITOR.env.ie && 10 > CKEDITOR.env.version
        && this.fixSplitNodesAfterDrop(a, b, f.dragStartContainerChildCount,
        ...
        b = e.endNode;
        g = f.startNode;
        b && a.getPosition(g) & CKEDITOR.POSITION_PRECEDING && b.getPosition(g)
        & CKEDITOR.POSITION_FOLLOWING && g.insertBefore(a);
        a = d.createRange();
        a.moveToBookmark(e);
      ...
      getRangeAtDropPosition: function (a, b) {
        var c = a.data.$, d = c.clientX, f = c.clientY,
            h = b.getSelection(!0).getRanges()[0], e = b.createRange();
        if (a.data.testRange) {
          return a.data.testRange;
        }
        if (document.caretRangeFromPoint && b.document.$.caretRangeFromPoint(d,
            f)) {
          c = b.document.$.caretRangeFromPoint(d, f), e.setStart(
              CKEDITOR.dom.node(c.startContainer), c.startOffset),
              e.collapse(!0);
        } else if (c.rangeParent) {
          e.setStart(
              CKEDITOR.dom.node(c.rangeParent), c.rangeOffset), e.collapse(
              !0);
        } else {
          if (CKEDITOR.env.ie && 8 < CKEDITOR.env.version && h
              && b.editable().hasFocus) {
            return h;
          }
            ...
            try {
              ...
              if (g) {
                ...
                var q = b.document.$.elementFromPoint(d, f),
                    p = new CKEDITOR.dom.element(q), r;
                ...
                r = p.getClientRect();
                d < r.left ? e.setStartAt(p, CKEDITOR.POSITION_AFTER_START)
      ...
      initDragDataTransfer: function (a,
        ...
        c ? this.dragData && d.id == this.dragData.id ? d = this.dragData
            : this.dragData = d : this.dragData ? d = this.dragData
            : this.dragData = d;
      ...
      initPasteDataTransfer: function (a, b) {
        if (this.isCustomCopyCutSupported) {
          if (a && a.data && a.data.$) {
            ...
            this.copyCutData &&
            d.id == this.copyCutData.id ? (d = this.copyCutData, d.$ = c)
                : this.copyCutData = d;
            return d
          }
    ...
    n = CKEDITOR.plugins.clipboard.isCustomDataTypesSupported ? "cke/id"
        : "Text";
    CKEDITOR.plugins.clipboard.dataTransfer = function (a, b) {
      ...
      this.id || (this.id = "Text" == n ? "" : "cke-"
          + CKEDITOR.tools.getUniqueId());
      b && (this.sourceEditor = b, this.setData("text/html",
          b.getSelectedHtml(1)), "Text" == n || this.getData("text/plain")
      ...
      getData: function (a, b) {
        ...
        if (void 0 === c || null === c || "" === c) {
          if (this._.fallbackDataTransfer.isRequired()) {
            c = this._.fallbackDataTransfer.getData(
                a, b);
          } else {
            try {
              c = this.$.getData(a) || ""
        ...
        a = this._.normalizeType(a);
        "text/html" == a ? (this._.data[a] = this._stripHtml(
            b), this._.nativeHtmlCache = b) : this._.data[a] = b;
        if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported || "URL" == a
            || "Text" == a) {
          if ("Text" == n && "Text" == a
          && (this.id = b), this._.fallbackDataTransfer.isRequired()) {
            this._.fallbackDataTransfer.setData(
                a, b);
          } else {
            try {
              this.$.setData(a, b)
        ...
        return this.sourceEditor ? this.sourceEditor == a
            ? CKEDITOR.DATA_TRANSFER_INTERNAL
        ...
        return this._.files.length ? this._.files.length : this.$
        && this.$.files && this.$.files.length ? this.$.files.length
            : this._getImageFromClipboard() ? 1 : 0
      }, getFile: function (a) {
        return this._.files.length ? this._.files[a] : this.$ && this.$.files
        && this.$.files.length ?
        ...
        CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(this._.data),
            function (b) {
              a[b] = 1
            });
        if (this.$) {
          if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported) {
            if (this.$.types) {
              for (var c = 0; c < this.$.types.length;
                  c++) {
                a[this.$.types[c]] = 1
              }
            }
        ...
        try {
          if (this.$ && this.$.items && this.$.items[0]
              && (a = this.$.items[0].getAsFile()) && a.type) {
            return a
          }
        } catch (b) {
        }
      ...
      isRequired: function () {
        ...
        if (null === a._isCustomMimeTypeSupported) {
          if (b) {
            ...
            if (CKEDITOR.env.edge && 17 <= CKEDITOR.env.version) {
              return !0;
            }
            try {
              b.setData("cke/mimetypetest",
                  "cke test value"), a._isCustomMimeTypeSupported = "cke test value"
                  === b.getData("cke/mimetypetest"), b.clearData(
                  "cke/mimetypetest")
            } catch (c) {
            }
          } else {
        ...
        var c = this._extractDataComment(c), d = null,
            d = a === this._customDataFallbackType ? c.content : c.data
            && c.data[a] ? c.data[a] : this._getData(a, !0);
        return null !== d ? d : ""
      }, setData: function (a, b) {
        ...
        try {
          ...
          if (this._isUnsupportedMimeTypeError(h)) {
            ...
            e[a] = d;
            try {
              d = this._applyDataComment(c, e), f.setData(
                  this._customDataFallbackType,
                  d), this._dataTransfer._.nativeHtmlCache = d
            } catch (g) {
              d = ""
            }
          }
        ...
        a || (a = this._extractDataComment(
            this._getData(this._customDataFallbackType, !0)).content);
        return a
      }, _getFallbackTypeData: function () {
        var a = CKEDITOR.plugins.clipboard.fallbackDataTransfer._customTypes,
            b = this._extractDataComment(
                this._getData(this._customDataFallbackType, !0)).data || {},
        ...
        if (a && 16 < a.length) {
          var c;
          (c = /\x3c!--cke-data:(.*?)--\x3e/g.exec(a)) && c[1]
          && (b.data = JSON.parse(
              decodeURIComponent(c[1])), b.content = a.replace(c[0], ""))
        }
        return b
      }, _applyDataComment: function (a, b) {
        var c = "";
        b && CKEDITOR.tools.object.keys(b).length && (c = "\x3c!--cke-data:"
            + encodeURIComponent(JSON.stringify(b)) + "--\x3e");
  ...
  (function () {
    ...
    function z(a) {
      var e = a.startContainer.getAscendant(function (a) {
            return a.type == CKEDITOR.NODE_ELEMENT && "true" == a.getAttribute(
                "contenteditable")
          },
          !0);
      if (a.root.equals(e)) {
    ...
    var A = CKEDITOR.dom.walker.whitespaces(),
        B = CKEDITOR.dom.walker.bookmark(), v, u, r, w;
    CKEDITOR.plugins.enterkey =
        {
          enterBlock: function (a, e, b, l) {
            function n(a) {
              var b;
              if (a === CKEDITOR.ENTER_BR || -1 === CKEDITOR.tools.indexOf(
                  ["td", "th"], p.lastElement.getName()) || 1
                  !== p.lastElement.getChildCount()) {
                return !1;
              }
            ...
            if (b = b || y(a)) {
              b = z(b);
              var g = b.document, f = b.checkStartOfBlock(),
                  k = b.checkEndOfBlock(), p = a.elementPath(b.startContainer),
              ...
              if (c && f && k) {
                ...
                if (c.is("li") || c.getParent().is("li")) {
                  ...
                  var h = !c.hasNext();
                  l = a.getSelection();
                  var m = l.createBookmarks(), t = c.getDirection(1),
                      k = c.getAttribute("class"), q = c.getAttribute("style"),
                      r = d.getDirection(1) != t;
                  a = a.enterMode != CKEDITOR.ENTER_BR || r || q || k;
                  if (d.is("li")) {
                    b || h ? (b && h && f.remove(), c[h
                        ? "insertAfter" :
                        "insertBefore"](d)) : c.breakParent(d);
                  } else {
                    if (a) {
                      if (p.block.is("li") ? (d = g.createElement(
                          e == CKEDITOR.ENTER_P ? "p" : "div"), r
                          && d.setAttribute("dir", t), q && d.setAttribute("style",
                          q), k && d.setAttribute("class", k), c.moveChildren(
                          d))
                          : d = p.block, b || h) {
                        d[b ? "insertBefore"
                            : "insertAfter"](f);
              ...
              if (q = b.splitBlock(m)) {
                ...
                f = q.wasStartOfBlock;
                k = q.wasEndOfBlock;
                c ? (h = c.getParent(), h.is("li") && (c.breakParent(h), c.move(
                    c.getNext(), 1))) : a && (h = a.getParent()) &&
                    h.is("li") && (a.breakParent(
                        h), h = a.getNext(), b.moveToElementEditStart(
                        h), a.move(a.getPrevious()));
                if (f || k) {
                  if (n(e)) {
                    b.moveToElementEditStart(
                        b.getTouchedStartNode());
                  } else {
                    if (a) {
                      if (a.is("li") || !w.test(a.getName()) && !a.is(
                          "pre")) {
                        d = a.clone()
                      }
                    } else {
                    ...
                    d ? l && !d.is("li") && d.renameNode(m) : h && h.is("li")
                        ? d = h : (d = g.createElement(m), a
                        && (t = a.getDirection()) && d.setAttribute("dir", t));
                    if (g = q.elementPath) {
                      for (e = 0, l = g.elements.length;
                          e < l; e++) {
                        m = g.elements[e];
                        if (m.equals(g.block) || m.equals(g.blockLimit)) {
                          break;
                        }
                    ...
                    !CKEDITOR.env.ie || !f || k && a.getChildCount()
                    || (b.moveToElementEditStart(k ? a : d), b.select());
                    b.moveToElementEditStart(f && !k ? c : d)
                  }
                } else {
                  c.is("li") && (d = b.clone(), d.selectNodeContents(
                      c), d = new CKEDITOR.dom.walker(
                      d), d.evaluator = function (a) {
                    return !(B(a) || A(a) || a.type == CKEDITOR.NODE_ELEMENT
                        && a.getName() in CKEDITOR.dtd.$inline && !(a.getName()
                            in
                            CKEDITOR.dtd.$empty))
                  }, (h = d.next()) && h.type == CKEDITOR.NODE_ELEMENT && h.is(
                      "ul", "ol") && (CKEDITOR.env.needsBrFiller
                      ? g.createElement("br") : g.createText(" ")).insertBefore(
                      h)), c && b.moveToElementEditStart(c);
                }
                b.select();
                b.scrollIntoView()
              }
            ...
            if (b = b || y(a)) {
              var n = b.document, g = b.checkEndOfBlock(),
                  f = new CKEDITOR.dom.elementPath(
                      a.getSelection().getStartElement()), k = f.block,
                  p = k && f.block.getName();
              l || "li" != p ? (!l && g && w.test(p) ? (g = k.getDirection())
                  ? (n = n.createElement("div"), n.setAttribute("dir",
                      g), n.insertAfter(k), b.setStart(n, 0))
                  : (n.createElement("br").insertAfter(k), CKEDITOR.env.gecko
                  && n.createText("").insertAfter(k), b.setStartAt(k.getNext(),
                      CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START
                          : CKEDITOR.POSITION_AFTER_START)) : (a = "pre" == p
              && CKEDITOR.env.ie && 8 > CKEDITOR.env.version ? n.createText(
                  "\r") : n.createElement(
                  "br"), b.deleteContents(), b.insertNode(
                  a), CKEDITOR.env.needsBrFiller ? (n.createText(
                  "﻿").insertAfter(a), g && (k
                  || f.blockLimit).appendBogus(), a.getNext().$.nodeValue = "", b.setStartAt(
                  a.getNext(),
                  CKEDITOR.POSITION_AFTER_START)) : b.setStartAt(a,
                  CKEDITOR.POSITION_AFTER_END)), b.collapse(
                  !0), b.select(), b.scrollIntoView()) : r(a, e, b, l)
            }
          }
        };
  ...
  (function () {
    ...
    CKEDITOR.plugins.add("entities", {
      afterInit: function (a) {
        ...
        function g(a) {
          return "force" != c.entities_processNumerical && b[a] ? b[a] : "\x26#"
              + a.charCodeAt(0) + ";"
        }
        ...
        if (a = (a = a.dataProcessor) && a.htmlFilter) {
          ...
          var d = new RegExp(d, "g"), h = k("nbsp,gt,lt,amp,shy", !0),
  ...
  (function () {
    function k(a) {
      var l = a.config, p = a.fire("uiSpace", {space: "top", html: ""}).html,
          t = function () {
            function f(a, c, e) {
              b.setStyle(c, w(e));
            ...
            return function (d) {
              if (k = a.editable()) {
                ...
                h = g.getViewPaneSize();
                q = n.height;
                v = "pageXOffset" in g.$ ? g.$.pageXOffset
                    : CKEDITOR.document.$.documentElement.scrollLeft;
                m ? (q + r <= c.top ? e("top") : q + r > h.height - c.bottom
                    ? e("pin") : e("bottom"), d = h.width
                    / 2, d = l.floatSpacePreferRight ? "right" : 0 < c.left
                && c.right < h.width && c.width > n.width ? "rtl"
                == l.contentsLangDirection ?
                    "right" : "left" : d - c.left > c.right - d ? "left"
                    : "right", n.width > h.width ? (d = "left", f = 0)
                    : (f = "left" == d ? 0 < c.left ? c.left : 0 : c.right
                    < h.width ? h.width - c.right : 0, f + n.width > h.width
                    && (d = "left" == d ? "right" : "left", f = 0)), b.setStyle(
                    d,
                    w(("pin" == m ? u : p) + f + ("pin" == m ? 0 : "left" == d
                        ? v : -v)))) : (m = "pin", e("pin"), t(d))
              }
            }
          }();
      if (p) {
        var k = new CKEDITOR.template(
            ...
            + CKEDITOR.env.cssClass + '" dir\x3d"{langDir}" title\x3d"'
            + (CKEDITOR.env.gecko ?
            " " : "")
            ...
            b = CKEDITOR.document.getBody().append(
                CKEDITOR.dom.element.createFromHtml(k.output({
                  content: p,
                  id: a.id,
                  langDir: a.lang.dir,
                  langCode: a.langCode,
  ...
  (function () {
    function m(a) {
      function e(a) {
        ...
        g.attachListener(g, "keyup", function () {
          ...
          b && (1 == d.count() && !d.getItem(0).getCustomData("retain")
          && CKEDITOR.tools.isEmpty(d.getItem(0).getAttributes()) && d.getItem(
              0).remove(1), b = !1)
        })
      }
      ...
      if (b && !b.isDetached()) {
        ...
        (f = c.getElementById("cke_basetagscrpt")) && f.parentNode.removeChild(
            f);
        d.contentEditable = !0;
        CKEDITOR.env.ie
        ...
        CKEDITOR.env.ie && !CKEDITOR.env.edge &&
        b.enterMode != CKEDITOR.ENTER_P ? e("p") : CKEDITOR.env.edge && 15
            > CKEDITOR.env.version && b.enterMode != CKEDITOR.ENTER_DIV && e(
                "div");
        if (CKEDITOR.env.webkit || CKEDITOR.env.ie && 10
            < CKEDITOR.env.version) {
          c.getDocumentElement().on("mousedown",
              function (a) {
        ...
        (CKEDITOR.env.gecko || CKEDITOR.env.ie && "CSS1Compat"
            == b.document.$.compatMode) && this.attachListener(this, "keydown",
            function (a) {
              var c =
                  a.data.getKeystroke();
              if (33 == c || 34 == c) {
    ...
    function n(a) {
      function e() {
        ...
        a.editable().attachListener(a, "selectionChange", function () {
          ...
          d && (c && (c.detachEvent("onresizestart",
      ...
      if (CKEDITOR.env.gecko) {
        try {
          var c = a.document.$;
          c.execCommand("enableObjectResizing", !1,
              !a.config.disableObjectResizing);
          c.execCommand("enableInlineTableEditing", !1,
              !a.config.disableNativeTableHandles)
        } catch (d) {
        }
      } else {
        CKEDITOR.env.ie && 11 > CKEDITOR.env.version
        && a.config.disableObjectResizing && e(a)
      }
    }
    ...
    function p() {
      ...
      if (8 <= CKEDITOR.document.$.documentMode) {
        ...
        CKEDITOR.env.gecko && (a.push(
            "html{height:100% !important}"), a.push(
    ...
    CKEDITOR.plugins.add("wysiwygarea", {
      init: function (a) {
        ...
        a.addMode("wysiwyg", function (e) {
          function b(b) {
            b && b.removeListener();
            a.isDestroyed() || a.isDetached() || (a.editable(
                new l(a, d.$.contentWindow.document.body)), a.setData(
                a.getData(1), e))
          }

          var c = "document.open();" + (CKEDITOR.env.ie ? "("
              + CKEDITOR.tools.fixDomain + ")();" : "") + "document.close();",
              c = CKEDITOR.env.air ? "javascript:void(0)" : CKEDITOR.env.ie
              && !CKEDITOR.env.edge ? "javascript:void(function(){"
          ...
          g && (CKEDITOR.env.ie && h && (g += ", " + h), d.setAttribute("title",
              g));
          if (h) {
            var g = CKEDITOR.tools.getNextId(),
                k = CKEDITOR.dom.element.createFromHtml(
                    '\x3cspan id\x3d"' + g + '" class\x3d"cke_voice_label"\x3e'
                    +
                    h + "\x3c/span\x3e");
            c.append(k, 1);
    ...
    l = CKEDITOR.tools.createClass({
      $: function () {
        ...
        setData: function (a, e) {
          var b = this.editor;
          if (e) {
            this.setHtml(a), this.fixInitialSelection(), b.fire(
                "dataReady");
          } else {
            this._.isLoadingData = !0;
            b._.dataStore = {id: 1};
            var c = b.config, d = c.fullPage, f = c.docType,
                g = CKEDITOR.tools.buildStyleHtml(p()).replace(/<style>/,
                    '\x3cstyle data-cke-temp\x3d"1"\x3e');
            d || (g += CKEDITOR.tools.buildStyleHtml(b.config.contentsCss));
            var h = c.baseHref ? '\x3cbase href\x3d"' + c.baseHref
            ...
            d ? (/<body[\s|>]/.test(a) || (a = "\x3cbody\x3e"
                + a), /<html[\s|>]/.test(a) || (a = "\x3chtml\x3e" + a
                + "\x3c/html\x3e"), /<head[\s|>]/.test(a) ? /<title[\s|>]/.test(
                a) || (a = a.replace(/<head[^>]*>/,
                "$\x26\x3ctitle\x3e\x3c/title\x3e")) : a = a.replace(
                /<html[^>]*>/,
                "$\x26\x3chead\x3e\x3ctitle\x3e\x3c/title\x3e\x3c/head\x3e"),
            h && (a = a.replace(/<head[^>]*?>/, "$\x26" + h)), a = a.replace(
                /<\/head\s*>/, g + "$\x26"), a = f + a) : a = c.docType
                + '\x3chtml dir\x3d"' + c.contentsLangDirection + '" lang\x3d"'
                + (c.contentsLanguage || b.langCode)
                + '"\x3e\x3chead\x3e\x3ctitle\x3e' + this._.docTitle
                + "\x3c/title\x3e" + h + g + "\x3c/head\x3e\x3cbody" + (c.bodyId
                    ? ' id\x3d"' + c.bodyId + '"' : "") + (c.bodyClass
                    ? ' class\x3d"' + c.bodyClass + '"' : "") + "\x3e" + a
                + "\x3c/body\x3e\x3c/html\x3e";
            CKEDITOR.env.gecko && (a = a.replace(/<body/,
                '\x3cbody contenteditable\x3d"true" '), 2E4
            > CKEDITOR.env.version &&
            (a = a.replace(/<body[^>]*>/,
                "$\x26\x3c!-- cke-content-start --\x3e")));
            c = '\x3cscript id\x3d"cke_actscrpt" type\x3d"text/javascript"'
                ...
                + this._.frameLoadedHandler + ",window);wasLoaded\x3d1;}"
                + (CKEDITOR.env.ie ? "onload();"
                    : 'document.addEventListener("DOMContentLoaded", onload, false );')
                + "\x3c/script\x3e";
            CKEDITOR.env.ie && 9 > CKEDITOR.env.version
            && (c += '\x3cscript id\x3d"cke_shimscrpt"\x3ewindow.parent.CKEDITOR.tools.enableHtml5Elements(document)\x3c/script\x3e');
            h && CKEDITOR.env.ie && 10 > CKEDITOR.env.version
            && (c += '\x3cscript id\x3d"cke_basetagscrpt"\x3evar baseTag \x3d document.querySelector( "base" );baseTag.href \x3d baseTag.href;\x3c/script\x3e');
          ...
          a = this.editor;
          var e = a.config, b = e.fullPage, c = b && a.docType,
              d = b && a.xmlDeclaration,
              f = this.getDocument(),
              b = b ? f.getDocumentElement().getOuterHtml()
                  : f.getBody().getHtml();
          CKEDITOR.env.gecko && e.enterMode != CKEDITOR.ENTER_BR
          ...
          var a = this.editor, e = a.document,
        ...
        a.on("dirChanged", function (b) {
          ...
          for (var n = new CKEDITOR.dom.walker(f), c; c = n.next();) {
            if (c.type
              ...
              if (!c.equals(l) &&
                  c.getDirection()) {
                f.setStartAfter(c), n = new CKEDITOR.dom.walker(
                    f);
              } else {
                var d = a.config.indentClasses;
                if (d) {
                  for (var g = "ltr" == b.data.dir ? ["_rtl", ""] : ["",
                    "_rtl"], h = 0; h < d.length; h++) {
                    c.hasClass(d[h] + g[0])
                ...
                g ? c.setStyle("margin-right", g) : c.removeStyle(
                    "margin-right")
              }
            }
          }
            ...
            (function (a, b) {
              ...
              for (c in b.jobs) {
                e.on("exec", function (d) {
                  d.data.done || (a.fire("lockSnapshot"), b.execJob(a, c)
                  && (d.data.done =
                      !0), a.fire(
                      "unlockSnapshot"), CKEDITOR.dom.element.clearAllMarkers(
                      b.database))
                }, this, null, c), e.on("refresh", function (d) {
                  d.data.states || (d.data.states = {});
                  d.data.states[b.name + "@" + c] = b.refreshJob(a, c,
                      d.data.path)
                }, this, null, c);
              }
              a.addFeature(b)
    ...
    CKEDITOR.plugins.indent.specificDefinition.prototype = {
      execJob: function (a, b) {
        ...
        if (e.state != k) {
          ...
          b, e) {
        b = this.jobs[b];
        a.activeFilter.checkFeature(this) ? b.state = b.refresh.call(this, a, e)
            : b.state = k;
        return b.state
  ...
  (function () {
    function w(f) {
      function g(b) {
        for (var e = c.startContainer, a = c.endContainer;
        ...
        for (var e = k.isIndent ? 1 : -1, a = d[0], d = d[d.length - 1],
        ...
        for (a = d.getCustomData("listarray_index") + 1;
            a < h.length && h[a].indent > m; a++) {
          h[a].indent += e;
        }
        e = CKEDITOR.plugins.list.arrayToList(h, q, null, f.config.enterMode,
            b.getDirection());
        if (!k.isIndent) {
          var t;
          if ((t = b.getParent()) && t.is(
              "li")) {
            for (var d = e.listNode.getChildren(),
                r = [], l, a = d.count() - 1; 0 <= a; a--) {
              (l = d.getItem(a))
              && l.is && l.is("li") && r.push(l)
            }
          }
        }
        ...
        if (r && r.length) {
          for (a = 0; a < r.length; a++) {
            for (l = b = r[a]; (l = l.getNext()) && l.is && l.getName()
            in p;) {
              CKEDITOR.env.needsNbspFiller && !b.getFirst(x) && b.append(
                  c.document.createText(" ")), b.append(l);
            }
            b.insertAfter(t)
          }
        }
      ...
      for (var k = this, q = this.database, p = this.context, c,
          m = f.getSelection(), m = (m && m.getRanges()).createIterator();
          c = m.getNextRange();) {
        ...
        b || (b = c.startPath().contains(p)) && c.setEndAt(b,
            CKEDITOR.POSITION_BEFORE_END);
        if (!b) {
          var d = c.getEnclosedNode();
          d && d.type == CKEDITOR.NODE_ELEMENT && d.getName() in p
          && (c.setStartAt(d, CKEDITOR.POSITION_AFTER_START), c.setEndAt(d,
              CKEDITOR.POSITION_BEFORE_END), b = d)
        }
        b && c.startContainer.type == CKEDITOR.NODE_ELEMENT
        && c.startContainer.getName() in p && (d = new CKEDITOR.dom.walker(
            c), d.evaluator = n, c.startContainer =
            d.next());
        b && c.endContainer.type == CKEDITOR.NODE_ELEMENT
        && c.endContainer.getName() in p && (d = new CKEDITOR.dom.walker(
            c), d.evaluator = n, c.endContainer = d.previous());
        if (b) {
          return g(b)
        }
      }
          ...
          this.jobs[this.isIndent ? 10 : 30] = {
            refresh: this.isIndent ? function (f, c) {
              var g = this.getContext(c),
                  b = CKEDITOR.plugins.indentList.firstItemInPath(this.context,
                      c, g);
  ...
  (function () {
    ...
    var k = CKEDITOR.htmlParser.cssStyle, h = CKEDITOR.tools.cssLength,
        l = /^((?:\d*(?:\.\d+))|(?:\d+))(.*)?$/i, m = {
          elements: {
            $: function (a) {
              var b = a.attributes;
              if ((b = (b = (b = b && b["data-cke-realelement"])
                  && new CKEDITOR.htmlParser.fragment.fromHtml(
                      decodeURIComponent(b))) && b.children[0])
    ...
    CKEDITOR.editor.prototype.createFakeElement = function (a, b, c, d) {
      ...
      d && (b["data-cke-resizable"] = d, c = new k, d = a.getAttribute(
          "width"), a = a.getAttribute("height"), d && (c.rules.width = h(d)), a
    ...
    CKEDITOR.editor.prototype.createFakeParserElement = function (a, b, c, d) {
      ...
      c && (b["data-cke-real-element-type"] = c);
      d
      && (b["data-cke-resizable"] = d, d = a.attributes, a = new k, c = d.width, d = d.height, void 0
      !== c && (a.rules.width = h(c)), void 0 !== d && (a.rules.height = h(
          d)), a.populate(b));
  ...
  (function () {
    ...
    function r(c, b) {
      for (var a = c.plugins.link, e = a.compiledProtectionFunction.params,
          a = [a.compiledProtectionFunction.name, "("], f, d, g = 0;
          g < e.length; g++) {
        f = e[g].toLowerCase(), d = b[f], 0 < g && a.push(
    ...
    CKEDITOR.plugins.add("link", {
      requires: "dialog,fakeobjects", onLoad: function () {
        function c(b) {
          return a.replace(/%1/g, "rtl" == b ? "right" : "left").replace(/%2/g,
              "cke_contents_" + b)
        }

        var b = "background:url(" + CKEDITOR.getUrl(
        ...
        c.addCommand("link", new CKEDITOR.dialogCommand("link",
            {allowedContent: b, requiredContent: "a[href]"}));
        ...
        c.on("doubleclick", function (a) {
          ...
          b && !b.isReadOnly() && (b.is("a") ? (a.data.dialog = !b.getAttribute(
              "name") || b.getAttribute("href") &&
              b.getChildCount() ? "link" : "anchor", a.data.link = b)
        ...
        c.contextMenu && c.contextMenu.addListener(function (a) {
          ...
          if (!a && !(a = CKEDITOR.plugins.link.getSelectedLink(
              c))) {
            return null;
          }
          var b = {};
        ...
        c.dataProcessor.dataFilter.addRules({
          elements: {
            a: function (a) {
              return a.attributes.name ? a.children.length ? null
                  : c.createFakeParserElement(a, "cke_anchor", "anchor") : null
            }
          }
        });
        var b = c._.elementsPath && c._.elementsPath.filters;
        b && b.push(function (a, b) {
          if ("a" == b && (CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, a)
              || a.getAttribute("name") && (!a.getAttribute("href")
                  || !a.getChildCount()))) {
            return "anchor"
          }
        })
    ...
    var t = /^javascript:/, u = /^(?:mailto)(?:(?!\?(subject|body)=).)+/i,
        v = /subject=([^;?:@&=$,\/]*)/i, w = /body=([^;?:@&=$,\/]*)/i,
        x = /^#(.*)$/, y = /^((?:http|https|ftp|news):\/\/)?(.*)$/,
    ...
    CKEDITOR.plugins.link = {
      getSelectedLink: function (c, b) {
        var a = c.getSelection(), e = a.getSelectedElement(), f = a.getRanges(),
            d = [], g;
        if (!b && e && e.is("a")) {
          return e;
        }
        for (e = 0; e < f.length; e++) {
          if (g = a.getRanges()[e], g.shrink(
              CKEDITOR.SHRINK_ELEMENT, !0, {skipBogus: !0}), (g = c.elementPath(
              g.getCommonAncestor()).contains("a", 1)) && b) {
            d.push(
                g);
          } else if (g) {
            return g;
        ...
        for (var b = c.editable(),
            ...
            b = a.getElementsByTag("a"), a = a.getElementsByTag("img"), e = [],
            f = 0, d; d = b.getItem(f++);) {
          (d.data("cke-saved-name")
              || d.hasAttribute("name")) && e.push({
        ...
        return e
          ...
          b) {
        if (b && b.data("cke-real-element-type") && "anchor" == b.data(
        ...
        var a = b && (b.data("cke-saved-href") || b.getAttribute("href")) || "",
            ...
            f = c.config.emailProtection, d = {}, g;
        a.match(t) && ("encode" == f ? a = a.replace(A, function (a, b, c) {
          ...
          if (b == e.name) {
            ...
            b = /(^')|('$)/g;
            c = c.match(/[^,\s]+/g);
            for (var f = c.length, g, h, k = 0; k < f;
                k++) {
              g = decodeURIComponent, h = c[k].replace(b, "").replace(
                  /\\'/g, "'"), h = g(
                  h), g = e.params[k].toLowerCase(), a[g] = h;
            }
        ...
        if (b) {
          if (a = b.getAttribute("target")) {
            d.target = {
              type: a.match(z) ? a : "frame", name: a
            };
          } else if (a = (a = b.data("cke-pa-onclick") || b.getAttribute(
              "onclick")) && a.match(C)) {
            for (d.target = {
              type: "popup",
              name: a[1]
              ...
              "yes" != f[2] && "1" != f[2] || f[1]
              in {height: 1, width: 1, top: 1, left: 1} ? isFinite(f[2])
                  && (d.target[f[1]] = f[2]) : d.target[f[1]] = !0;
            }
          }
          null !==
        ...
        switch (b.type) {
          case "url":
            var a = b.url && void 0 !== b.url.protocol ? b.url.protocol
                : "http://", f = b.url && CKEDITOR.tools.trim(b.url.url) || "";
            ...
            switch (a) {
              ...
              case "encode":
                var g = encodeURIComponent(d.subject || ""),
                    k = encodeURIComponent(d.body || ""), d = [];
                g && d.push("subject\x3d" + g);
                k && d.push("body\x3d" + k);
                d = d.length ? "?" + d.join("\x26") : "";
                "encode" == a
                    ? (a = ["javascript:void(location.href\x3d'mailto:'+",
                      q(f)], d && a.push("+'", p(d), "'"), a.push(")"))
                    : a = ["mailto:", f, d];
                break;
              default:
                a = f.split("@",
                    2), d.name = a[0], d.domain = a[1], a = ["javascript:", r(c,
                    d)]
            }
          ...
          if ("popup" == b.target.type) {
            for (var a = ["window.open(this.href, '", b.target.name || "",
                ...
                h = "resizable status location toolbar menubar fullscreen scrollbars dependent".split(
                    " "), f = h.length, g = function (a) {
                  b.target[a] && h.push(a + "\x3d" + b.target[a])
                }, d = 0; d < f; d++) {
              h[d] += b.target[h[d]] ? "\x3dyes"
                  : "\x3dno";
            }
            g("width");
            g("left");
    ...
    CKEDITOR.unlinkCommand.prototype = {
      exec: function (c) {
        if (CKEDITOR.env.ie) {
          var b = c.getSelection().getRanges()[0],
              a = b.getPreviousEditableNode()
                  && b.getPreviousEditableNode().getAscendant("a", !0)
                  || b.getNextEditableNode()
                  && b.getNextEditableNode().getAscendant("a", !0), e;
          b.collapsed && a &&
      ...
      refresh: function (c, b) {
        ...
        a && "a" == a.getName() && a.getAttribute("href") && a.getChildCount()
            ? this.setState(CKEDITOR.TRISTATE_OFF) : this.setState(
            CKEDITOR.TRISTATE_DISABLED)
      },
      contextSensitive: 1,
      startDisabled: 1,
    ...
    CKEDITOR.removeAnchorCommand.prototype = {
      exec: function (c) {
        ...
        if (b && (e = b.getSelectedElement()) && (e.getChildCount() ? e.is("a")
            : CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, e))) {
          e.remove(
              1);
        } else if (e = CKEDITOR.plugins.link.getSelectedLink(
            c)) {
          e.hasAttribute("href") ? (e.removeAttributes(
              {name: 1, "data-cke-saved-name": 1}), e.removeClass("cke_anchor"))
              : e.remove(1);
        }
        b.selectBookmarks(a)
  ...
  (function () {
    function K(a, l, d, f) {
      for (var e = CKEDITOR.plugins.list.listToArray(l.root, d), g = [], b = 0;
          b < l.contents.length; b++) {
        var h = l.contents[b];
        (h = h.getAscendant("li", !0)) && !h.getCustomData(
            "list_item_processed") && (g.push(
            h), CKEDITOR.dom.element.setMarker(d, h, "list_item_processed", !0))
      }
      for (var h = l.root.getDocument(), k, c, b = 0; b < g.length; b++) {
        ...
        k.is(this.type) || (c = h.createElement(this.type), k.copyAttributes(c,
            {start: 1, type: 1}), c.removeStyle("list-style-type"),
            e[p].parent = c)
      }
      d = CKEDITOR.plugins.list.arrayToList(e, d, null, a.config.enterMode);
      for (var m, e = d.listNode.getChildCount(), b = 0;
          b < e && (m = d.listNode.getChild(b)); b++) {
        m.getName() == this.type
        && f.push(m);
      }
    ...
    function L(a, l, d) {
      ...
      for (b = 0; b < f.length; b++) {
        l = l.getCommonAncestor(f[b].getParent());
      }
      ...
      if (!(1 > g.length)) {
        ...
        for (d.push(b); g.length;) {
          d = g.shift(), a = e.createElement(
              "li"), c = d, c.is("pre") || M.test(c.getName()) || "false"
          == c.getAttribute("contenteditable") ? d.appendTo(a)
              : (d.copyAttributes(a), h && d.getDirection() && (a.removeStyle(
                  "direction"),
                  a.removeAttribute("dir")), d.moveChildren(
                  a), d.remove()), a.appendTo(b);
        }
    ...
    function N(a, l, d) {
      function f(b) {
        if (!(!(c = k[b ? "getFirst" : "getLast"]()) || c.is
            && c.isBlockBoundary() || !(p = l.root[b ? "getPrevious"
                : "getNext"](CKEDITOR.dom.walker.invisible(!0))) || p.is
            && p.isBlockBoundary({br: 1}))) {
          a.document.createElement("br")[b
              ? "insertBefore" : "insertAfter"](c)
        }
      }
      ...
      for (b = 0; b < g.length; b++) {
        h = g[b].getCustomData(
            "listarray_index"), e[h].indent = -1;
      }
      for (b = h + 1; b < e.length; b++) {
        if (e[b].indent > e[b - 1].indent
            + 1) {
      ...
      var k = CKEDITOR.plugins.list.arrayToList(e, d, null, a.config.enterMode,
          l.root.getAttribute("dir")).listNode, c, p;
      f(!0);
      f();
      k.replace(l.root);
      a.fire("contentDomInvalidated")
    ...
    function F(a, l, d, f) {
      for (var e, g; e = a[f ? "getLast" : "getFirst"](O);) {
        (g = e.getDirection(
            1)) !== l.getDirection(1) && e.setAttribute("dir", g), e.remove(), d
            ? e[f ? "insertBefore" : "insertAfter"](d) : l.append(e, f), d = e
      }
    }
    ...
    function G(a) {
      function l(d) {
        ...
        f && f.type == CKEDITOR.NODE_ELEMENT && f.is(a.getName()) && (F(a, f,
            null, !d), a.remove(),
            a = f)
      }
    ...
    function H(a) {
      return a.type == CKEDITOR.NODE_ELEMENT && (a.getName()
          in CKEDITOR.dtd.$block || a.getName() in CKEDITOR.dtd.$listItem)
    ...
    function D(a, l, d) {
      ...
      var e = l.createBookmark(),
          g = new CKEDITOR.dom.elementPath(l.startContainer), b = g.block,
      ...
      b ? (b = b.getBogus()) && b.remove() : h && (b = h.getPrevious(t)) && z(b)
          && b.remove();
      (b = f.getLast()) && b.type == CKEDITOR.NODE_ELEMENT && b.is("br")
      && b.remove();
      (b = l.startContainer.getChild(l.startOffset)) ? f.insertBefore(b)
          : l.startContainer.append(f);
      k && (f = A(k)) && (g.contains(k) ? (F(f, k.getParent(), k), f.remove())
          : g.append(f));
      for (; d.checkStartOfBlock() && d.checkEndOfBlock();) {
        ...
        f.is("li") && (g = f.getParent(), f.equals(g.getLast(t)) && f.equals(
            g.getFirst(t)) &&
        (f = g));
      ...
      (d = d.next()) && d.type == CKEDITOR.NODE_ELEMENT && d.getName()
      in CKEDITOR.dtd.$list && G(d);
      l.moveToBookmark(e);
      l.select();
      a.fire("saveSnapshot")
    }
    ...
    function A(a) {
      return (a = a.getLast(t)) && a.type == CKEDITOR.NODE_ELEMENT
      && a.getName() in u ? a : null
    }

    var u = {ol: 1, ul: 1}, P = CKEDITOR.dom.walker.whitespaces(),
    ...
    CKEDITOR.plugins.list = {
      listToArray: function (a, l, d, f, e) {
        ...
        for (var g = 0, b = a.getChildCount(); g < b; g++) {
          var h = a.getChild(g);
          h.type == CKEDITOR.NODE_ELEMENT && h.getName() in CKEDITOR.dtd.$list
          && CKEDITOR.plugins.list.listToArray(h, l, d, f + 1);
          if ("li" == h.$.nodeName.toLowerCase()) {
            var k = {parent: a, indent: f, element: h, contents: []};
            e ? k.grandparent = e
                : (k.grandparent = a.getParent(), k.grandparent && "li"
                == k.grandparent.$.nodeName.toLowerCase() &&
                (k.grandparent = k.grandparent.getParent()));
            l && CKEDITOR.dom.element.setMarker(l, h, "listarray_index",
                d.length);
            d.push(k);
            for (var c = 0, p = h.getChildCount(), m; c < p;
                c++) {
              m = h.getChild(c), m.type == CKEDITOR.NODE_ELEMENT
              && u[m.getName()] ? CKEDITOR.plugins.list.listToArray(m, l, d,
                  f + 1, k.grandparent) : k.contents.push(m)
            }
          }
        }
        return d
        ...
        for (var g, b = a[d].parent.getDocument(),
            h = new CKEDITOR.dom.documentFragment(b), k = null, c = d,
          ...
          if (q.indent == p) {
            k && a[c].parent.getName() == k.getName() || (k = a[c].parent.clone(
                !1, 1), e && k.setAttribute("dir", e), h.append(k));
            m = k.append(q.element.clone(0, 1));
            n != k.getDirection(1) && m.setAttribute("dir", n);
            for (g = 0; g < q.contents.length; g++) {
              m.append(
                  q.contents[g].clone(1, 1));
            }
            c++
          } else if (q.indent == Math.max(p, 0) + 1) {
            q = a[c
            - 1].element.getDirection(1), c = CKEDITOR.plugins.list.arrayToList(
                a,
                null, c, f, q != n ? n : null), !m.getChildCount() &&
            CKEDITOR.env.needsNbspFiller && 7 >= b.$.documentMode && m.append(
                b.createText(" ")), m.append(
                c.listNode), c = c.nextIndex;
          } else if (-1 == q.indent && !d
              && g) {
            u[g.getName()] ? (m = q.element.clone(!1, !0), n != g.getDirection(
                1) && m.setAttribute("dir", n))
                : m = new CKEDITOR.dom.documentFragment(b);
            var k = g.getDirection(1) != n, w = q.element,
                B = w.getAttribute("class"), E = w.getAttribute("style"),
                J = m.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && (f
                    != CKEDITOR.ENTER_BR || k || E || B), v,
                z = q.contents.length, x;
            for (g = 0; g < z; g++) {
              if (v = q.contents[g], I(v) &&
              1 < z) {
                J ? x = v.clone(1, 1) : m.append(
                    v.clone(1, 1));
              } else if (v.type == CKEDITOR.NODE_ELEMENT
                  && v.isBlockBoundary()) {
                k && !v.getDirection() && v.setAttribute("dir", n);
                r = v;
                var A = w.getAttribute("style");
                A && r.setAttribute("style",
                ...
                J ? (r || (r = b.createElement(y), m.append(r), k
                && r.setAttribute("dir", n)), E && r.setAttribute("style", E), B
                && r.setAttribute("class", B), x && (r.append(
                    x), x = null), r.append(v.clone(1,
                    1))) : m.append(v.clone(1, 1));
              }
            }
            x && ((r || m).append(x), x = null);
            m.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && c != a.length - 1
            && (CKEDITOR.env.needsBrFiller && (n = m.getLast()) && n.type
            == CKEDITOR.NODE_ELEMENT && n.is("br")
            && n.remove(), (n = m.getLast(t)) && n.type == CKEDITOR.NODE_ELEMENT
            && n.is(CKEDITOR.dtd.$block) || m.append(b.createElement("br")));
          ...
          r = null;
          if (a.length <= c || Math.max(a[c].indent, 0) < p) {
            break
          }
        }
        if (l) {
          for (a = h.getFirst(); a;) {
            if (a.type ==
                CKEDITOR.NODE_ELEMENT && (CKEDITOR.dom.element.clearMarkers(l,
                    a), a.getName() in CKEDITOR.dtd.$listItem
    ...
    C.prototype = {
      exec: function (a) {
        ...
        function f(a) {
          var b = !0;
          if (0 === a.getChildCount()) {
            return !1;
          }
          a.forEach(function (a) {
            if (a.type !== CKEDITOR.NODE_COMMENT) {
              return b = !1
            }
          }, null, !0);
          return b
        ...
        if (this.state == CKEDITOR.TRISTATE_OFF) {
          ...
          if (h.getFirst(t)) {
            ...
            (e = k && k.getEnclosedNode()) && e.is && this.type == e.getName()
            && this.setState(CKEDITOR.TRISTATE_ON)
          } else {
            e.enterMode ==
            CKEDITOR.ENTER_BR ? h.appendBogus() : b[0].fixBlock(1,
                e.enterMode == CKEDITOR.ENTER_P ? "p" : "div"), g.selectRanges(
                b)
          }
        }
        for (var e = g.createBookmarks(!0), h = [], c = {},
            b = b.createIterator(), p = 0; (k = b.getNextRange()) && ++p;) {
          var m = k.getBoundaryNodes(), n = m.startNode, r = m.endNode;
          n.type == CKEDITOR.NODE_ELEMENT && "td" == n.getName()
          && k.setStartAt(m.startNode, CKEDITOR.POSITION_AFTER_START);
          r.type == CKEDITOR.NODE_ELEMENT && "td" == r.getName() && k.setEndAt(
              m.endNode, CKEDITOR.POSITION_BEFORE_END);
          k = k.createIterator();
          for (k.forceBrBreak =
              this.state == CKEDITOR.TRISTATE_OFF;
              m = k.getNextParagraph();) {
            if (!m.getCustomData("list_block")
                && !f(m)) {
              CKEDITOR.dom.element.setMarker(c, m, "list_block", 1);
              for (var y = a.elementPath(m), n = y.elements, r = 0,
                  y = y.blockLimit, q, w = n.length - 1; 0 <= w && (q = n[w]);
                  w--) {
                if (u[q.getName()] && y.contains(q)) {
                  y.removeCustomData("list_group_object_" + p);
                  (n = q.getCustomData("list_group_object")) ? n.contents.push(
                      m)
                      : (n = {root: q, contents: [m]}, h.push(
                      n), CKEDITOR.dom.element.setMarker(c, q,
                      "list_group_object",
                      n));
                  r = 1;
                  break
              ...
              r || (r = y, r.getCustomData("list_group_object_" +
                  p) ? r.getCustomData("list_group_object_" + p).contents.push(
                  m)
                  : (n = {
                    root: r,
                    contents: [m]
                  }, CKEDITOR.dom.element.setMarker(
                      c, r, "list_group_object_" + p, n), h.push(n)))
            }
          }
        }
        for (q = []; 0 < h.length;) {
          n = h.shift(), this.state
          == CKEDITOR.TRISTATE_OFF ? l(n) || (u[n.root.getName()] ? K.call(this,
              a, n, c, q) : L.call(this, a, n, q)) : this.state
              == CKEDITOR.TRISTATE_ON && u[n.root.getName()] && !l(n) && N.call(
                  this, a, n, c);
        }
    ...
    CKEDITOR.plugins.add("list", {
      requires: "indentlist", init: function (a) {
        a.blockless || (a.addCommand("numberedlist",
            new C("numberedlist", "ol")), a.addCommand("bulletedlist",
            new C("bulletedlist", "ul")), a.ui.addButton && (a.ui.addButton(
            "NumberedList", {
            ...
            if (e && e.collapsed) {
              ...
              if (b) {
                ...
                (c = g.contains(u)) && e.checkBoundaryOfElement(c,
                    CKEDITOR.START) && (c = c.getParent()) && c.is("li")
                && (c = A(c)) ? (f = c, c = c.getPrevious(t), d.moveToPosition(
                    c && z(c) ? c : f, CKEDITOR.POSITION_BEFORE_START))
                    : (k.range.setStartAt(h,
                    CKEDITOR.POSITION_AFTER_START), k.range.setEnd(
                    e.startContainer, e.startOffset), (c = k.previous())
                    && c.type == CKEDITOR.NODE_ELEMENT && (c.getName() in u || c.is(
                    "li")) && (c.is("li") || (k.range.selectNodeContents(
                    c), k.reset(), k.evaluator = H, c = k.previous()), f = c, d.moveToElementEditEnd(
                    f), d.moveToPosition(d.endPath().block,
                    CKEDITOR.POSITION_BEFORE_END)));
                if (f) {
                  D(a, d, e), l.cancel();
                } else {
                  var p = g.contains(u);
                  p && e.checkBoundaryOfElement(p, CKEDITOR.START)
                  && (f = p.getFirst(t), e.checkBoundaryOfElement(f,
                      CKEDITOR.START) && (c = p.getPrevious(t), A(f) ? c
                      && (e.moveToElementEditEnd(c), e.select())
                      : a.execCommand("outdent"), l.cancel()))
                }
              } else if (f = g.contains("li")) {
                if (k.range.setEndAt(h,
                    CKEDITOR.POSITION_BEFORE_END), b = (h = f.getLast(t)) && H(
                    h) ? h : f, g = 0, (c = k.next()) && c.type
                == CKEDITOR.NODE_ELEMENT && c.getName() in u && c.equals(h)
                    ? (g = 1, c = k.next()) : e.checkBoundaryOfElement(b,
                    CKEDITOR.END) &&
                    (g = 2), g && c) {
                  e = e.clone();
                  e.moveToElementEditStart(c);
                  if (1 == g && (d.optimize(), !d.startContainer.equals(f))) {
                    for (f = d.startContainer;
                        f.is(CKEDITOR.dtd.$inline);) {
                      p = f, f = f.getParent();
                    }
                    p && d.moveToPosition(p, CKEDITOR.POSITION_AFTER_END)
                  }
                  2 == g && (d.moveToPosition(d.endPath().block,
                      CKEDITOR.POSITION_BEFORE_END), e.endPath().block
                ...
                k.range.setEndAt(h,
                    CKEDITOR.POSITION_BEFORE_END), (c = k.next()) && c.type
                == CKEDITOR.NODE_ELEMENT &&
                c.is(u) && (c = c.getFirst(t), g.block && e.checkStartOfBlock()
                && e.checkEndOfBlock()
                    ? (g.block.remove(), e.moveToElementEditStart(
                        c), e.select())
                    : A(c) ? (e.moveToElementEditStart(c), e.select())
                        : (e = e.clone(), e.moveToElementEditStart(c), D(a, d,
                            e)), l.cancel());
              }
              setTimeout(function () {
                a.selectionChange(1)
  ...
  (function () {
    ...
    var g = [CKEDITOR.CTRL + 90, CKEDITOR.CTRL + 89,
      CKEDITOR.CTRL + CKEDITOR.SHIFT + 90], p = {8: 1, 46: 1};
    CKEDITOR.plugins.add("undo", {
      init: function (a) {
        ...
        var d = a.undoManager = new e(a), l = d.editingHandler = new k(d),
            f = a.addCommand("undo", {
              exec: function () {
        ...
        d.onChange = function () {
          f.setState(d.undoable() ? CKEDITOR.TRISTATE_OFF
              : CKEDITOR.TRISTATE_DISABLED);
          h.setState(
    ...
    e.prototype = {
      type: function (a, b) {
        ...
        b ? (d = 0, this.editor.fire("saveSnapshot")) : this.editor.fire(
            "change");
        ...
        var d = this.editor;
        if (this.locked || "ready" != d.status || "wysiwyg"
            != d.mode) {
          return !1;
        }
        var e = d.editable();
        ...
        a.bookmarks ? c.selectBookmarks(a.bookmarks) : CKEDITOR.env.ie
            && (c = this.editor.document.getBody().$.createTextRange(), c.collapse(
                !0), c.select());
        this.locked = null;
        this.index = a.index;
    ...
    var f = CKEDITOR.plugins.undo.Image = function (a, b) {
      ...
      b || (this.bookmarks = (c = c && a.getSelection()) && c.createBookmarks2(
          !0));
    ...
    k.prototype = {
      onKeydown: function (a) {
        var b = a.data.getKey();
        if (229 !== b) {
          if (-1 < CKEDITOR.tools.indexOf(g,
              a.data.getKeystroke())) {
            a.data.preventDefault();
          } else if (this.keyEventsStack.cleanUp(
              a), a = this.undoManager, this.keyEventsStack.getLast(b)
          || this.keyEventsStack.push(b), this.lastKeydownImage = new f(
              a.editor), e.isNavigationKey(b)
          || this.undoManager.keyGroupChanged(
              b)) {
        ...
        if (this.ignoreInputEvent) {
          ...
          && (this.undoManager.type(a.keyCode,
              !0), this.keyEventsStack.resetInputs())
        }
      }, onKeyup: function (a) {
        ...
        if (!(e.ieFunctionalKeysBug(a) && this.lastKeydownImage
            && this.lastKeydownImage.equalsContent(new f(b.editor,
                !0)))) {
          if (0 < c) {
            b.type(a);
          } else if (e.isNavigationKey(
              a)) {
        ...
        b.attachListener(b, "keydown", function (a) {
            ...
            null, null, 999);
        b.attachListener(b, CKEDITOR.env.ie ? "keypress" : "input", c.onInput,
            c, null, 999);
        ...
        b.attachListener(b.isInline() ? b : a.document.getDocumentElement(),
            "click", function () {
              c.onNavigationKey()
            }, null, null, 999);
