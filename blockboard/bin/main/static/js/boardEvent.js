...
function clickSaveaddedBoard() {
  ...
  $.ajax({
    ...
    success: function (data) {    //통신 성공시 탭 내용담는 div를 읽어들인 값으로 채운다.
      ...
      var tabBoardIDinEditor = $('#boardIDinEditor');
      tabBoardIDinEditor.html("");
      $.each(data, function (key, value) {
        tabBoardIDinEditor.append("<option data-tab=" + value.boardID + "  class=tabmenu id=default>" + value.boardName + "</option>");
      });
    }
  });
